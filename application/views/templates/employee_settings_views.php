...
<body>
        ...
        <div class="row ">
            ...
            <div class="col-md-12">
                <div class="container-fluid p-4">
                    <div class="row pt-1">
                        <div class="col-md-6">
                            <h1 class="page-title d-flex align-items-center"><a href="<?= $module[0] ?>"><img style="width: 24px; height: 24px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" /></a>&nbsp;Settings &nbsp;(<?= $module[2] ?>)<h1>
                        </div>
                        <?php
                        ...
                        <div class="col-md-6 button-title">
                            <a href="<?php echo base_url('main_table_01/add_data?' . $url_add_encrypted); ?>" id="btn_application" class=" btn technos-button-green shadow-none rounded" <?php if (!$add_button[0])  echo "hidden"; ?>><img class="mb-1" src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">&nbsp;<?= $add_button[1] ?></a>
                            ...
                            <a href="<?php echo base_url('main_table_01/excel_import?' . $url_csv_encrypted); ?>" id="bulk_import" class=" btn technos-button-green shadow-none rounded" <?php if (!$add_button[0])  echo "hidden"; ?>><img class="mb-1" src="<?= base_url('assets_system/icons/file-import-solid.svg') ?>" alt="">&nbsp;Bulk Update</a>
                            <a id="btn_export" class=" btn technos-button-green shadow-none rounded" <?php if (!$excel_output[0])  echo "hidden"; ?>><img class="mb-1" src="<?= base_url('assets_system/icons/file-export-solid.svg') ?>" alt="">&nbsp;Export XLSX</a>
                        </div>
                    </div>
                    <hr>
                    <div class="pb-1">
                    ...
                    <div class="card border-0 p-0 m-0">
                        <div class="row">
                            ...
                            <nav class="side_module position-fixed " id="side_nav">
                                <a href="employee_types" class="list-group-item list-group-item-action px-3 border-0 ripple <?php echo ($this->router->method == 'employee_types') ? 'active' : ''; ?>" id="employee_types">Employee Types</a>
                                <a href="positions" class="list-group-item list-group-item-action px-3 border-0 ripple  <?php echo ($this->router->method == 'positions') ? 'active' : ''; ?>" id="positions">Positions</a>
                                <a href="branches" class="list-group-item list-group-item-action px-3 border-0 ripple <?php echo ($this->router->method == 'branches') ? 'active' : ''; ?>" <?= ($C_COM_STRUCTURE[32]->value == '1') ? '' : 'hide'; ?>" id="branches">Branches</a>
                                ...
                                <div class="p-1">
                                    ...
                                    <div class="col-md-4 pl-0">
                                        <div class="input-group p-1 pt-2">
                                            <?php
                                            if ($search_data) { ?>
                                                <button id="clear_search_btn" class="input-group-prepend btn technos-button-blue shadow-none d-flex align-items-center" <?php if (!$add_button[0])  echo "hidden"; ?>><img style="height: 16px;" src="<?= base_url('assets_system/icons/broom-wide-sharp-solid.svg') ?>" alt="">&nbsp;Clear</button>
                                            <?php } else { ?>
                                                <button id="search_btn" class="input-group-prepend btn technos-button-blue shadow-none d-flex align-items-center" <?php if (!$add_button[0])  echo "hidden"; ?>><img src="<?= base_url('assets_system/icons/magnifying-glass-solid.svg') ?>" alt="">&nbsp;Search</button>
                                            <?php } ?>
                                    ...
                                    <div class="p-2">
                                        <div>
                                            ...
                                            foreach ($C_BULK_BUTTON as $C_BULK_BUTTON_ROW) { ?>
                                                <button id=<?= $C_BULK_BUTTON_ROW[1] ?> class="btn technos-button-green shadow-none rounded bulk-button" data-toggle="modal" data-id=<?= $C_BULK_BUTTON_ROW[5] ?> data-target="#modal_set_ssa" <?php if (!$C_BULK_BUTTON_ROW[0])  echo "hidden"; ?> status=<?= $C_BULK_BUTTON_ROW[3] ?>><img style="height: 1rem; width: 1rem; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/' . $C_BULK_BUTTON_ROW[2]) ?>" alt="">&nbsp;<?= $C_BULK_BUTTON_ROW[3] ?></button>
                                            <?php
                                            } ?>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td style="width:15%" class="text-center">
                                                                <a class="select_row p-2" href="<?php echo base_url('main_table_01/show_data?' . $url_edit_encrypted); ?>" style="color: gray; cursor: pointer; !important" row_id="<?= $id_raw ?>"> <img src="<?= base_url('assets_system/icons/eye-solid.svg') ?>" alt="" id="view"></i></a>
                                                                <a class="select_edit_row p-2" href="<?php echo base_url('main_table_01/edit_data?' . $url_edit_encrypted); ?>" style="color: gray; cursor: pointer; !important" row_id="<?= $id_raw ?>"><img src="<?= base_url('assets_system/icons/pen-to-square-solid.svg') ?>" alt="" id="edit"></a>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                    }
    ...
    ?>
        <script>
            Swal.fire('<?php echo $this->session->userdata('info'); ?>', '', 'info')
        </script>
    <?php
