...
<body>
    ...
    <nav class="main-header border-0 navbar-expand mb-4" style="background-color: #FFFF;">
        <div>
            <span class="" >
                <button class="btn btn-light nav-link mb-2 ml-auto" data-widget="pushmenu" role="button">
    ...
    <aside style="height: 100vh;position:fixed" class="main-sidebar sidebar-light-primary elevation-0 " style="border-right: 1px solid #EEEEEE;">
