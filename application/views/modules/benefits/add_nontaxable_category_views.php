...
<div id="loadingOverlay" class="loading-overlay" hidden>
  <div class="loading-spinner"></div>
    ...
    <div class="container-fluid p-4">
        <div class="row pt-1">
            <div class="col-md-6">
                <h1 class="page-title"><a href="<?= base_url() . 'benefits/nontaxable'; ?>"><img style="width: 24px; height: 24px; margin-bottom: 5px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" /></a>&nbsp;Add Category<h1>
            </div>
            ...
            <div class="card border-0 py-1 m-0">
                ...
                <div class="p-2">
                    <div class="d-flex justify-content-center justify-content-lg-start">
                        <button class="btn btn-success mr-1" id="btn-add-row"><img class="mb-1" style="height: 1.1rem; width: 1.1rem;" src="<?= base_url('assets_system/icons/circle-plus-solid_xs.svg') ?>" alt="" />&nbsp;Add Row</button>
                        <button class="btn btn-danger mr-1" id="btn-delete-row"><img class="mb-1" style="height: 1.1rem; width: 1.1rem;" src="<?= base_url('assets_system/icons/circle-minus-solid_xs.svg') ?>" alt="" /> Delete Row</button>
...
<script>
    var url = '<?= base_url() ?>';
    var fixedType = <?= !empty($DISP_NONTAXABLE_TYPE) ? json_encode($DISP_NONTAXABLE_TYPE) : '[]'; ?>;
    var categories = <?= !empty($DISP_CATEGORIES) ? json_encode($DISP_CATEGORIES) : '[]'; ?>;
    ...
    udpate_date.addEventListener('click', function() {
        ...
        fetch(url + 'benefits/insert_nontax_category', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
...
<script>
    $(document).ready(function() {
        ...
        $('select.type_filter').on('change', function(){
            window.location.href = "<?= base_url('benefits/add_nontaxable_category?type='); ?>" + $(this).val();
        })
    })
</script>
</body>
