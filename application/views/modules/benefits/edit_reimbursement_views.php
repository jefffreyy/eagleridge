            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="modal-body pb-5">
                        <div class="row">
                            <div class="col-md-12">
                                <?php echo form_open('benefits/edit_reimbursement_form'); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="empl_id" id="input_empl_id">
                                        ...
                                        ?>
                                            <option value="<?= $employee->id ?>" <?= $reimbursement[0]->empl_id == $employee->id? 'selected': '' ?>><?= $employee->name ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type" id="type">
                                        ...
                                        ?>
                                            <option value="<?= $type->id ?>"  <?= $reimbursement[0]->type == $type->id ? 'selected': '' ?> ><?= $type->name ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea required name="description" class="form-control" id="description" rows="4" cols="50" enabled=""
                                    ><?= $reimbursement[0]->description ?></textarea>
                                </div>
                                <!-- 
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="required" for="amount">Amount</label>
                                    <input type="text" value="<?= $reimbursement[0]->amount ?>" required class="form-control" name="amount" id="amount" pattern="^[0-9]+(\.[0-9]+)?$" title="Please enter a valid amount">
                                </div>
                                ...
                                <div class="file_uploader form-group" data-type="benefits">
                                    ...
                                    <input type="hidden" name="attachment" class="selected_images d-block w-100" value="<?= $reimbursement[0]->attachment ?>" />
                                </div>
                                <!--<div class="form-group">-->
