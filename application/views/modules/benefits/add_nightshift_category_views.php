...
<div class="content-wrapper">
    <div class="container-fluid p-4">
        <div class="row pt-1">
            <div class="col-md-6">
                <h1 class="page-title"><a href="<?= base_url() . 'benefits/taxable'; ?>"><img style="width: 24px; height: 24px; margin-bottom: 5px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" /></a>&nbsp;Add Night Shift Category<h1>
            </div>
...
console.log(categories)
    ...
    udpate_date.addEventListener('click', function() {
        ...
        fetch(url + 'benefits/insert_nightshift_category', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
...
<script>
    $(document).ready(function() {
        ...
        $('select.type_filter').on('change', function(){
            window.location.href = "<?= base_url('benefits/add_nightshift_category?type='); ?>" + $(this).val();
        })
    })
</script>
</body>
