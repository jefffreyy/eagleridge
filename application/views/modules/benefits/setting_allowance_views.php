                        ...
                        <div class="col-md-9">
                            <div class="row">
                                <div class="col-12 d-flex justify-content-between align-items-center">
                                    <span style="font-weight: 500; font-size: 18px">Extra Allowance</span>
                            ...
                            <hr>
                            <?php echo form_open('benefits/update_setting_allowance'); ?>
                            <div class="">

                                <div class="form-group row d-flex justify-content-center">
                                    <div class="col-5 col-lg-6 mt-2  my-auto"><span class="fs-" style="font-weight: 500;">Night Shift Allowance (Taxable)</span></div>
                                    <div class="col-7 col-lg-6 mt-3 d-flex justify-content-center justify-content-lg-start text-nowrap">
                                        <span class="mx-4 mt-1" style="text-align: right;">Hide</span>
                                        <div class="mt-1">
                                            <label class="switch enable-switch">
                                                <input type="hidden" name="night_shift_allowance_tax" value="0">
                                                <input class="switch_on" name="night_shift_allowance_tax" value="1" type="checkbox" <?= ($DISP_NIGHTSHIFT_ALLOWANCE == 1) ? 'checked' : ''; ?>><span class="slider round"></span>
                                            </label>
                                        </div>
                                        <span class="mx-4 mt-1">Show</span>
                                    </div>
                                </div>


                                <div class="form-group row d-flex justify-content-center">
                                    <div class="col-5 col-lg-6 mt-2  my-auto"><span class="fs-" style="font-weight: 500;">Night Shift Allowance (Non-Taxable)</span></div>
                                    <div class="col-7 col-lg-6 mt-3 d-flex justify-content-center justify-content-lg-start text-nowrap">
                                        <span class="mx-4 mt-1" style="text-align: right;">Hide</span>
                                        <div class="mt-1">
                                            <label class="switch enable-switch">
                                                <input type="hidden" name="night_shift_allowance_nontax" value="0">
                                                <input class="switch_on" name="night_shift_allowance_nontax" value="1" type="checkbox" <?= ($DISP_NIGHTSHIFT_ALLOWANCE_NONTAX == 1) ? 'checked' : ''; ?> ><span class="slider round"></span>
                                            </label>
                                        </div>
                                        <span class="mx-4 mt-1">Show</span>
                                    </div>
