...
<div class="content-wrapper">
  <div class="container-fluid p-4">
    <div class="row pt-1">
      <div class="col-md-6">
        <h1 class="page-title"><a href="<?= base_url() . 'benefits/taxable'; ?>"><img style="width: 24px; height: 24px; margin-bottom: 5px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" /></a>&nbsp;Taxable Types<h1>
      </div>
      <div class="col-md-6 button-title">
        <a href="<?= base_url() . 'benefits/add_taxable_type'; ?>" class=" btn btn-primary shadow-none rounded"><img class="mb-1" src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">&nbsp;Add Type</a>
      ...
      <div class="card border-0 py-1 m-0">
        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered m-0" id="table_main" style="width:100%">
              ...
              <?php if ($DISP_FIXED_TYPE) {  ?>
                  <?php foreach ($DISP_FIXED_TYPE as $type) { ?>
                    <tr >
                      <td><?= $type->id ?></td>
                      <td><?= $type->name ?></td>
                      <td><?= $type->onetime_attendance ?></td>
                      <td style='width:2%;text-align: center;'> <a href="<?= base_url() . 'benefits/edit_taxable_type/'.$type->id; ?>"><img  src="<?= base_url('assets_system/icons/pen-to-square-solid.svg') ?>" alt=""></a> </td>
                    </tr>
                    <?php } ?>
                <?php } else { ?>
