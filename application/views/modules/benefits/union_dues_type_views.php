  ...
  <div class="container-fluid p-4">
    <div class="row pt-1">
      <div class="col-md-6">
        ...
        <h1 class="page-title d-flex align-items-center"><a href="<?= base_url() . 'benefits/union_dues'; ?>"><img style="width: 24px; height: 24px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" />
          </a>&nbsp;Union Dues Types<h1>
      </div>
...
<script>
  ...
  udpate_date.addEventListener('click', function() {
    ...
    fetch(url + 'benefits/update_union_dues_type', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
