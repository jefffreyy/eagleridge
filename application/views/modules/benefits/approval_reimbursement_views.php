    ...
    <div class="modal-dialog approval">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url()?>benefits/reimbursement_approval_action" id="reimbursement_approval_form" method="post">
                    <div class="row">
                        <div class="col-6">
                            <p class="mb-1">Date: <span><?= date(($DATE_FORMAT) ? $DATE_FORMAT : "d/m/Y", strtotime($reimbursement[0]->create_date)) ?></span></p>
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-12">
                            <p class="mb-1">Attachment: <a href="<?= base_url('assets_user/files/benefits/'.$reimbursement[0]->attachment) ?>" download> <?= $reimbursement[0]->attachment ?></a></p>
                        </div>
                        <div class="col-12">
