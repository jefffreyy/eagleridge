...
<div class="content-wrapper">
  <div class="container-fluid p-4">
    <div class="row pt-1">
      <div class="col-md-6">
        <h1 class="page-title"><a href="<?= base_url() . 'benefits/dynamic_standard'; ?>"><i class="fa-duotone fa-circle-left"></i></a>&nbsp;Dynamic Benefit Types<h1>
      </div>
...
<script>
  var url         = '<?= base_url() ?>';
  var dynamic_std = <?= json_encode($DISP_DYNAMIC_TYPE); ?>;
  let data = [
    {id: '', name: '', incentive_type: '', taxable: ''},
    {id: '', name: '', incentive_type: '', taxable: ''},
    {id: '', name: '', incentive_type: '', taxable: ''},
    {id: '', name: '', incentive_type: '', taxable: ''},
    {id: '', name: '', incentive_type: '', taxable: ''},
  ...
  hot = new Handsontable(container, {
    data: dynamic_std,
    colHeaders: ['ID', 'Name', 'Type', 'Taxable'],
    rowHeaders: true,
    height: 'auto',
    ...
    if (selectedRows.length > 0) {
      ...
      if (confirmed) {
        ...
        if (idsToDelete.length > 0) {
          ...
          fetch(url + 'benefits/delete_dynamic_type', {
              method: 'POST',
              headers: {
  ...
  udpate_date.addEventListener('click', function() {
    ...
    // const dynamic_std2 = dynamic_std.filter(item => item.name !== null && );
    // console.log('dynamic_std', dynamic_std)
    // console.log('dynamic_st2', dynamic_std2)
    ...
    fetch(url + 'benefits/update_dynamic_type', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
