            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="modal-body pb-5">
                        <div class="row">
                            <form  action="<?= base_url('benefits/update_taxable_types')?>" method="post" id="" style="width:100%">
                                <div class="col-md-12">
                          
                                    <div class="form-group">
                                        <label class="">Name</label>
                                        <input type="text" class="form-control " name="name" id="name" value="<?= $DISP_TAXABLE_TYPES->name ?>" required >
                                    </div>
                                    <div class="form-group">
                                        <label class="">Type</label>
                                        <select class="form-control" name="type" id="type" >
                                            <option value='One-Time' <?= ($DISP_TAXABLE_TYPES->onetime_attendance == "One-Time") ? "Selected" : ""  ?> >One-Time</option>
                                            <option value='Attendance' <?= ($DISP_TAXABLE_TYPES->onetime_attendance == "Attendance") ? "Selected" : ""  ?> >Attendance</option>
                                        </select>
                                    </div>
                                    <input type="hidden" class="form-control " name="type_id" id="type_id" value="<?= $DISP_TAXABLE_TYPES->id ?>" required >
