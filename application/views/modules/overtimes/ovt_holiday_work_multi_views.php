    ...
    <div class="container-fluid p-4">
      ...
      <div class="row pt-1">
        ...
        <div class="col-md-6">
          ...
          <h1 class="page-title d-flex align-items-center"><a href="<?= base_url('overtimes/holiday_works') ?>"><img style="width: 24px; height: 24px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" />
            </a>&nbsp;Holiday Work<h1>

        </div>

          <div class="col-md-6 button-title">
          <a href="<?= base_url('overtimes/holiday_works') ?>" class=" btn btn-primary"><img class="mb-1" src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
              &nbsp;Normal Request</a>
            ...
            <a href="<?= base_url('overtimes/new_holiday_work_request_direct') ?>" class=" btn btn-primary"><i class="fas fa-plus"></i>&nbsp;Add Request</a>
          </div>
      ...
      <div class="filter-container <?= $filter ? 'visible' : '' ?>">
        <div class="row mb-4   d-flex">
          ...
          <!-- <div class="col-md-2">
            ...
            <a href="<?= base_url('overtimes/holiday_works_multi') ?>" id="btn_clear_filter" class="col btn btn-secondary mx-1">Clear Filter</a>
            ...
            <div class="d-flex justify-content-between align-items-end">
              ...
              <div class="card-header p-0">
                <div class="input-group m-2 ml-auto" style="width:max-content">
                  ...
                  <a href="<?= base_url('overtimes/holiday_works_multi') ?>" id="btn_clear_filter" class="btn btn-primary mx-1"><img src="<?= base_url('assets_system/icons/clear_filter.svg')?>" alt=""/>&nbsp;Clear</a>
                </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('a.paginate').on('click', function() {
        ...
        window.location.href = "<?= base_url('overtimes/holiday_work') ?>" + $(this).attr('href') + filter_url;
      ...
      function reloadPage() {
        ...
        window.location.href = "<?= base_url('overtimes/holiday_works_multi') ?>" + "?status=" + status + "&page=" + page + "&row=" + row + '&search=' + search + filter_url;
