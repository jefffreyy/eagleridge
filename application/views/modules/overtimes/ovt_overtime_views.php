    ...
    <div class="container-fluid p-4">
      ...
      <div class="row pt-1">
        ...
        <div class="col-12 col-md-6 button-title d-block d-lg-flex justify-content-center justify-content-lg-end ">
          <a href="<?= site_url('overtimes/overtime_recommendations') ?>" class="d-none d-lg-inline btn btn-primary shadow-none rounded"><img class="mb-1" src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
            &nbsp;Recommendation</a>
          <?php if ($multiple_request == 1) { ?>
            <a href="<?= base_url('overtimes/overtime_multi') ?>" class="d-none d-lg-inline btn btn-primary shadow-none rounded"><img class="mb-1" src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
              &nbsp;Multi Request</a> <?php } ?>
          <a href="<?= base_url('overtimes/request_overtime') ?>" class=" btn btn-primary shadow-none rounded"><img class="mb-1" src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
            &nbsp;Add Request</a>
