...
<body>
  ...
  <div class="container-fluid p-4">
    <div class="row pt-1">
      <div class="col-md-6">
        <h1 class="page-title"><a href="<?=base_url('overtimes')?>"><i
              class="fa-duotone fa-circle-left"></i></a>&nbsp;Time Adujsments<h1>
      </div>
      ...
      <div class="col-md-6 button-title">
        ...
        <!--</form>-->
        <a href="<?=base_url('overtimes/request_time_adjustment')?>"
          class=" btn technos-button-green shadow-none rounded"><i class="fas fa-plus"></i>&nbsp;Add Request</a>
...
<?php endforeach ?>
        ...
        <div class="col-md-2">
            ...
            <a href="<?=base_url('attendances/time_adjustment_lists')?>" id="btn_clear_filter"
        ...
        <div class="table-responsive">
          ...
          <table class="table table-bordered m-0" id="table_main" style="width:100%">
            <thead>
              ...
              <th class="text-center">Ajustment Date</th>
...
<?php if($TABLE_DATA) {  ?>
    <?php foreach($TABLE_DATA as $row_data) { ?>
              <tr >
                ...
                <td class="text-center" ><?=date_format(date_create($row_data->date_adjustment),'d/m/Y')?></td>
                <td class="text-center" ><?=$row_data->shift_type?></td>
                <td class="text-center" ><?=$row_data->time_in_1?></td>
                <td class="text-center"><?=$row_data->time_out_1?></td>
