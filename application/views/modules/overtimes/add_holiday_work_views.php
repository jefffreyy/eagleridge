...
<div class="content-wrapper" style="min-height: 692.889px;">
    <div class="container-fluid px-4">
        <div class='row mt-3'>
            <div class='col-md-8'>
                <h2><a href="<?= base_url('overtimes/holiday_works') ?>"><img style="width: 32px; height: 32px; " class="mb-1" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt=""></a></h2>
            </div>
        </div>
                    ...
                    <div class="modal-body pb-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <?php echo form_open('overtimes/add_new_holiday_work'); ?>

                                <!-- <label class="">Assigned By</label> -->

                                <input type="hidden" class="form-control" value="<?= $this->session->userdata('SESS_USER_ID') ?>" name='assigned_by' />
