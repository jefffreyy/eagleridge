...
<div class="form-group">
    ...
    <select class="form-control" id="completion" name="COMPLETION" value="<?= isset($completion) ? $completion : '' ?>">
        <option value="">-Select-</option>
        <option value="Incomplete" <?= isset($completion) && $completion === 'Incomplete' ? 'selected' : '' ?>>Incomplete</option>
        <option value="Present" <?= isset($completion) && $completion === 'Present' ? 'selected' : '' ?>>Present</option>
        <option value="Graduate" <?= isset($completion) && $completion === 'Graduate' ? 'selected' : '' ?>>Graduate</option>
</div>