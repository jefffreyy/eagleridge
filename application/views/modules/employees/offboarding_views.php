    ...
    <div class="flex-fill">
      ...
      <div class="row mb-2">
        ...
        <div class="col-md-6 button-title d-flex justify-content-end">
          <a href="<?= base_url('employees') ?>" class="btn btn-primary shadow-none rounded d-flex align-items-center" title="Add">
...
<!-- <script>
  function changeRows(value) {
    window.location.href = "?status=<?= $STATUS ?>&page=<?= $current_page ?>&row=" + value + "&search=<?= $search_data ?>";
  }
</script> -->
</body>
