...
<body>
            ...
            <div class="filter-container <?= $filter ? 'visible' : '' ?>">
                <div class=" mb-4 d-flex row ">
                    ...
                    <!-- <div class="col-md-2">
                        ...
                        <a href=<?= base_url() . "employees/payroll_assignment" ?> id="btn_clear_filter" class="col btn btn-secondary mx-1">Clear Filter</a>
                    </div> -->
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <div class="d-flex row align-items-center">
                                            ...
                                            <div class=" form-group row d-flex justify-content-center justify-content-lg-start col-12 col-md-3 col-lg-6 ">
                                                ...
                                                <a href="<?= base_url('employees/payroll_assignment') ?>" id="btn_clear_filter" class=" btn btn-primary mx-1"><img src="<?= base_url('assets_system/icons/clear_filter.svg') ?>" alt="">&nbsp;Clear</a>


                                            </div>

                                            <div class="row d-none d-lg-flex col-sm-7 col-md-10 col-lg-6 justify-content-center my-lg-0 my-2">
                                                <div class="col-12 col-lg-7 d-flex justify-content-lg-end align-items-end ">
    ...
    <script>
        ...
        function filter_clear() {
            document.location.href = "payroll_assignment";
        }
    </script>
    ...
    <script>
        ...
        const source = ["Rank & File", "Rank & File/Managers"];
    ...
    <script>
        $(document).ready(function() {
            ...
            function filter_data(page_row) {
                ...
                window.location = base_url + "employees/payroll_assignment" + filterUrl;
            }
