...
<script>
  var C_SKILLS_NAME = <?php echo json_encode($C_SKILLS_NAME); ?>;
  var C_SKILLS_LEVEL = <?php echo json_encode($C_SKILLS_LEVEL); ?>;
  ...
  var dataCopy = null;
  var deletedId = [];
  const apiUrl = url + 'employees/get_tableplus_skills_all';
  fetch(apiUrl
  ...
  function initializeHandsontable(data) {
    ...
    hot = new Handsontable(container, {
      data,
      colHeaders: ['ID', 'Employee ID', 'Name', 'Level', 'Status'],
      rowHeaders: true,
      height: 'auto',
      ...
      columns: [{
        ...
        },
        {
          data: 'name', 
          type: 'dropdown',
          source: json_data(C_SKILLS_NAME),
        },
        {
          data: 'value', 
          type: 'dropdown',
          source: json_data(C_SKILLS_LEVEL),
        },
        {
          data: 'status', 
          type: 'dropdown',
  ...
  update_data.addEventListener('click', function() {
    ...
    const apiUrl = url + 'employees/update_skills_all';
    const data = {
      updatedData,
      deletedId
    };
