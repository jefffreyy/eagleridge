        ...
        <div class="container-fluid p-4">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Taxable Allowance
                    </li>
                </ol>
            </nav>
            ...
            <div class="row  pt-1"> <!-- Title starts -->
                <div class="col-md-6">
                    <h1 class="page-title"><a href="<?= base_url() . 'employees'; ?>"><i class="fa-duotone fa-circle-left"></i></a>&nbsp;Taxable Allowance</h1>
                </div>
            ...
            <div class="row mb-4"><!-- Filter Starts -->
                ...
                <div class="col-md-2">
                    ...
                    <a href=<?= base_url() . "employees/taxable_allowance_assign" ?> id="btn_clear_filter" class="col btn btn-secondary mx-1">Clear Filter</a>
                </div>
                        ...
                        <table class="table table-bordered m-0" id="TableToExport" style="width:100%">
                            <thead>
                                ...
                                <?php foreach ($DISP_ALLOWANCE_TYPES as $DISP_ALLOWANCE_TYPES_ROW) { ?>
                                    <th class="text-center std" <?= ($DISP_ALLOWANCE_TYPES_ROW->type == "Attendance") ? 'style="background:#f6d6ff;"' : 'style="background:#feffd6;"'  ?>><?= $DISP_ALLOWANCE_TYPES_ROW->name ?> <br> <?= $DISP_ALLOWANCE_TYPES_ROW->type ?></th>
                                <?php } ?>
                            </thead>
                                            ...
                                            ?>
                                                <td style="padding: 1px !important;">
                                                    <form class="bg-transparent">
                                                        ...
                                                        <input type="text" class="form-control entitlement_val" id="entitlement_val" name="entitlement_val"  step="0.01" style="width:100%;" default=<?=$val?> value=<?= $val; ?>>
                                                    </form>
                                                </td>
                                            <?php } ?>
                                        </tr>
    ...
    <div class="modal fade  class_modal_update_list" id="modela_update" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url() . 'employees/update_allowance_tax'; ?>" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
    ...
    <script>
        $(document).ready(function() {
            ...
            function filter_data(page_row) {
                ...
                window.location = base_url + "employees/taxable_allowance_assign"+page_row+"&branch=" + branch +
            ...
            $('.entitlement_val').on('focusout', function(event) {
                ...
                let year                = $("#filter_year").find(":selected").val();
                console.log(allowance_val)
                if(allowance_val!=defaultVal){
                    window.location = base_url + "employees/process_allowance_assigning_tax/" + employee + "/" + allowance_val + "/" + year + "/" + type;
                }
            })
