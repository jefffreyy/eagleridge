...
<body>
                        ...
                        <div class="">
                            <div class="justify-content-between">
                                ...
                                <div class="d-flex row justify-content-between align-items-center">
                                    <div class="form-group row d-flex justify-content-center justify-content-lg-start col-12 col-lg-4 mx-1">

                                        <label class="col-md-12 mb-1 p-0 text-secondary ">Search Employee</label>

                                        <select id="search_select" class="px-1 col-12 col-lg-6 employee_select form-control w-50 ">
                                            <?php
                                        ...
                                        <a href="<?= base_url('employees/salary_details') ?>" id="btn_clear_filter" class="btn btn-primary mx-1"><img src="<?= base_url('assets_system/icons/clear_filter.svg') ?>" alt="">&nbsp;Clear</a>
    ...
    <script>
        ...
        hot = new Handsontable(container, {
            data: data,
            colHeaders: ['ID', 'Employee ID', 'Employee Name', 'Salary Type', 'Salary Amount', 'No Work with Pay', 'History'],
            rowHeaders: true,
            ...
            //     if (col === 1) {
            //         TH.setAttribute('title', 'Employee ID: Unique identifier for each employee');
            //     }
            // }
        })
        ...
        update_date.addEventListener('click', function() {
            ...
            fetch(url + 'employees/update_salary_detail', {
                method: 'POST',
                headers: {
    ...
    <script>
        $(document).ready(function() {
            ...
            function filter_data(page_row) {
                ...
                window.location = base_url + "employees/salary_details" + filterUrl;
            }
