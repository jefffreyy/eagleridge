            ...
            <div class="flex-fill">
                <div class="row pr-3 mb-3">
                    ...
                    <div class="col ml-auto button-title">
                        <button class="btn btn-primary" id="btn-insert"><img style="height: 1rem; width: 1rem; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-arrow-up-sharp-solid.svg')?>" alt=""/>&nbsp;Update </button>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="p-1">
                        ...
                        <div class="d-flex">
                            ...
                            <a href="<?= base_url('employees/employee_update') ?>" id="btn_clear_filter" class="btn btn-primary mx-1"><img src="<?= base_url('assets_system/icons/clear_filter.svg')?>" alt=""/>&nbsp;Clear</a>
                        </div>
                    </div>
    ...
    <script>
        ...
        function initializeHandsontable(data) {
            ...
            hot = new Handsontable(container, {
                data: data,
                colHeaders: ['Employee ID', 'Last Name', 'Middle Name', 'First Name', 'Suffix', 'Marital Status', 'Home Address', 'Current Address','Province','City','Barangay', 'Birthday', 'Gender', 'Nationality', 'Shirt Size', 'Email Address', 'Mobile Number', 'Hired Date', 'Regularization Date', 'Resignation Date', 'Last Day Date', 'Employment Type', 'Position', 'Company', 'Branch', 'Department', 'Division', 'Clubhouse', 'Section', 'Groups', 'Team', 'Line', 'Image File', 'Bank Name','Account Number', 'SSS Number', 'Pagibig', 'Philhealth', 'TIN', 'Drivers License', 'National ID', 'Passport', 'HMO', 'HMO Number', 'Salary Rate', 'Salary Type'],
                rowHeaders: true,
                height: 'auto',
                // wordWrap: false,
