...
<div class="content-wrapper">
  <div class="container-fluid p-4">
    <div class="row pt-1">
      <div class="col">
        <h1 class="page-title"><a href="<?= base_url() . 'employees/directories'; ?>"><img style="width: 24px; height: 24px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" />
          </a>&nbsp;Quick Edit Employees</h1>
      </div>
    </div>
      ...
      <div class="card border-0 p-1 m-0">
        <div class=" py-3 w-25">
          ...
          <select class="form-control" id="table-id" onchange="pageTable(this.value)">
            ...
            <option value="Work History" selected>Work History</option>
...
<script>
  ...
  var dataCopy = null;
  var deletedId = [];
  const apiUrl = url + 'employees/get_tableplus_data_work_history_all';
  fetch(apiUrl
  ...
  function initializeHandsontable(data) {
    ...
    hot = new Handsontable(container, {
      data,
      colHeaders: ['ID', 'Employee ID', 'Company Name', 'Company Address', 'Date Start', 'Date End', 'Position'],
      rowHeaders: true,
      height: 'auto',
  ...
  update_data.addEventListener('click', function() {
    ...
    const apiUrl = url + 'employees/update_work_history_all';
    const data = {
      updatedData,
      deletedId
    };
