            ...
            <div class="mx-auto card d-block d-lg-none col-11">
                <div class="form-group row d-flex justify-content-center">
                    ...
                    <select name="" class="form-control col-10" id="settingsDropdown">
                        ...
                        <option value="marital_stat" selected>
                           Marital Statuses
                        </option>
                        ...
                        <div class="col-md-9">
                            <div class="row mx-2">
                                <div class="col-md-12 d-flex justify-content-between align-items-center">
                                    <span style="font-weight: 500; font-size: 18px">Marital Statuses</span>
                                    <button class="btn btn-primary pt-1 pb-1" style="margin-left: 8rem;" id="btn-update" style="font-size: 14px"><img class="mb-1" style="height: 1.1rem; width: 1.1rem;" src="<?= base_url('assets_system/icons/circle-arrow-up-sharp-solid.svg') ?>">&nbsp;Update</button>
                                </div>
...
<script>
    ...
    update.addEventListener('click', function() {
        ...
        // insert data
        fetch(url + 'employees/update_marital_statuses', {
                method: 'POST',
                headers: {
