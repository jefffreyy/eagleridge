                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="col-12 d-flex justify-content-between align-items-center">
                                    <span style="font-weight: 500; font-size: 18px">Offset Access</span>
                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                <div class="tab-pane fade show active" id="v-pills-system_setup" role="tabpanel" aria-labelledby="v-pills-system_setup-tab">
                                    <form id="submit_payroll" action="<?= base_url('employees/update_offset_access') ?>" method="Post" enctype="multipart/form-data">
                                        <div class="row mt-3 ">
                                            <div class="col-12 col-lg-6">
                                                <div class="form-group col-5">
                                                    <label for="selfservice_offset">Self-Service</label>
                                                    <select name="selfservice_offset[]" id="selfservice_offset" class="form-control" style='width:100%' multiple multiselect-search="true">
                                                        <?php
                                                        if ($EMPLOYEE_LISTS) {
                                                            foreach ($EMPLOYEE_LISTS as $row) {
                                                                $selected = (in_array($row->id, $selfservice_offset)) ? 'selected' : '';
                                                        ?>
                                            ...
                                            <div class="col-12 col-lg-6">
                                                <div class="form-group col-5">
                                                    <label for="teams_offset">Teams</label>
                                                    <select name="teams_offset[]" id="teams_offset" class="form-control" style='width:100%' multiple multiselect-search="true">
                                                        <?php if ($EMPLOYEE_LISTS) {
                                                            foreach ($EMPLOYEE_LISTS as $row) {
                                                                $selected = (in_array($row->id, $teams_offset)) ? 'selected' : '';
                                                        ?>
                                                                <option value="<?= $row->id ?>" <?= $selected ?>><?= $row->nameWithCMIDList ?></option>
                                                        <?php }
                                                        } ?>
