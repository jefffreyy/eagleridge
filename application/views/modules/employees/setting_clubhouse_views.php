                        ...
                        <div class="col-md-9">
                            <div class="row">
                                <div class="col-md-12 d-flex justify-content-between align-items-center">
                                    <span style="font-weight: 500; font-size: 18px">Clubhouse</span>
                                </div>
...
<script>
    ...
    update.addEventListener('click', function() {
        ...
        function validateData(row, rowIndex, tableColumn, title) {
            const validPositions = tableColumn.map(data => data.name);
        ...
        // insert data
        fetch(url + 'employees/update_clubhouse', {
                method: 'POST',
                headers: {
...
<script>
    $(document).ready(function() {
        ...
        $('#settingsDropdown').on('change', function() {
            ...
            if (selectedValue === 'clubhouse') {
                window.location.href = '<?= base_url('employees/clubhouse') ?>';
            }
