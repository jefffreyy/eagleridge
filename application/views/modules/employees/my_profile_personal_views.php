...
<div class="content-wrapper">
    ...
    <div class="container-fluid p-4">
        ...
        <div class='row'>
            <div class='col-md-8'>
                <h2><a href="<?= base_url() . 'selfservices'; ?>"><img style="width: 32px; height: 32px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" /></a></h2>
            </div>
        </div>
        <div class="row  d-flex justify-content-center">
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div class="d-flex  align-items-center">
                            <div class="profile-pic m-0 p-0">
                                <img class="img-circle rounded-circle avatar m-3 elevation-2" id="employee_img" style="cursor: pointer;" data-toggle="tooltip" data-placement="right" title="Profile Image" src="<?php if ($user_image) {
                            ...
                            <div class="basic-profile p-3">
                                ...
                                <div class="emp-stat m-0 d-flex flex-column p-0">
                                    <div>
                                        <div class="stats-icn mt-2"><img style="" src="<?= base_url('assets_system/icons/briefcase-solid.svg') ?>" alt=""></div>
            ...
            <div class="col-md-8 card p-1" id="content_container">
                ...
                <div class="card-title pl-4 pt-0 pb-0 text-bold header-title d-flex align-items-center">
                    <img style="width: 18px; height: 15.4px; margin-right: 7px;" src="<?= base_url('assets_system/icons/id-card-clip-solid.svg') ?>" alt="">Personal Details
                </div>
                <hr>
                <div class="row pl-4 pt-0 pb-0">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col col-md-6">
                                <span style="font-weight:normal"><?= ($birthdate && strtotime($birthdate) && $birthdate !== '0000-00-00') ? date("d/m/Y", strtotime($birthdate)) : '' ?></span>
                            </div>
                        </div>
                ...
                <div class="row pl-4 pt-0 pb-0 mt-3">
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col col-md-6">
                                ...
                                <span style="font-weight:normal"><?= ($hired_on && strtotime($hired_on) && $hired_on !== '0000-00-00') ? date("d/m/Y", strtotime($hired_on)) : '' ?></span>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col col-md-6">
                                <span style="font-weight:normal"><?= ($regularization_date && strtotime($regularization_date) && $regularization_date !== '0000-00-00') ? date("d/m/Y", strtotime($regularization_date)) : '' ?></span>
                ...
                <div class="row pl-4 pt-0 pb-0 mt-3">
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col col-md-6">
                                <span style="font-weight:normal"><?= ($resignation_date && strtotime($resignation_date) && $resignation_date !== '0000-00-00') ? date("d/m/Y", strtotime($resignation_date)) : '' ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col col-md-6">
                                <p class="mb-0"><?= ($end_on && strtotime($end_on) && $end_on !== '0000-00-00') ? date("d/m/Y", strtotime($end_on)) : '' ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row pl-4 pt-0 pb-0 mt-3">
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col col-md-6">
                                <span style="font-weight:normal"><?= ($termination_date && strtotime($termination_date) && $termination_date !== '0000-00-00') ? date("d/m/Y", strtotime($termination_date)) : '' ?></span>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?= date("d/m/Y", strtotime($C_SKILLS_MATRIX_ROW->edit_date)); ?></td>
                                        </tr>
                                    <?php
                                    }
                                } else {
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?= date("d/m/Y", strtotime($C_DEPENDENTS_ROW->col_depe_bday)); ?></td>
                    ...
                    <div class="table-responsive">
                        <table class="table table table-hover table-nowrap mb-0" style="border:none;">
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            <td><?= $C_LOGS_ROW->log_date ? date("d/m/Y", strtotime(explode(" ", $C_LOGS_ROW->log_date)[0])) : '<a class="text-danger">No data</a>' ?></td>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" autocomplete="off" type="date" value="<?= date("d/m/Y", strtotime($birthdate)) ?>" name="UPDT_EMPL_BIRTHDAY" id="UPDT_EMPL_BIRTHDAY">
                                        </div>
                                    </div>
                                </div>
                            </div>
