            ...
            <div class="mx-auto card d-block d-lg-none col-11">
                <div class="form-group row d-flex justify-content-center">
                    ...
                    <select name="" class="form-control col-10" id="settingsDropdown">
                        ...
                        <option value="departments" selected>
                           Departments
                        </option>
                ...
                <div class="card col-xl-8 col-lg-4 col-md-8 col-11" style="min-height:700px ">
                    <div class="row">
                        ...
                        <div class="col-md-9 ">
                            <div class="row mx-2">
                                <div class="col-md-12">
                                    <span style="font-weight: 500; font-size: 18px">Departments</span>
                                </div>
                            ...
                            <div class="row justify-content-center ">
                                <div class="col-md-12 mb-3 text-nowrap">
...
<script>
    ...
    column_headers = ['Id', 'Name', 'Status']; //Min Hours
    columns = [{
            data: 'id'
        }, {
            data: 'name'
    ...
    update.addEventListener('click', function() {
        ...
        // insert data
        fetch(url + 'employees/update_departments', {
                method: 'POST',
                headers: {
