...
<script>
  ...
  var dataCopy  = null;
  var deletedId = [];
  const apiUrl  = url + 'employees/get_tableplus_education_all';
  fetch(apiUrl
  ...
  function initializeHandsontable(data) {
    ...
    hot = new Handsontable(container, {
      data,
      colHeaders: ['ID', 'Employee ID', 'Degree', 'School', 'From', 'To', 'Grade', 'Address', 'Completion', 'Level'],
      rowHeaders: true,
      height: 'auto',
      ...
      columns: [{
        ...
        {
          data: 'col_educ_degree',
        },
        {
          data: 'col_educ_school',
        },
        {
          data: 'col_educ_from_yr',
        },
        {
          data: 'col_educ_to_yr',
        },
  ...
  update_data.addEventListener('click', function() {
    ...
    const apiUrl = url + 'employees/update_education_all';
    const data = {
      updatedData,
      deletedId
    };
