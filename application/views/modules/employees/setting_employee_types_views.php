            ...
            <div class="ml-0 pr-0 pl-0 " style="display: flex; align-items: center; justify-content: center;">
                <div class="card col-xl-8 col-lg-4 col-md-8 col-11" style="min-height:700px ">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="row mx-2">
                                <div class="col-md-12 d-flex justidy-content-between align-items-center">
                                    <span class="text-nowrap" style="font-weight: 500; font-size: 18px">Employee Types</span>
                                    <button class="ml-auto btn btn-primary pt-1 pb-1" style="" id="btn-update" style="font-size: 14px"><img class="mb-1" style="height: 1.1rem; width: 1.1rem;" src="<?= base_url('assets_system/icons/circle-arrow-up-sharp-solid.svg') ?>">&nbsp;Update </button>
                                </div>
...
<script>
    ...
    update.addEventListener('click', function() {
        ...
        // console.log(changes);
        const hasIdsFrom1To4 = changes.some(item => {
        ...
        if (hasIdsFrom1To4) {
            ...
            const objectsWithIds1To4 = changes.filter(item => {
                const id = parseInt(item.id);
                return id >= 1 && id <= 4;
            });

            const names = objectsWithIds1To4.map(item => item.name);
            
            $(document).Toasts('create', {
                class: 'bg-warning toast_width',
                title: 'Warning!',
                subtitle: 'close',
                body: `${names} can't be edited`
            })
            return;
        }
        ...
        // insert data
        fetch(url + 'employees/update_employees_type', {
                method: 'POST',
                headers: {
