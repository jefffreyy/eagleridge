  ...
  <div class="content-wrapper">
    ...
    <div class="container-fluid p-4">
      ...
      <div class="row pt-1">
        ...
        <div class="col-12 col-md-6 button-title d-block d-lg-flex justify-content-center justify-content-lg-end ">
          <a href="<?= site_url('requests/overtime_recommendations') ?>" class="d-none d-lg-inline btn btn-primary shadow-none rounded"><img class="mb-1" src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
            &nbsp;Recommendation</a>
          <?php if ($multiple_request == 1) { ?>
            <a href="<?= base_url('requests/overtime_multi') ?>" class="d-none d-lg-inline btn btn-primary shadow-none rounded"><img class="mb-1" src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
              &nbsp;Multi Request</a> <?php } ?>
          <a href="<?= base_url('requests/request_overtime') ?>" class=" btn btn-primary shadow-none rounded"><img class="mb-1" src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
            &nbsp;Add Request</a>
      ...
      <div class="mx-auto card py-2 d-block d-lg-none col-12">
        <div class=" form-group row d-flex justify-content-center">
          <label for="" class="col-11 ml-1 ">Go to</label>
              ...
              <div class="">
                <div class="d-flex row align-items-center mx-1">
                  <div class="form-group row d-flex justify-content-center justify-content-lg-start col-12 col-md-3 col-lg-6 ">
                    ...
                    <select class="px-1 col-12 col-md-4 select-employee form-control" id="search_data"> <!-- employee_select  -->
                      <option value=''>All</option>
                      <?php foreach ($EMPLOYEES as $employee) {
                    ...
                    <a href="<?= base_url('requests/overtime') ?>" id="btn_clear_filter" class="mt-2 mt-lg-0 btn btn-primary mx-1"><img src="<?= base_url('assets_system/icons/clear_filter.svg') ?>" alt="" />&nbsp;Clear</a>
                ...
                <?php if ($TABLE_DATA) {  ?>
                  ...
                  <?php foreach ($TABLE_DATA as $row_data) { ?>
                    ...
                    <tr class="hover" data-id="<?= $row_data->id ?>" data-toggle="modal" data-target="#modal_approval">
                      ...
                      <!-- <td class="text-left"><?= date_format(date_create($row_data->date_ot), $DATE_FORMAT) ?></td> -->
                      <td class="text-left"> <?= date(($DATE_FORMAT) ? $DATE_FORMAT: "d/m/Y", strtotime($row_data->date_ot)) ?></td>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('a.paginate').on('click', function() {
        ...
        window.location.href = "<?= base_url('requests/overtime') ?>" + $(this).attr('href') + filter_url;
      ...
      function reloadPage() {
        ...
        var filter_url = '&company=' + company + '&branch=' + branch + '&dept=' + department + '&div=' + division + '&clubhouse=' + clubhouse + '&section=' + '&section=' + section + '&group=' + group + '&team=' + team + '&line=' + line;

        if (document.querySelector('.filter-container').classList.contains('visible')) {
          filter_url = filter_url + '&filter=1';
        }

        window.location.href = "<?= base_url('requests/overtime') ?>" + "?status=" + status + "&page=" + page + "&row=" + row + '&search=' + search + filter_url;
    ...
    $(document).ready(function() {
      ...
      $('#settingsDropdown').on('change', function() {
        ...
        if (selectedValue === 'recommend') {
          window.location.href = '<?= base_url('requests/overtime_recommendations') ?>';
        }
        if (selectedValue === 'multi_request') {
          window.location.href = '<?= base_url('requests/overtime_multi') ?>';
        }
      });
    });
  </script>
