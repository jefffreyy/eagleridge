...
<div class="content-wrapper">
  <div class="container-fluid p-4">
    <div class="">
      <h1 class="page-title d-flex align-items-center"><a onclick="afterRenderFunction()" href="<?= base_url('requests/exemptut_approval') ?>"> <img style="width: 24px; height: 24px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" />
...
<script>
  ...
  $(document).ready(function() {
    ...
    function filter_data(page_row) {
      ...
      window.location = base_url + "requests/exemptut_list_approval" + page_row + filterUrl;
    }
