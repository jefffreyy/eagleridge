...
<div class="content-wrapper" style="min-height: 624px;">
    <div class="container-fluid px-4">
        <div class='row mt-3'>
            <div class='col-md-8'>
                <h2><a href="<?= base_url('requests/overtime') ?>"><img style="width: 32px; height: 32px; " class="mb-1" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt=""></a></h2>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    // Initial fetch shift type
    if ($('#input_employee_id').val() && $('#input_date_ot').val()) {
        $('#input_employee_id').trigger('change');
    }
...
<script>
    ...
    function submitForm() {
        ...
        const apiUrl = baseUrl + 'requests/add_request_overtime';
        fetch(apiUrl, {
                method: 'POST',
                body: requestData
            })
            ...
            .then(data => {
                ...
                if (data.messageError) {
                    ...
                    setTimeout(() => {
                        window.location.href = '<?= base_url() ?>requests/overtime';
                    }, 1200);
                }
            })
            .catch(error => {
