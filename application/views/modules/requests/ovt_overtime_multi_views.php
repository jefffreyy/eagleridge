    ...
    <div class="container-fluid p-4">
      ...
      <div class="row pt-1">
        ...
        <div class="col-md-6 button-title ">
          ...
          <a href="<?= base_url('requests/overtime') ?>" class="d-none d-lg-inline btn btn-primary"><img class="mb-1" src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
            &nbsp;Normal Request</a>
          ...
          <a href="<?= base_url('requests/new_request_overtime_direct') ?>" class="d-none d-lg-inline btn btn-primary"><img class="mb-1" src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
            &nbsp;Add Request</a>
        </div>
                  ...
                  <div class="col-12 col-lg-5 ">
                    <div class="">
                      ...
                      <div class="input-group my-2 d-flex justify-content-center justify-content-lg-start">
                        ...
                        <a href="<?= base_url('requests/overtime_multi') ?>" id="btn_clear_filter" class="mt-3 mt-lg-0 btn btn-primary mx-1"><img src="<?= base_url('assets_system/icons/clear_filter.svg') ?>" alt="" />&nbsp;Clear</a>
                      </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('a.paginate').on('click', function() {
        ...
        window.location.href = "<?= base_url('requests/overtime_multi') ?>" + $(this).attr('href') + filter_url;
      ...
      function reloadPage() {
        ...
        window.location.href = "<?= base_url('requests/overtime_multi') ?>" + "?status=" + status + "&page=" + page + "&row=" + row + '&search=' + search + filter_url;
