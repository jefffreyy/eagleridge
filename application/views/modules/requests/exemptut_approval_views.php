  ...
  <div class="container-fluid p-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h1 class="page-title d-flex align-items-center"><a onclick="afterRenderFunction()" href="<?= base_url('requests') ?>"> <img style="width: 24px; height: 24px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" />
        </a>&nbsp;Exempt Undertime Approval<h1>
      ...
      <div class="card border-0 p-0 m-0">
          ...
          <div>
            <div class=''>
              ...
              <div class='row mt-3 py-1'>
                ...
                <div class="col-12 col-xl-12 d-lg-flex d-none justify-content-between ">
                  <a onclick="afterRenderFunction()" href="<?= base_url('requests/exemptut_list_approval') ?>" class="btn btn-primary shadow-none rounded">
                    &nbsp;Approval List
                  </a>
        ...
        <div class="col-12 col-lg-7 d-lg-none d-block justify-content-lg-end">
          <div class=' ml-auto my-2 my-lg-0 row'>
            <a onclick="afterRenderFunction()" href="<?= base_url('selfservices/exemptut_list_approval') ?>" class="btn btn-primary shadow-none rounded">
              &nbsp;Approval List
            </a>
...
<script>
  ...
  $(document).ready(function() {
    ...
    function filter_data(page_row) {
      ...
      window.location = base_url + "requests/exemptut_approval" + page_row + filterUrl;
    }
