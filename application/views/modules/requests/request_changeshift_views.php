...
<div class="content-wrapper" style="min-height: 624px;">
    <div class='row'>
        <div class='col-md-8 ml-4 mt-3'>
            <h2><a href="change_shift"><img style="width: 32px; height: 32px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="">
</a></h2>
        </div>
    </div>
                    ...
                    <div class="modal-body pb-5">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <!-- <form action="<?= base_url('requests/add_request_shift') ?>" method='post'> -->
                                    ...
                                    <div class="mr-2" style="float: right !important">
                                        <button id="btn_add"  type='button' onclick="submitForm()" class="btn btn-primary shadow-none rounded btn_submit" ;="">
                                            Submit</button>
                                    </div>
                                </form>
                            </div>
...
<script>
    ...
    const apiUrl = baseUrl + 'requests/add_request_shift';
    ...
    .then(result => {
        ...
        try {
            ...
            setTimeout(() => {
                window.location.href = '<?= base_url() ?>requests/change_shift';
            }, 500);
