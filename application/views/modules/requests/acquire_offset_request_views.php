...
<div class="content-wrapper" style="min-height: 624px;">
    <div class="row">
        <div class="col-md-8 ml-4 mt-3">
            <h2><a onclick="afterRenderFunction()" href="<?= base_url('requests/apply_offsets') ?>"><img style="width: 32px; height: 32px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt=""></a></h2>
        </div>
    </div>
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="modal-body pb-5">
                        <div class="row">
                            <div class="col-md-12">
                            <?php echo form_open('requests/add_new_offset'); ?>
                            <!--<label class="">Assigned by</label>-->
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control custom_selection" name="empl_id" id="input_empl_id" onchange="fetchAttendanceRecord()"> <!--id="input_employee_id" -->
...
<script>
    ...
    function fetchAttendanceRecord() {
        const empl_id = $('#input_empl_id').val();
        const date = $('#input_offset_date').val();

        if (!empl_id) return;

        $.ajax({
            url: '<?= base_url("teams/get_attendance_record") ?>',
            type: 'POST',
            dataType: 'json',
            data: {
                empl: empl_id,
