                    ...
                    <div class="row">
                        <div class="col-2 d-none d-lg-block">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                ...
                                <a class="nav-link active" href="<?= site_url('administrators/home_settings') ?>">Home</a>
                                ...
                                <div class="tab-pane fade show active" id="v-pills-system_setup" role="tabpanel" aria-labelledby="v-pills-system_setup-tab">
                                    <form action="<?= base_url('administrators/update_settings') ?>" method="Post">
                                        <div class="row">
                                            <div class="col-12 col-lg-6">
                                                <div class="mt-3 ">
                                                    <div class="row m-2 d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="col-6 d-flex align-items-center justify-content-end">
                                                            <label class="switch ml-3">
                                                                <input type="hidden" class="setting" name="home_announcement" value="<?= $HOME_ANNOUNCEMENT['value'] ?>">
                                                                <input class="switch_on" type="checkbox" <?= $HOME_ANNOUNCEMENT['value'] == 1 ? 'checked' : '' ?>>
                                                    ...
                                                    <div class="m-2 d-flex align-items-center justify-content-between">
                                                        <div class="col-6">
                                                            <label for="">Celebrations</label>
                                                        </div>
                                                        <div class="col-6 d-flex align-items-center justify-content-end">
                                                            <label class="switch ml-3">
                                                                <input type="hidden" class="setting" name="home_celebration" value="<?= $HOME_CELEBRATION['value'] ?>">
                                                                <input class="switch_on" type="checkbox" <?= $HOME_CELEBRATION['value'] == 1 ? 'checked' : '' ?>>
                                                                <span class="slider round"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="">
                                                <label for="">Upcoming Holidays</label>
                                            </div>
                                            <label class="switch ml-3">
                                                <input  type="hidden" class="setting" name="home_upcoming_holidays" value="<?= $HOME_HOLIDAY['value'] ?>">
                                                <input class="switch_on" type="checkbox" <?= $HOME_HOLIDAY['value'] == 1 ? 'checked' : '' ?> >
                                                <span class="slider round"></span>
                                            </label>
                                        </div> -->
                                                    <div class="row m-2 d-flex align-items-center justify-content-between">
                                                        <div class="col-6">
                                                            <label for="">New member this month</label>
                                                        </div>
                                                        <div class="col-6 d-flex align-items-center justify-content-end">
                                                            <label class="switch ml-3">
                                                                <input type="hidden" class="setting" name="home_new_member" value="<?= $HOME_NEW_MEMBER['value'] ?>">
                                                                <input class="switch_on" type="checkbox" <?= $HOME_NEW_MEMBER['value'] == 1 ? 'checked' : '' ?>>
                                                                <span class="slider round"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="row m-2 d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="col-6 d-flex align-items-center justify-content-end">
                                                            <label class="switch ml-3">
                                                                <input type="hidden" class="setting" name="home_leave_info" value="<?= $HOME_LEAVE_INFO['value'] ?>">
                                                                <input class="switch_on" type="checkbox" <?= $HOME_LEAVE_INFO['value'] == 1 ? 'checked' : '' ?>>
                                                                <span class="slider round"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="row m-2 d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="col-6 d-flex align-items-center justify-content-end ">
                                                            <label class="switch ml-3">
                                                                <input type="hidden" class="setting" name="home_team_members" value="<?= $HOME_TEAM_MEMBERS['value'] ?>">
                                                                <input class="switch_on" type="checkbox" <?= $HOME_TEAM_MEMBERS['value'] == 1 ? 'checked' : '' ?>>
                                                                <span class="slider round"></span>
                                                            </label>
                                                        </div>
                                                    </div>
