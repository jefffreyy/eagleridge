            ...
            <div class="mx-auto card d-block d-lg-none col-11">
                <div class="form-group row d-flex justify-content-center">
                    ...
                    <select name="" class="form-control col-10" id="settingsDropdown">
                        ...
                        <option value="payroll_officers" selected>
                            Payroll Officers
                        </option>
                    ...
                    <div class="row">
                        <div class="col-2 d-none d-lg-block">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                ...
                                <a class="nav-link active" href="<?= site_url('administrators/payroll_settings') ?>">Payroll Officers</a>
                        ...
                        <div class="col">
                            <div class="tab-content" id="v-pills-tabContent">
                                <div class="tab-pane fade show active" id="v-pills-system_setup" role="tabpanel" aria-labelledby="v-pills-system_setup-tab">
                                    <form id="submit_payroll" action="<?= base_url('administrators/update_settings') ?>" method="Post" enctype="multipart/form-data">
                                        <div class="row mt-3 ">
                                            <div class="col-12 col-lg-6">
                                                <div class="form-group col-5">
                                                    <label for="payroll_managers">Managers</label>
                                                    <select name="payroll_managers[]" id="payroll_managers" class="form-control" style='width:100%' multiple multiselect-search="true">
                                                        <?php
                                                        if ($EMPLOYEE_LISTS) {
                                                            foreach ($EMPLOYEE_LISTS as $row) {
                                                                $selected = (in_array($row->id, $payroll_managers)) ? 'selected' : '';
                                                        ?>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group col-5">
                                                    <label for="payroll_rankandfile">Rank and File Staffs</label>
                                                    <select name="payroll_rankandfile[]" id="payroll_rankandfile" class="form-control" style='width:100%' multiple multiselect-search="true">
                                                        <?php if ($EMPLOYEE_LISTS) {
                                                            foreach ($EMPLOYEE_LISTS as $row) {
                                                                $selected = (in_array($row->id, $payroll_rankandfile)) ? 'selected' : '';
                                                        ?>
                                                                <option value="<?= $row->id ?>" <?= $selected ?>><?= $row->nameWithCMIDList ?></option>
                                                        <?php }
                                                        } ?>
