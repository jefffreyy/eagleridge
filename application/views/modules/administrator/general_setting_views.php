                    ...
                    <div class="row">
                        <div class="col-2 d-none d-lg-block">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                <a class="nav-link active" href="<?= site_url('administrators/generalsettings') ?>">System Setup</a>
                                ...
                                <div class="tab-pane fade show active" id="v-pills-system_setup" role="tabpanel" aria-labelledby="v-pills-system_setup-tab">
                                    <form action="<?php echo base_url(); ?>administrators/update_general_settings" method="post" accept-charset="utf-8" autocomplete='off' class="m-2" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row mb-4">
                                            <label class="col-12 col-lg-3" for="">Company Name</label>
                                        ...
                                        <div class="form-group row mb-4">
                                            <label class="col-12 col-lg-3" for="">Header Content</label>
                                            <div class="col-12 col-lg-9">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-12 col-lg-3" for="">Side Navbar Logo</label>
                                            <div class="col-12 col-lg-9">
                                                <div class="input-group">
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input fileficker" id="update_nav_logo" name="update_nav_logo" multiple="" accept=".jpg, .jpeg, .png" style="width: 96% !important;">
                                                        <label class="custom-file-label" id="preview_nav_logo" for="update_nav_logo">Choose file
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="row m-2 image">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-12 col-lg-3" for="">Login Form Logo</label>
                                            <div class="col-12 col-lg-9">
                                                <div class="input-group">
                                                    <div class="custom-file">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-12 col-lg-3" for="">Header Logo (Mobile)</label>
                                            <div class="col-12 col-lg-9">
                                                <div class="input-group">
                                                    <div class="custom-file">
