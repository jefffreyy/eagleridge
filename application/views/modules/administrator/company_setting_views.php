                    ...
                    <div class="row">
                        <div class="col-2 d-none d-lg-block">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                ...
                                <!-- <a class="nav-link " href="<?= site_url('administrators/time_keeping_settings') ?>">Remote In / Out</a> -->
                                <!-- <a class="nav-link " href="<?= site_url('administrators/employee_settings') ?>">Employee</a> -->
                                <a class="nav-link active" href="<?= site_url('administrators/company_settings') ?>">Company Structure</a>
                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                <div class="tab-pane fade show active" id="v-pills-system_setup" role="tabpanel" aria-labelledby="v-pills-system_setup-tab">
                                    <form action="<?= base_url('administrators/update_settings') ?>" method="Post">
                                            ...
                                            <div class="col-12 col-lg-6">
                                                <div class="mt-3 ">
                                                    <div class="row m-2 d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="col-6 d-flex justify-content-center justify-content-lg-end">
                                                            <label class="switch ml-3">
                                                                <input type="hidden" class="setting" name="com_company" value="<?= $COM_COMPANY['value'] ?>">
                                                                <input class="switch_on" type="checkbox" <?= $COM_COMPANY['value'] == 1 ? 'checked' : '' ?>>
                                                    ...
                                                    <div class="row m-2 d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="col-6 d-flex justify-content-center justify-content-lg-end">
                                                            <label class="switch ml-3">
                                                                <input type="hidden" class="setting" name="com_branch" value="<?= $COM_BRANCH['value'] ?>">
                                                                <input class="switch_on" type="checkbox" <?= $COM_BRANCH['value'] == 1 ? 'checked' : '' ?>>
                                                                <span class="slider round"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="row m-2 d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="col-6 d-flex justify-content-center justify-content-lg-end">
                                                            <label class="switch ml-3">
                                                                <input type="hidden" class="setting" name="com_Department" value="<?= $COM_DEPARTMENT['value'] ?>">
                                                                <input class="switch_on" type="checkbox" <?= $COM_DEPARTMENT['value'] == 1 ? 'checked' : '' ?>>
                                                                <span class="slider round"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="row m-2 d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="col-6 d-flex justify-content-center justify-content-lg-end">
                                                            <label class="switch ml-3">
                                                                <input type="hidden" class="setting" name="com_division" value="<?= $COM_DIVISION['value'] ?>">
                                                                <input class="switch_on" type="checkbox" <?= $COM_DIVISION['value'] == 1 ? 'checked' : '' ?>>
                                                                <span class="slider round"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="row m-2 d-flex align-items-center justify-content-between">
                                                        <div class="col-6">
                                                            <label for="">Clubhouse</label>
                                                        </div>
                                                        <div class="col-6 d-flex justify-content-center justify-content-lg-end">
                                                            <label class="switch ml-3">
                                                                <input type="hidden" class="setting" name="com_clubhouse" value="<?= $COM_CLUBHOUSE['value'] ?>">
                                                                <input class="switch_on" type="checkbox" <?= $COM_CLUBHOUSE['value'] == 1 ? 'checked' : '' ?>>
                                                                <span class="slider round"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="row m-2 d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="col-6 d-flex justify-content-center justify-content-lg-end">
                                                            <label class="switch ml-3">
                                                                <input type="hidden" class="setting" name="com_section" value="<?= $COM_SECTION['value'] ?>">
                                                                <input class="switch_on" type="checkbox" <?= $COM_SECTION['value'] == 1 ? 'checked' : '' ?>>
                                                                <span class="slider round"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="row m-2 d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="col-6 d-flex justify-content-center justify-content-lg-end">
                                                            <label class="switch ml-3">
                                                                <input type="hidden" class="setting" name="com_group" value="<?= $COM_GROUP['value'] ?>">
                                                                <input class="switch_on" type="checkbox" <?= $COM_GROUP['value'] == 1 ? 'checked' : '' ?>>
                                                                <span class="slider round"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="row m-2 d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="col-6 d-flex justify-content-center justify-content-lg-end">
                                                            <label class="switch ml-3">
                                                                <input type="hidden" class="setting" name="com_team" value="<?= $COM_TEAM['value'] ?>">
                                                                <input class="switch_on" type="checkbox" <?= $COM_TEAM['value'] == 1 ? 'checked' : '' ?>>
                                                                <span class="slider round"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="row m-2 d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="col-6 d-flex justify-content-center justify-content-lg-end">
                                                            <label class="switch ml-3">
                                                                <input type="hidden" class="setting" name="com_line" value="<?= $COM_LINE['value'] ?>">
                                                                <input class="switch_on" type="checkbox" <?= $COM_LINE['value'] == 1 ? 'checked' : '' ?>>
                                                                <span class="slider round"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                        ...
                                        <button type="submit" class="btn btn-primary ml-auto d-block mt-5 mt-lg-0"><img class="mb-1" style="height: 1.1rem; width: 1.1rem;" src="<?= base_url('assets_system/icons/circle-arrow-up-sharp-solid.svg') ?>" alt="" />&nbsp;Update</button>
                                    </form>
                                </div>
                            </div>
                        </div>
