            ...
            <div class="mx-auto card d-block d-lg-none col-11">
                <div class="form-group row d-flex justify-content-center">
                    ...
                    <select name="" class="form-control col-10" id="settingsDropdown">
                        ...
                        <option value="administrators" selected>
                            Administrators
                        </option>
                    ...
                    <div class="row" >
                        <div class="col-2 d-none d-lg-block">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                              ...
                              <a class="nav-link active" href="<?=site_url('administrators/administrator_settings')?>">Administrators</a>
                                        ...
                                        <div class="row mt-3 ">
                                            <div class="col-12 col-lg-6">
                                                <div class="form-group m-2 p-2">
                                                    <label class="m-0" for="system_administrator">System Administrator</label>
                                                    <select name="system_administrator"  id="system_administrator" class="form-control m-0" style='width: fit-content'>
                                                        <option value="" <?= (!empty($system_administrator)) ? 'selected' : '' ?>>-Select System Administrator-</option>
                                                        <?php if ($EMPLOYEE_LISTS) { foreach ($EMPLOYEE_LISTS as $row) { 
                                                            $selected = ($row->id == $system_administrator['value']) ? 'selected' : '';
                                                            ?>
                                            ...
                                            <!-- <div class="col-12">
                                                <div class="form-group col-5 m-2 d-flex align-items-center justify-content-between">
                                                    <label for="payroll_administrator">Payroll Administrator</label>
                                                    <select name="payroll_administrator"  id="payroll_administrator" class="form-control ml-3" style='width:100%'>
                                                        <option value="" <?= (!empty($payroll_administrator)) ? 'selected' : '' ?>>-Select Payroll Administrator-</option>
                                                        <?php if ($EMPLOYEE_LISTS) { foreach ($EMPLOYEE_LISTS as $row) { 
                                                            $selected = ($row->id == $payroll_administrator['value']) ? 'selected' : '';
                                                            ?>
                                                            <option value="<?= $row->id ?>" <?= $selected ?> ><?= $row->nameWithCMIDList ?></option>
                                                        <?php } } ?>
