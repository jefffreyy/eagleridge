    ...
    <div class="container-fluid p-4">
        ...
        <div class="row pt-1">
            ...
            <div class="col-md-6 button-title d-flex justify-content-center justify-content-lg-end">
                ...
                <a href="<?= base_url('hressentials/add_warning') ?>" class="mr-1 btn btn-primary shadow-none rounded"><img class="mb-1" src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
                    &nbsp;Add Warning</a>
            ...
            <div class="p-2">
                ...
                <div class="row py-1">
                    ...
                    <div class="col-12 col-xl-3 d-flex justify-content-lg-start justify-content-center align-items-center">
                        <button style="height: 36px;" id=btn_mark_active class="mr-1 btn technos-button-green shadow-none rounded bulk-button" data-toggle="modal" data-id=Active data-target="#modal_set_ssa" data-action='activate' status=Mark as Active>
                            <img style="height: 1rem; width: 1rem; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-check-solid_mark.svg') ?>" alt="">
                            &nbsp;Mark as Active
                        </button>

                        <button style="height: 36px;" id=btn_mark_inactive class="btn btn-danger shadow-none rounded bulk-button" data-toggle="modal" data-id=Inactive data-target="#modal_set_ssa" data-action='deactivate' status=Mark as Inactive><img style="height: 1rem; width: 1rem; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-x-solid_mark_as.svg') ?>" alt="">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered m-0" id="table_main" style="width:100%">
                    ...
                    <thead>
                        ...
                        <th style='width:20%;text-align: left;'>EMPLOYEE</th>
                        <th style='width:20%;text-align: left;'>TITLE</th>
                        <th style='width:35%;text-align: left;'>DESCRIPTION</th>
                        <th style='width:20%;text-align: left;'>FEEDBACK</th>
                            ...
                            <?php foreach ($WARNINGS as $warning) : ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" id="select_item">
                                        ...
                                        <input type="checkbox" name="brand" class="check_single" row_id="<?= $warning->id ?>">

                                    </td>
                                    <td class="text-left" style="width:5%"><?= $warning->format_id ?></td>
                                    <td class="text-left" style="width:20%"><?= $warning->fullname ?></td>
                                    <td class="text-left" style="width:20%"><?= $warning->title ?></td>
                                    <td class="text-left" style="width:35%"><?= $warning->description ?></td>
                                    <td class="text-left" style="width:20%"><?= $warning->feedback ?></td>
                                    <td class="text-center" style="width:15%"><?= $warning->status ?></td>
                                    <td class="text-center">

                                        <div class="action_btn">

                                            <a href="<?= base_url('hressentials/warning/' . $warning->id) ?>" class="select_edit_row m-1" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important" row_id="9"><img src="<?= base_url('assets_system/icons/eye-sharp-solid_dark.svg') ?>" alt="" /></a>



                                            <a href="<?= base_url('hressentials/edit_warning/' . $warning->id) ?>" type="submit" class="select_edit_row m-1" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important" row_id="9"><img src="<?= base_url('assets_system/icons/pen-to-square-solid.svg') ?>" alt="" /></a>
    ...
    <div class="modal-dialog modal-md" role="document">
        ...
        <div class="modal-content">
            ...
            <form id='form_activation' action="" method="post">
                ...
                <input type='hidden' name='table' value="tbl_hr_warnings">

                <input type='hidden' name='sub_url' value="warnings">
...
<script>
    $(document).ready(function() {
        ...
        var table_name = "tbl_hr_warnings";
        ...
        $('.delete_data').click(function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "https://dev-env.eyebox.app/" + "main_table_02/delete_row?delete_id=" + user_deleteKey + "&table=" + table_name + "&module=" + module_name + "&page=" + page_name;
