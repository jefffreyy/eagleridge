    ...
    <div class="container-fluid p-4">
        ...
        <div class="row pt-1">
            ...
            <div class="col-md-6 button-title d-flex justify-content-center justify-content-lg-end">
                <a href="<?= base_url('hressentials/add_support') ?>" class="mr-1 btn btn-primary shadow-none rounded">
        ...
        <div class="card border-0 p-0 m-0">
            ...
            <div class="card border-0 pt-1 m-0">
                ...
                <div class="card-header p-0 row">
                    ...
                    <div class="col-12 col-xl-4 mt-1 mt-lg-0">

                        <div class="input-group ml-auto mr-1" style="width:max-content">
                            ...
                            <select class="select-employee d-block" id="search_data" style="">
                                <option value=''>All</option>
                                <?php foreach ($EMPLOYEE_LIST as $employee) { ?>
                                    <option value="<?= $employee->id ?>" <?= $EMPLOYEE == $employee->id ? 'selected' : '' ?>>
                                        <?= $employee->employee ?>
                                    </option>
                                <?php } ?>
                            </select>
            ...
            <div class="p-2">
                ...
                <div class="row py-1">
                    <div class="col-12 col-xl-3 d-flex justify-content-lg-start justify-content-center align-items-center">
                        ...
                        <div class="d-flex align-items-center  row">
                            <div class="d-inline col-12 col-xl-6">
                                <p class="p-0 m-0 text-center text-nowrap" style="color: gray">Showing <?= $low_limit ?>
                                    to <?= $high_limit ?> of <?= $C_DATA_COUNT ?> entries&nbsp;
                                </p>
                            </div>
                            <div class="d-lg-inline d-flex col-12 col-xl-6 justify-content-center">
                                <ul class="pagination ml-0 ml-lg-4 m-0 p-0">
                                    ...
                                    <li><a <?php if ($current_page > 1)
                                                echo "href='?page=$prev_page&row=$row&tab=$TAB&all=$EMPLOYEE'"; ?>>

                                            < </a>

                                    </li>

                                    <li><a href="?page=1&row=<?= $row ?>&tab=<?= $TAB ?>&all=<?= $EMPLOYEE ?>" <?php if ($current_page == 1)
                                                                                                                    echo "hidden"; ?>>1 </a></li>

                                    <li><a <?php if ($current_page <= 2)
                                                echo "hidden"; ?>>... </a></li>

                                    <li><a href="?page=<?= $current_page - 1 ?>&row=<?= $row ?>&tab=<?= $TAB ?>&all=<?= $EMPLOYEE ?>" <?php if ($current_page <= 2)
                                    ...
                                    <li><a href="?page=<?= $current_page + 1 ?>&row=<?= $row ?>&tab=<?= $TAB ?>&all=<?= $EMPLOYEE ?>" <?php if ($current_page >= $last_page - 1)
                                                                                                                                            echo "hidden"; ?>><?= $next_page ?> </a></li>

                                    <li><a <?php if ($current_page >= $last_page - 1)
                                                echo "hidden"; ?>>... </a></li>

                                    <li><a href="?page=<?= $last_page ?>&row=<?= $row ?>&tab=<?= $TAB ?>&all=<?= $EMPLOYEE ?>" <?php if ($current_page == $last_page || $last_page <= 0)
                                                                                                                                    echo "hidden"; ?>><?= $last_page ?> </a></li>

                                    <li><a style="margin-right: 10px;" <?php if ($current_page < $last_page)
                                                                            echo "href='?page=$next_page&row=$row&tab=$TAB&all=$EMPLOYEE'"; ?>>> </a>
                                    </li>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered m-0" id="table_main" style="width:100%">
                    ...
                    <thead>
                        ...
                        <th class="text-center" style="width:5%"><input type="checkbox" name="check_all" id="check_all">
                        </th>
                    ...
                    <tbody id="tbl_application_container">
                        <?php if ($TABLE_DATA) { ?>
                            <?php foreach ($TABLE_DATA as $tow_data) : ?>

                                <tr>

                                    <td class="text-center" id="select_item">

                                        <input type="checkbox" name="brand" class="check_single" row_id="<?= $tow_data->id ?>">
                                    ...
                                    <td class="text-left" style="width:5%">
                                        <?= 'SUP' . str_pad($tow_data->id, 5, '0', STR_PAD_LEFT) ?>
                                    </td>
                                    <td class="text-left" style="width:20%"><?= $tow_data->employee ?></td>

                                    <td class="text-left" style="width:20%"><?= $tow_data->title ?></td>



                                    <td class="text-left" style="width:35%"><?= $tow_data->description ?></td>



                                    <td class="text-center" style="width:15%"><?= $tow_data->status ?></td>
                                    ...
                                    <td class="text-center">
                                        <div class="action_btn">
                                            ...
                                            <a href="<?= base_url('hressentials/show_support/' . $tow_data->id) ?>" class="select_edit_row m-1" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important" row_id="9"> <img src="<?= base_url('assets_system/icons/eye-sharp-solid_dark.svg') ?>" alt="">
                                            </a>



                                            <a href="<?= base_url('hressentials/edit_support/' . $tow_data->id) ?>" type="submit" class="select_edit_row m-1" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important" row_id="9"><img src="<?= base_url('assets_system/icons/pen-to-square-solid.svg') ?>" alt="">
                                            </a>
            ...
            <div class="col-12 col-lg-6 d-lg-none d-flex justify-content-lg-end">
                <div class="col-12  col-lg-6 ml-auto my-2 my-lg-0 row d-flex justify-content-lg-end justify-content-center align-items-center">
                    <div class="d-flex col-12 col-lg-8 justify-content-lg-end justify-content-center align-items-center">
                        <p class="p-0 m-0 text-center text-nowrap" style="color: gray">Showing <?= $low_limit ?> to
                            <?= $high_limit ?> of <?= $C_DATA_COUNT ?> entries&nbsp;
                        </p>
                    </div>
                    ...
                    <div class="d-lg-inline d-flex col-12 col-lg-4 justify-content-center">
                        <ul class="pagination ml-0 ml-lg-4 m-0 p-0">
                            ...
                            <li><a style="margin-right: 10px;" <?php if ($current_page < $last_page)
                                                                    echo "href='?page=$next_page&row=$row&tab=$TAB&all=$EMPLOYEE'"; ?>>> </a></li>
            ...
            <div class="col-sm-3 col-md-2 col-lg-2  d-flex d-lg-none align-items-center justify-content-center justify-content-lg-start mr-lg-0 m-2">
                ...
                <select id="row_dropdown" class="custom-select" style="width: auto;">
                    ...
                    foreach ($C_ROW_DISPLAY as $C_ROW_DISPLAY_ROW) { ?>
                        ...
                        <option value=<?= $C_ROW_DISPLAY_ROW ?> <?php echo ($C_ROW_DISPLAY_ROW == $row) ? "selected" : ''; ?>>
    ...
    <div class="modal-dialog modal-md" role="document">
        ...
        <div class="modal-content">
            ...
            <form id='form_activation' action="" method="post">
                ...
                <input type='hidden' name='table' value="tbl_hr_supports">

                <input type='hidden' name='sub_url' value="supports">
