    ...
    <div class="container-fluid p-4">
        ...
        <div class="row pt-1">
            ...
            <div class="col-md-6 button-title  d-flex justify-content-center justify-content-lg-end">
                <a href="<?= base_url('hressentials/add_policies') ?>" class="mr-1 btn btn-primary shadow-none rounded">
                    <img class="mb-" src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
                    &nbsp;Add Policy</a>

                <a id="btn_export" class=" btn btn-primary text-light shadow-none rounded">
                    <img class="mb-1" src="<?= base_url('assets_system/icons/file-export-solid.svg') ?>" alt="">
                    &nbsp;Export XLSX</a>
            ...
            <div class="card border-0 pt-1 m-0">
                ...
                <div class="p-2">
                    ...
                    <div class="row py-1 align-items-center">
                        ...
                        <div class="col-12 col-xl-3 d-flex justify-content-lg-start justify-content-center">
                            <button id=btn_mark_active class="mr-1 btn technos-button-green shadow-none rounded bulk-button" data-toggle="modal" data-id=Active data-target="#modal_set_ssa" data-action='activate' status=Mark as Active><img style="height: 1rem; width: 1rem; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-check-solid_mark.svg') ?>" alt="">
                                &nbsp;Mark as Active</button>

                            <button id=btn_mark_inactive class="btn btn-danger shadow-none rounded bulk-button" style="padding: 5px 12px 5px 12px" data-toggle="modal" data-id=Inactive data-target="#modal_set_ssa" data-action='deactivate' status=Mark as Inactive><img style="height: 1rem; width: 1rem; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-x-solid_mark_as.svg') ?>" alt="">
                        ...
                        <div class="col-12 col-xl-9 d-lg-flex d-none justify-content-end">
                            ...
                            <div class="col-sm-3 col-md-2 col-xl-1 col-2-xl  d-none d-lg-flex align-items-center justify-content-center mr-lg-0 ">
                                ...
                                <?php foreach ($POLICIES as $policy) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" id="select_item">
                                            ...
                                            <input type="checkbox" name="brand" class="check_single" row_id="<?= $policy->id ?>">

                                        </td>



                                        <td class="text-left" style="width:5%"><?= 'POL' . str_pad($policy->id, 5, '0', STR_PAD_LEFT) ?></td>



                                        <td class="text-left" style="width:20%"><?= $policy->title ?></td>



                                        <td class="text-left" style="width:35%"><?= $policy->description ?></td>



                                        <td class="text-center" style="width:15%"><?= $policy->status ?></td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <div class="action_btn">
                                                ...
                                                <a href="<?= base_url('hressentials/policy/' . $policy->id) ?>" class="select_edit_row m-1" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important" row_id="9"> <img src="<?= base_url('assets_system/icons/eye-sharp-solid_dark.svg') ?>" alt="" id="view">
                                                </a>



                                                <a href="<?= base_url('hressentials/edit_policy/' . $policy->id) ?>" type="submit" class="select_edit_row m-1" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important" row_id="9"><img src="<?= base_url('assets_system/icons/pen-to-square-solid.svg') ?>" alt="" id="edit">
                                                    </i></a>
                ...
                <div class="col-12 col-lg-5 d-lg-none d-flex justify-content-lg-end">
                    <div class="col-12  col-lg-6 ml-2 my-2 my-lg-0 row d-flex justify-content-lg-end justify-content-center align-items-center">
                        <div class="d-flex col-12 col-lg-6 justify-content-lg-end justify-content-center align-items-center">
                            <p class="p-0 m-0 text-center text-nowrap" style="color: gray">Showing <?= $low_limit ?> to <?= $high_limit ?> of <?= $C_DATA_COUNT ?> entries&nbsp;</p>
                        </div>
    ...
    <div class="modal-dialog modal-md" role="document">
        ...
        <div class="modal-content">
            ...
            <form id='form_activation' action="" method="post">
                ...
                <input type='hidden' name='table' value="tbl_hr_policies">

                <input type='hidden' name='sub_url' value="policies">
