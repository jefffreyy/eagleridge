                    ...
                    <div class="modal-body pb-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <?php echo form_open_multipart('hressentials/add_new_support'); ?>
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input required type="text" class="form-control" name="title" id="input_title" enabled="" value="">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="feedback" class="form-control" id="input_feedback" rows="4" cols="50" enabled="" spellcheck="false"></textarea>
