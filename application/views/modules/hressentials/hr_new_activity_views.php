                    ...
                    <div class="modal-body pb-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <?php echo form_open('hressentials/save_activity'); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input  type="text" class="form-control" name="title" id="input_title" enabled="" value="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="duration" id="input_duration" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="location" id="input_location" value="">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" name="description" class="form-control" id="input_description" rows="4" cols="50" enabled=""></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="d-flex align-items-center">
                                        ...
                                        <input type="checkbox" class="mr-2 mb-0"  id="check-select_all"> 
...
<script>
    $(document).ready(function() {
        ...
        $('input#input_duration').daterangepicker({
            ...
            endDate: moment().startOf('hour').add(30, 'minutes'),
            locale: {
