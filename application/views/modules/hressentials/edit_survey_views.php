					...
					<div class="modal-body pb-5">
						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<form action="<?=base_url('hressentials/update_survey')?>" method="POST">
    								...
    								<div class="form-group">
    									...
    									<textarea name="description" class="form-control" id="input_description" rows="4"
    										...
    										cols="50" enabled><?=$SURVEY->description?></textarea>
    								...
    								<div class="form-group">
    									...
    									<textarea name="feedback" class="form-control" id="input_feedback" rows="4"
    										...
    										cols="50" enabled><?=$SURVEY->feedback?></textarea>
    								...
    								<div class="form-group">
                                        ...
                                        <div class="file_uploader" data-type="hressentials">
                                            <input type="hidden" value="<?=$SURVEY->attachment?>" name="attachment" class="selected_images d-block w-100"/>
                                        </div>
                                    </div>
