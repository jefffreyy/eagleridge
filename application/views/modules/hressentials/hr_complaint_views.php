    ...
    <div class="container-fluid p-4">
        ...
        <div class="row pt-1">
            ...
            <div class="col-md-6 button-title d-flex justify-content-center justify-content-lg-end">
                <a href="<?= base_url('hressentials/add_complaint') ?>" class="mr-1 btn btn-primary shadow-none rounded">
                ...
                <div class="p-2 ">
                    ...
                    <div class="row py-1 align-items-center">
                        ...
                        <div class="col-12 col-xl-9 d-lg-flex d-none justify-content-end">
                                ...
                                <div class="d-lg-inline d-flex col-12 col-xl-6 justify-content-center">
                                    <div class="d-lg-inline d-flex col-12 col-lg-4 justify-content-center">
                                        <ul class="pagination ml-0 ml-lg-4 m-0 p-0">
                                            ...
                                            <li><a <?php if ($current_page > 1) echo "href='?page=$prev_page&row=$row&tab=$TAB&all=$EMPLOYEE'"; ?>>
                            ...
                            <div class="col-sm-3 col-md-2 col-lg-1 col-2-xl d-none d-lg-flex align-items-center justify-content-center  mr-lg-0 mr-2">
                        ...
                        <?php if ($TABLE_DATA) { ?>
                            <?php foreach ($TABLE_DATA as $row_data) : ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left" style="width:5%"><?= 'CMP' . str_pad($row_data->id, 5, '0', STR_PAD_LEFT) ?></td>
                                    ...
                                    <td class="text-center">
                                        <div class="action_btn">
                                            ...
                                            <a href="<?= base_url('hressentials/show_complaint/' . $row_data->id) ?>" class="select_edit_row m-1" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important" row_id="9">
                                                <img src="<?= base_url('assets_system/icons/eye-sharp-solid_dark.svg') ?>" alt="">
                                            </a>
                                            <a href="<?= base_url('hressentials/edit_complaint/' . $row_data->id) ?>" type="submit" class="select_edit_row m-1" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important" row_id="9">
    ...
    <div class="modal-dialog modal-md" role="document">
        ...
        <div class="modal-content">
            ...
            <form id='form_activation' action="" method="post">
                ...
                <input type='hidden' name='table' value="tbl_hr_complaints">

                <input type='hidden' name='sub_url' value="complaints">
