							...
							<div class="col-md-12">
    								...
    								<div class="form-group">
    									...
    									<textarea name="description" class="form-control" id="input_description" rows="4"
    										...
    										cols="50" disabled><?=$SUPPORT->description?></textarea>
    								...
    								<div class="form-group">
    									...
    									<textarea name="feedback" class="form-control" id="input_feedback" rows="4"
    										...
    										cols="50" disabled><?=$SUPPORT->feedback?></textarea>

    								</div>

    								<div class="form-group">
                                        <label class="d-block" for="input_attachment">Attachment</label>
                                        <a download href="<?=base_url('assets_user/files/hressential/'.$SUPPORT->attachment)?>"><?=$SUPPORT->attachment?></a>
                                    </div>
