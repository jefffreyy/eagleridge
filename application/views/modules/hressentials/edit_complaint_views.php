...
<div class="content-wrapper">
	...
	<div class='row'>
		...
		<div class='col-md-8 ml-4 mt-3'>
			...
			<!-- <h2><a href="<?=base_url('hressentials/complaints')?>"><i class="fa-duotone fa-circle-left"></i></a></h2> -->
			<h2><a href="<?= base_url() . 'hressentials/complaints'; ?>">
					...
					<div class="modal-body pb-5">
						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<form action="<?=base_url('hressentials/update_complaint')?>" method="POST" enctype="multipart/form-data">
								    ...
								    <div class="form-group">
										...
										value="<?='CMP' . str_pad($COMPLAINT->id, 5, '0', STR_PAD_LEFT)?>">

    								</div>

									<div class="form-group">
                                        <label class="" for="input_create_date">Create Date</label>
                                        <input type="text" class="form-control" disabled value="<?= !empty($COMPLAINT->create_date) ? 
                                        date_format(date_create($COMPLAINT->create_date), $DATE_FORMAT . ' H:i:s A') : '' ?>">
                                    </div>
    								...
    								<!-- <div class="form-group">
    									...
    									<input type="datetime-local" class="form-control" name="input_create_date"
    										...
    										id="input_create_date" disabled value="<?=$COMPLAINT->create_date?>">

    								</div> -->

									<div class="form-group">
                                        <label class="" for="input_edit_date">Edit Date</label>
                                        <input type="text" class="form-control" disabled value="<?= !empty($COMPLAINT->edit_date) ? 
                                        date_format(date_create($COMPLAINT->edit_date), $DATE_FORMAT . ' H:i:s A') : '' ?>">
                                    </div>
    								...
    								<!-- <div class="form-group">
    									...
    									<input type="datetime-local" class="form-control" name="input_edit_date"
    										...
    										id="input_edit_date" disabled value="<?=$COMPLAINT->edit_date?>">
    								...
    								<div class="form-group">
        								...
        								<select class="form-control employee_selection" name="input_edit_user" id="input_edit_user" disabled>
        									...
        									<option value=1><?=$COMPLAINT->last_editor?></option>
    								...
    								<div class="form-group">
        								...
        								<select class="form-control employee_selection" name="employee_id" id="input_employee_id">
    											...
    											<option value="<?=$employee->id?>" <?=$COMPLAINT->employee_id == $employee->id ? 'selected': '' ?>>
    								...
    								<div class="form-group">
    									...
    									<textarea name="description" class="form-control" id="input_description" rows="4"
    										...
    										cols="50" enabled><?=$COMPLAINT->description?></textarea>
    								...
    								<div class="form-group">
    									...
    									<textarea name="feedback" class="form-control" id="input_feedback" rows="4"
    										...
    										cols="50" enabled><?=$COMPLAINT->feedback?></textarea>
    								...
    								<div class="form-group">
                                        ...
                                        <div class="file_uploader" data-type="hressentials">
                                            <input type="hidden" value="<?=$COMPLAINT->attachment?>" name="attachment" class="selected_images d-block w-100"/>
                                        </div>
                                    </div>
    								...
    								<div class="form-group">
    									...
    									<select class="form-control" name="status" id="input_status" enabled>
    										...
    										<option <?=$COMPLAINT->status=='Inactive'? 'selected' : '' ?>> Inactive</option>
