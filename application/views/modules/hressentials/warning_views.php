						...
						<div class="row">
							...
							<div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control custom_selection" disabled name="employee_id" id="input_employee_id">
    								...
    								<div class="form-group">
    									...
    									<textarea name="description" disabled class="form-control" id="description" rows="4"
