						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="input_title" id="input_title" disabled
								...
								<div class="form-group">
									...
									<textarea name="description" class="form-control" id="input_description" rows="4"
										...
										cols="50" disabled><?=$ANNOUNCEMENT->description?></textarea>
								...
								<div class="form-group">
									...
									<!-- <input type="file" class="form-control" name="input_attachment" id="input_attachment" disabled value= aw.jpg> -->

									

<?php if(file_exists(FCPATH.'assets_user/files/hressentials/'.$ANNOUNCEMENT->attachment) && !empty( $ANNOUNCEMENT->attachment) ){ ?>

    									<br><a href="<?=base_url('assets_user/files/hressentials/'.$ANNOUNCEMENT->attachment)?>"

    										download> <?=$ANNOUNCEMENT->attachment?></a>

    									<img width='200px' class="d-block" src="<?=base_url('assets_user/files/hressentials/'.$ANNOUNCEMENT->attachment)?>"/>
...
<?php } ?>
								...
								<div class="form-group">
									...
									<input class="form-control" name="input_status" id="input_status" disabled value="<?=$ANNOUNCEMENT->status?>">
