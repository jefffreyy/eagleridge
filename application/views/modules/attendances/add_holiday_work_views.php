...
<div class="content-wrapper" style="min-height: 692.889px;">
    ...
    <div class='row'>
        <div class='col-md-8 ml-4 mt-3'>
            <h2><a href="<?= base_url() . 'attendances/holiday_work'; ?>"><i class="fa-duotone fa-circle-left"></a></i></h2>
        </div>
    </div>
    ...
    <div class="container-fluid px-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add&nbsp;Holiday Work 
                </li>
