  ...
  <div class="content-wrapper">
    <div class="container-fluid p-4">
      ...
      <div class="card border-0 p-0 m-0">
        ...
        <div class="card border-0 p-0 m-0">
          <div class="p-2">
            <div class="float-right mb-2" id="view_details" hidden>
              <!-- <span style="font-size: 20px; margin-right: 30px;" >TOTAL NET INCOME : ₱<?= number_format($DISP_GENERATED_SUM_NET_INCOME, 2) ?></span> -->
              <a href="<?= base_url() . 'attendances/view_details?period=' . $PERIOD. '&tab='.$TAB; ?>" class=" btn technos-button-green shadow-none rounded" <?= ($GENERATED_LIST_COUNT == '0') ? "hidden" : ''; ?>><img style="height: 15px; width: 15px;" class="mb-1" src="<?= base_url('assets_system/icons/eye-solid_new.svg') ?>" alt="">&nbsp;Generated View Details</a>
              <a style="width: 150px;" href="#" class=" btn technos-button-blue shadow-none rounded" id="update1" data-toggle="modal" data-target="#modela_update1"><img style="height: 14px; width: 14px;" class="mb-1" src="<?= base_url('assets_system/icons/circle-check-solid_mark.svg') ?>" alt="">&nbsp;Publish</a>
            </div>
            <div class="float-right mb-2" id="published_view_details" hidden>
              <!-- <span style="font-size: 20px; margin-right: 30px;" >TOTAL NET INCOME : ₱<?= number_format($DISP_PUBLISHED_SUM_NET_INCOME, 2) ?></span> -->
              <a href="<?= base_url() . 'attendances/published_view_details?period=' . $PERIOD. '&tab='.$TAB; ?>" class=" btn technos-button-green shadow-none rounded" <?= ($PUBLISHED_LIST_COUNT == '0') ? "hidden" : ''; ?>><img style="height: 15px; width: 15px;" class="mb-1" src="<?= base_url('assets_system/icons/eye-solid_new.svg') ?>" alt="">&nbsp;Published View Details</a>
              <a style="width: 150px;" href="#" class=" btn technos-button-blue shadow-none rounded" id="view_payslip" data-toggle="modal" data-target="#modal_view_payslip"><img style="height: 14px; width: 14px;" class="mb-1" src="<?= base_url('assets_system/icons/circle-check-solid_mark.svg') ?>" alt="">&nbsp;View Payslip</a>
            </div>
            <div class="float-right mb-2" id="generate_payslip" hidden>
              <a href="<?= base_url() . 'attendances/payroll_summary?period=' . $PERIOD. '&tab='.$TAB; ?>" class=" btn technos-button-green shadow-none rounded"><img style="height: 15px; width: 15px;" class="mb-1" src="<?= base_url('assets_system/icons/eye-solid_new.svg') ?>" alt="">&nbsp;Generate Payslip</a>
            </div>
            ...
            <ul class="nav nav-tabs border-0">
              <li class="nav-item">
                <a class="nav-link "   href="<?= base_url() . 'attendances/pending' ?>"  id="payslip_pending" pending_name='pending'><img style="width: 15px; height: 15px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/hand-solid.svg') ?>" alt="" />&nbsp;&nbsp;Pending
                  <span class="ml-2 badge badge-pill badge-secondary"> <?= $DISP_PENDING_COUNT; ?> </span>
                </a>
              </li>
              <li class="nav-item">
                <a  class="nav-link <?=($TAB) ? (($TAB=='ready') ? 'active' : '') : ''?>" data-toggle="tab" href="#employees_payslip_not_yet_generated"   id="payslip_not_yet_generated" ready_name='ready'><img style="width: 15px; height: 15px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-x-solid.svg') ?>" alt="" />&nbsp;&nbsp;Ready
                  <span class="ml-2 badge badge-pill badge-secondary"> <?= $DISP_EMP_LIST_COUNT; ?> </span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link <?=($TAB) ? (($TAB=='generated') ? 'active' : '') : ''?>" data-toggle="tab" href="#employees_payslip_generated"  id="payslip_generated" gen_name='generated'><img style="width: 15px; height: 15px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-check-solid_payslip.svg') ?>" alt="" />&nbsp;&nbsp;Generated
                  <span class="ml-2 badge badge-pill badge-secondary"> <?= $GENERATED_LIST_COUNT; ?> </span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link <?=($TAB) ? (($TAB=='published') ? 'active' : '') : ''?>" data-toggle="tab" href="#employees_payslip_published" id="payslips_published" pub_name='published'><img style="width: 15px; height: 15px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/file-pdf-solid.svg') ?>" alt="" />&nbsp;&nbsp;Published
          ...
          <div class="card border-0 mt-2 tab-pane p-0 <?=($TAB) ? (($TAB=='pending') ? 'active' : '') : ''?>" id="employees_payslip_pending" style="margin-top: -1px !important; margin-bottom: 0px !important; border-top: none !important; ">
              <div class="row">
                <div class="col">
            ...
            <div class="card border-0 mt-2 tab-pane p-0 <?=($TAB) ? (($TAB=='generated') ? 'active' : '') : ''?>" id="employees_payslip_generated" style="margin-top: -1px !important; margin-bottom: 0px !important; border-top: none !important;">
              <div class="row">
                <div class="col">
                  <div class="table-responsive">
                          ...
                          foreach ($PAYROLL_PAYSLIP_GENERATED_LIST as $GENERATED_LIST) { ;?>
                            ...
                            <tr class="payslip_row">
                              <td class="text-center" id="select_item">
                                <input type="checkbox" name="brand" class="check_single" loan_id_list="<?=  $GENERATED_LIST->LOAN_ID; ?>" empl_name="<?= $GENERATED_LIST->PAYSLIP_EMPLOYEE_NAME ?>" value="<?= $GENERATED_LIST->id ?>">
                              </td>
                              ...
                              <td class="text-center">₱<?= number_format($GENERATED_LIST->NET_INCOME, 2); ?></td>
                              <td class="text-center">
                                ...
                                <a href="<?= base_url(); ?>attendances/generated_payslip/<?= $GENERATED_LIST->empl_id; ?>/<?= $GENERATED_LIST->PAYSLIP_PERIOD; ?>" class="select_edit_row m-1" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important" hidden><i class="fa-duotone fa-eye"></i></a>
                                <a  class="select_edit_row m-1 btn_delete" delete_key="<?= $GENERATED_LIST->LOAN_ID; ?>" delete_id="<?= $GENERATED_LIST->id; ?>" style="background-color: transparent; border: none;color: gray; cursor: pointer;"><img class="mb-1"   src="<?= base_url('assets_system/icons/trash-solid.svg') ?>" alt="" /></a>
                                <!-- <a href="<?= base_url(); ?>attendances/edit_generated_payslip/<?= $GENERATED_LIST->empl_id; ?>/<?= $GENERATED_LIST->PAYSLIP_PERIOD; ?>" class="select_edit_row m-1" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important"><i class="far fa-edit" id="edit"></i></a> -->
                              </td>
                            </tr>
                          <?php }
                        } else { ?>
            ...
            <div class="card border-0 mt-2 tab-pane p-0 <?=($TAB) ? (($TAB=='published') ? 'active' : '') : ''?>" id="employees_payslip_published" style="margin-top: -1px !important; margin-bottom: 0px !important; border-top: none !important;">
              <div class="row">
                <div class="col">
                  <div class="table-responsive">
                        ...
                        <?php if ($PAYROLL_PAYSLIP_PUBLISHED_LIST) {
                          foreach ($PAYROLL_PAYSLIP_PUBLISHED_LIST as $PUBLISHED_LIST) { ?>
                            <tr>
                              ...
                              <td class="text-center">₱<?= number_format($PUBLISHED_LIST->NET_INCOME, 2); ?></td>
                              <td class="text-center">
                                ...
                                <a href="<?= base_url(); ?>attendances/published_payslip/<?= $PUBLISHED_LIST->empl_id; ?>/<?= $PUBLISHED_LIST->PAYSLIP_PERIOD; ?>" class="select_edit_row m-1" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important" hidden><i class="fa-duotone fa-eye"></i></a>
                              </td>
                            </tr>
                          <?php }
                        } else { ?>
            ...
            <div class="card border-0 mt-2 tab-pane p-0  <?=($TAB) ? (($TAB=='ready') ? 'active' : '') : ''?>" id="employees_payslip_not_yet_generated" style="margin-top: -1px !important; margin-bottom: 0px !important; border-top: none !important; ">
              <div class="row">
                <div class="col">
                  <div class="table-responsive">
                    <table class="table table-bordered table-hover mb-0" id="tbl_employees_not_ready_for_payslip">
                      <thead>
                        <th>EMPLOYEE&nbsp;ID</th>
                        <th>FULL&nbsp;NAME</th>
                        <th>EMPLOYMENT&nbsp;TYPE</th>
                      ...
                      <tbody>
                        <?php if ($DISP_EMP_LIST) {
                          foreach ($DISP_EMP_LIST as $EMP_LIST) { ?>
                            <tr>
                              <td> <?= $EMP_LIST->col_empl_cmid ?></td>
                              <td> <?= $EMP_LIST->col_last_name . ', ' . $EMP_LIST->col_frst_name; ?></td>
                              <td> <?= ($EMP_LIST->col_empl_type) ? $EMP_LIST->col_empl_type : ""; ?> </td>
                          ...
                          <tr class="table-active" id="ready_for_payslip_no_data">
                            <td colspan="12">
                              <p class="text-center mb-0">No Records</p>
                            </td>
                          </tr>
                        <?php } ?>
                      </tbody>
...
// Government Contributions    ================ End ===============
      ...
      function filter_data(tabId) {
        ...
        let cut_off = $("#cut_off_period").find(":selected").val();
        window.location = base_url + "attendances/payroll_status?period="+cut_off+"&tab="+tabId;
      }
