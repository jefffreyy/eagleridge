...
<body>
    ...
    <div class="container-fluid p-4">
      <div class="row pt-1">
        ...
        <div class="col-md-6 button-title">
          ...
          <!--</form>-->
          <a href="<?= base_url('attendances/request_time_adjustment') ?>" class=" btn btn-primary shadow-none rounded"><img class="mb-1" src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
            &nbsp;Add Request</a>
      ...
      <div class="filter-container <?= $filter ? 'visible' : '' ?>">
        <div class="row d-flex mb-4 ">
          ...
          <!-- <div class="col-md-2">
            ...
            <a href="<?= base_url('attendances/time_adjustment_lists') ?>" id="btn_clear_filter" class="col btn btn-secondary mx-1">Clear Filter</a>
          </div> -->
          <div class="col-md-2">
        ...
        <div class="p-1">
          <div class="col-md-4 pl-0">
            ...
            <div class="flex-fill d-flex">
              <select name="search_data" id="search_data" class="custom-select">
                <option value="">All</option>
                <?php
              ...
              <a href="<?= base_url('attendances/time_adjustment_lists') ?>" id="btn_clear_filter" class="btn btn-primary mx-1"><img src="<?= base_url('assets_system/icons/clear_filter.svg')?>" alt=""/>&nbsp;Clear</a>
            </div>
          </div>
        </div>
                ...
                <?php if ($TABLE_DATA) {  ?>
                  <?php foreach ($TABLE_DATA as $row_data) { ?>
                    <tr>
                      ...
                      <td class="text-left"><?= $row_data->assigned_by ?></td>
                      <td class="text-left"><?= $row_data->employee ?></td>
                      <td class="text-left"><?= date_format(date_create($row_data->date_adjustment), 'd/m/Y') ?></td>
                      <td class="text-left"><?= $row_data->shift_type ?></td>
                      <td class="text-left"><?= $row_data->time_in_1 ?></td>
                      <td class="text-left"><?= $row_data->time_out_1 ?></td>
                      <td class="text-left"><?= $row_data->attachment ?></td>
                      ...
                      <td class="text-center">
                        ...
                        <?php if ($row_data->status == 'Pending 1' || $row_data->status == 'Pending 2' || $row_data->status == 'Pending 3') : ?>
                          <!--<a class = "select_edit_row p-2 edit_data_id"  href="<?= base_url('attendances/edit_time_adjustment/' . $row_data->id) ?>"  style ="color: gray; cursor: pointer; !important" row_id="56">-->
  ...
  <script>
    $(document).ready(function() {
      ...
      $('a.paginate').on('click', function() {
        ...
        window.location.href = "<?= base_url('attendances/time_adjustment_lists') ?>" + $(this).attr('href') + filter_url;
        return false;
      })
      ...
      function reloadPage() {
        ...
        window.location.href = "<?= base_url('attendances/time_adjustment_lists') ?>" + "?status=" + status + "&page=" + page + "&row=" + row + '&search=' + search + filter_url;
      }
    })
  </script>
  <!-------------------- Export ----------------->
  ...
  <script>
    document.getElementById("btn_export").addEventListener('click', function() {
      ...
      XLSX.writeFile(wb, "<?php echo 'time_adjustment_list.xlsx' ?>");
    });
  </script>
