    ...
    <div class="row pt-1">
      <div class="col-md-6">
        <h1 class="page-title"><a href="<?=base_url('attendances')?>"><i
              class="fa-duotone fa-circle-left"></i></a>&nbsp;Overtime Requests<h1>
      </div>
      ...
      <div class="col-md-6 button-title">
        ...
        <!--</form>-->
        <a href="<?=base_url('attendances/request_overtime')?>"
          class=" btn technos-button-green shadow-none rounded"><i class="fas fa-plus"></i>&nbsp;Add Request</a>
...
<?php endforeach ?>
        ...
        <div class="col-md-2">
            ...
            <a href="<?=base_url('attendances/overtimes')?>" id="btn_clear_filter"
...
<?php if($TABLE_DATA) {  ?>
    <?php foreach($TABLE_DATA as $row_data) { ?>
              <tr >
                ...
                <td class="text-center" ><?=date_format(date_create($row_data->date_ot),'d/m/Y')?></td>
        ...
        $(document).ready(function() {
           ...
           $('#modal_approval').on('show.bs.modal', function (e) {
            ...
            $('a.paginate').on('click',function(){
                ...
                window.location.href="<?=base_url('attendances/overtimes')?>"+$(this).attr('href')+filter_url;
                return false;
            })
            ...
            function reloadPage(){
                ...
                window.location.href="<?=base_url('attendances/overtimes')?>"+"?status="+status+"&page="+page+"&row="+row+'&search='+search+filter_url;
            }
        })
    </script>
    <!-------------------- Export ----------------->
