...
<body>
    <div class="content-wrapper">
        <div class="container-fluid p-4">
            <div class='row  pt-1'>
                <div class="col-md-6">
                    <h1 class="page-title d-flex align-items-center"><a href="<?= base_url() . 'attendances/payroll_schedules'; ?>"><img style="width: 32px; height: 32px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt=""></a>&nbsp;Payroll Schedule Details<h1>
                </div>
            </div>
