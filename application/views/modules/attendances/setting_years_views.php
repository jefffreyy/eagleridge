                ...
                <div class="card col-xl-8 col-lg-4 col-md-8 col-11" style="min-height:700px ">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="row mx-2">
                                <div class="col-md-12">
                                    <span style="font-weight: 500; font-size: 18px">Years</span>
                                </div>
...
<script>
    ...
    update.addEventListener('click', function() {
        ...
        // }
        //validate year
        // function validateYearFormat(row, rowIndex, title) {
        //     let year = parseInt(year);
        //     if (!(year !== null && year !== undefined && typeof year === 'number' && year >= 2000 && year <= 3000)) {
        //         shouldProceed = false;
        //         alert(`${title} in row ${rowIndex + 1} is not valid. Please select a valid ${title.toLowerCase()}.`);
        //     }
        // }
        ...
        updatedData.forEach((row, rowIndex) => {
            ...
            validateIncludes(row[1], rowIndex, yearsArray, 'Year');
        ...
        // return;
        // insert data
        fetch(url + 'attendances/update_setting_years', {
                method: 'POST',
                headers: {
