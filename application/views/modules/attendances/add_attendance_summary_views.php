...
<div class="content-wrapper">
  <div class="container-fluid p-4">
    <div class="row pt-1">
      <div class="col-md-6">
        <h1 class="page-title d-flex align-items-center"><a href="<?= base_url() . 'attendances/edit_attendance_summary'; ?>"><img style="width: 24px; height: 24px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" /></a>&nbsp;Add Attendance Record<h1>
      </div>
...
<script>
  ...
  hot = new Handsontable(container, {
    ...
    colHeaders: ['Employee ID', 'Date', 'Time in', 'Time out', 'Break in', 'Break out'],
    rowHeaders: true,
    height: 'auto',
