          ...
          <div class="p-2">
            ...
            <div class="row d-block d-lg-none mb-2">
              ...
              <div class="col-12 my-3" >
                <a href="<?= base_url() . 'attendances/view_details?period=' . $PERIOD . '&tab=' . $TAB; ?>" class="mr-1 btn btn-primary shadow-none rounded"><img style="height: 15px; width: 15px;" class="mb-1" src="<?= base_url('assets_system/icons/eye-solid_new.svg') ?>" alt="">&nbsp;Generated View Details</a>
              </div>
            ...
            <div class="float-right mb-2 d-none d-lg-flex" id="view_details">
              ...
              <a  <?= ($PAYROLL_PAYSLIP_GENERATED_LIST) ? "" : "hidden" ?> href="<?= base_url() . 'attendances/view_details?period=' . $PERIOD . '&tab=' . $TAB; ?>" class="mr-1 btn btn-primary shadow-none rounded"><img style="height: 15px; width: 15px;" class="mb-1" src="<?= base_url('assets_system/icons/eye-solid_new.svg') ?>" alt="">&nbsp;Generated View Details</a>
            ...
            <ul class="nav nav-tabs border-0 d-none d-lg-flex">
              <li class="nav-item">
                <a class="nav-link " href="<?= base_url() . 'attendances/pending?period=' . $PERIOD ?>" id="payslip_pending" pending_name='pending'><img style="width: 15px; height: 15px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/hand-solid.svg') ?>" alt="" />&nbsp;&nbsp;Pending
                          ...
                          foreach ($PAYROLL_PAYSLIP_GENERATED_LIST as $GENERATED_LIST) {; ?>
                            ...
                            <tr class="payslip_row">
                              <td class="text-center" id="select_item">
                                <input type="checkbox" name="brand" class="check_single" empl_id='<?= $GENERATED_LIST->empl_id ?>' loan_id_list="<?= $GENERATED_LIST->LOAN_ID; ?>" empl_name="<?= $GENERATED_LIST->PAYSLIP_EMPLOYEE_NAME ?>" net_income="<?= $GENERATED_LIST->NET_INCOME; ?>" value="<?= $GENERATED_LIST->id ?>">
                              </td>
                              ...
                              <td class="text-left">
                                ₱<?= number_format($GENERATED_LIST->NET_INCOME, 2); ?>
                              ...
                              <td class="text-center">
                                ...
                                <a class="select_edit_row m-1 btn_delete" empl_id='<?= $GENERATED_LIST->empl_id ?>' delete_key="<?= $GENERATED_LIST->LOAN_ID; ?>" delete_id="<?= $GENERATED_LIST->id; ?>" style="background-color: transparent; border: none;color: gray; cursor: pointer;"><img class="mb-1" src="<?= base_url('assets_system/icons/trash-solid.svg') ?>" alt="" /></a>
  ...
  <div class="modal fade  class_modal_bulk_delete" id="modal_bulk_delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <form action="<?= base_url() . 'attendances/bulk_delete_payslip_published'; ?>" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
          <div class="modal-body">
            <div class="row">
              <div class="col-md-12">
  ...
  <script>
    $(document).ready(function() {
      ...
      function filter_data(tabId) {
        ...
        window.location = base_url + "attendances/generated?period=" + cut_off;
      }
