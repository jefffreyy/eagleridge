                    ...
                    <div class="modal-body pb-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <?php echo form_open('attendances/add_new_offset'); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control " min="0" name="duration" id="input_duration" enabled="" value="" step="0.5"required>
                                    <!-- <div style="font-size: 14px">
                                ...
                                <div class="mr-2" style="float: right !important">
                                    ...
                                    <button type='submit' id="btn_add" class="btn btn-primary shadow-none rounded " ;="">
