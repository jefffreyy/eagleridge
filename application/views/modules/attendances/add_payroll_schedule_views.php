    ...
    <div class="content-wrapper">
        <div class="container-fluid p-4">
            <div class='row pt-1'>
                ...
                <div class="col-md-6">
                    <h1 class="page-title d-flex align-items-center"><a href="<?= base_url() . 'attendances/payroll_schedules'; ?>"><img style="width: 24px; height: 24px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" /></a>&nbsp;Add Payroll Schedule<h1>
                </div>
            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="modal-body pb-5">
                                <div class="row">
                                    <div class="col-md-12">
                                        <?php echo form_open_multipart('attendances/insert_payroll_sched'); ?>
