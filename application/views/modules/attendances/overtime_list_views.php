...
<body>
            ...
            <div class="row">
                ...
                <div class="col-md-6 button-title">
                    <a href="#" class="btn btn-primary shadow-none" id="btn_export"><i class="fas fa-file-export"></i>&nbsp;Export XLSX<a>
                            <a href="<?= base_url() ?>employees/new_employee" data-toggle="modal" data-target="#modal_application_overtime" class="btn btn-primary shadow-none"><i class="fas fa-plus"></i> Application for Overtime</a>
                </div>
            </div>
            <hr>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <select name="filter_cutoff_period" id="filter_cutoff_period" class="form-control">
                        ...
                        ?>
                                <option value="<?= $DISP_ALL_CUTOFF_PERIOD_ROW->name ?>"><?= $DISP_ALL_CUTOFF_PERIOD_ROW->name ?></option>
                        <?php
                            }
                        }
                        ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover" id="TableToExport">
                                ...
                                <tbody id="tbl_application_container">
                                    <?php if (!empty($DISP_ALL_OVERTIME)) { ?>

                                        <?php foreach ($DISP_ALL_OVERTIME as $DISP_ALL_OVERTIME_ROW) {
                                            $application_id = 'OVT' . str_pad($DISP_ALL_OVERTIME_ROW->id, 5, '0', STR_PAD_LEFT);
                                            $db_time_out = explode(':', $DISP_ALL_OVERTIME_ROW->time_out);
                                            $time_out = $db_time_out[0] . ':' . $db_time_out[1];
                                            $employee = $this->attendance_model->MOD_DISP_EMPLOYEE($DISP_ALL_OVERTIME_ROW->empl_id);
                                            $assigned_by = $this->attendance_model->MOD_DISP_EMPLOYEE($DISP_ALL_OVERTIME_ROW->assigned_by);
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header" style="border-bottom: none;">
                    <h4 class="modal-title ml-1" id="exampleModalLabel">Application for Overtime</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form action="<?php echo base_url('attendances/insrt_assign_overtime'); ?>" id="form_add_overtime" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
    ...
    <div class="modal fade" id="modal_edit_overtime" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header" style="border-bottom: none;">
                    <h4 class="modal-title ml-1" id="exampleModalLabel">Edit Overtime</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form action="<?php echo base_url('attendances/updt_overtime_application'); ?>" id="form_edit_overtime" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="appl_empl_id" id="appl_empl_id" class="form-control" disabled>
                                        <?php
                                        $user_data = $this->attendance_model->MOD_DISP_ALL_EMPLOYEES();
    ...
    <div class="modal fade" id="modal_overtime_details" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header" style="border-bottom: none;">
                    <h4 class="modal-title mt-0 ml-1">Overtime Details </h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-body pb-5">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="" for="ot_employee_name">Name:</label>
                                <input type="text" class="form-control" name="ot_employee_name" id="ot_employee_name" disabled>
                            </div>

                            <div class="form-group">
                                <label class="" for="ot_employee_position">Position:</label>
                                <input type="text" class="form-control" name="ot_employee_position" id="ot_employee_position" disabled>
                            </div>

                            <div class="form-group">
                                <label class="" for="ot_employee_department">Department:</label>
                                <input type="text" class="form-control" name="ot_employee_department" id="ot_employee_department" disabled>
                            </div>

                            <div class="form-group">
                                <label class="" for="ot_application_date">Application Date:</label>
                                <input type="date" class="form-control" name="ot_application_date" id="ot_application_date" disabled>
                            </div>

                            <div class="form-group">
                                <label class="" for="ot_overtime_date">Overtime Date:</label>
                                <input type="date" class="form-control" name="ot_overtime_date" id="ot_overtime_date" disabled>
                            </div>

                            <div class="form-group">
                                <label class="" for="ot_time_out">Time Out:</label>
                                <input type="text" class="form-control" name="ot_time_out" id="ot_time_out" disabled>
                            </div>

                            <div class="form-group">
                                <label class="" for="ot_type">Type:
                                </label>
                                <input type="text" class="form-control" name="ot_type" id="ot_type" disabled>
                            </div>

                            <div class="form-group">
                                <label class="" for="ot_num_hours">No. of Hours:</label>
                                <input type="text" class="form-control" name="ot_num_hours" id="ot_num_hours" disabled>
                            </div>

                            <div class="form-group">
                                <label class="" for="ot_reason">Reason:</label>
                                <input type="text" class="form-control" name="ot_reason" id="ot_reason" disabled>
                            </div>
                            <hr>
    ...
    <?php
    $page_count = $DISP_ROW_COUNT[0]->ot_count / 10;
    if (($DISP_ROW_COUNT[0]->ot_count % 10) != 0) {
            ...
            $('.ot_row').click(function() {
                ...
                get_overtime_data(url_get_overtime_data, modal_employee_id, modal_overtime_id).then(data => {
                    data.overtime_data.forEach((overtimeData) => {
                        ...
                        $('#ot_application_date').val(application_date);
                        $('#ot_overtime_date').val(overtime_date);
                        $('#ot_time_out').val(time_out);
                        $('#ot_type').val(type);
                        $('#ot_num_hours').val(hours + ' hrs');
                    ...
                    data.employee_data.forEach((employeeData) => {
                        $('#ot_employee_name').val(employeeData.col_frst_name + ' ' + employeeData.col_last_name);
                        $('#ot_employee_position').val(employeeData.col_empl_posi);
                        $('#ot_employee_department').val(employeeData.col_empl_dept);
    ...
    <script>
        document.getElementById("btn_export").addEventListener('click', function() {
            ...
            XLSX.writeFile(wb, "Overtime List.xlsx");
        });
    </script>
</body>
