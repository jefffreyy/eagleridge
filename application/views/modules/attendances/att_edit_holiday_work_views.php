...
<div class="content-wrapper">
    <div class='row'>
        <div class='col-md-8 ml-4 mt-3'>
            <h2><a href="<?= base_url('attendances/holiday_work'); ?>"><i class="fa-duotone fa-circle-left"></i></h2>
        </div>
    </div>
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="modal-body pb-5">
                        <?php echo form_open('attendances/update_holiday_work') ?>
