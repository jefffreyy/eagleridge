...
class attendance_model extends CI_Model
{
    ...
    {
        $where_query        = "WHERE disabled=0 AND (termination_date IS NULL OR termination_date IS NULL)";
        ...
        $sql = "SELECT id,col_suffix,col_empl_posi,col_empl_group,col_empl_cmid,col_last_name,col_frst_name,col_midl_name FROM tbl_employee_infos $where_query ORDER BY col_empl_cmid + 0 ASC";
        $arr_val = array();
    ...
    function GET_EMPLOYEELIST()
    {
        ...
        col_empl_team,col_empl_line FROM tbl_employee_infos WHERE (termination_date IS NULL OR termination_date IS NULL) AND disabled=0
    ...
    function GET_FILTERED_EMPLOYEELIST_3($offset, $row, $branch, $dept, $division, $section, $group, $team, $line)
    {
        ...
        $sql = "SELECT tbl_employee_infos.id,col_suffix,col_empl_posi,col_empl_cmid,col_last_name,col_imag_path,col_midl_name,col_frst_name,col_empl_branch,col_empl_dept,col_empl_divi, col_empl_sect,col_empl_group,col_empl_team,col_empl_line,salary_rate,salary_type, empl_cmid, empl_code FROM tbl_employee_infos 
    ...
    function GET_FILTERED_EMPLOYEELIST_DATA($offset, $row, $branch, $dept, $division, $section, $group, $team, $line)
    {
        ...
        FROM tbl_employee_infos WHERE (termination_date IS NULL OR termination_date IS NULL) AND disabled=0
        AND col_empl_branch = $branch
        AND col_empl_dept   = $dept
        AND col_empl_divi   = $division
        AND col_empl_sect   = $section
    ...
    function GET_FILTERED_EMPLOYEELIST_2($offset, $row, $branch, $dept, $division, $section, $group, $team, $line)
    {
        ...
        $sql = "SELECT id,col_empl_posi,col_empl_cmid,col_last_name,col_imag_path,col_midl_name,col_frst_name,col_empl_branch,col_empl_dept,col_empl_divi, col_empl_sect,col_empl_group,col_empl_team,col_empl_line,salary_rate,salary_type FROM tbl_employee_infos WHERE termination_date IS NULL AND disabled=0
        AND col_empl_branch  = $branch
        AND col_empl_dept    = $dept
        AND col_empl_divi    = $division
        AND col_empl_sect    = $section
    ...
    {
        $sql = "SELECT * FROM tbl_employee_infos WHERE termination_date IS NULL AND disabled=0 
    ...
    {
        $sql = "SELECT id,col_empl_cmid, CONCAT(col_last_name, ' ', col_frst_name) AS full_name FROM tbl_employee_infos WHERE termination_date IS NULL AND disabled=0 
        AND (tbl_employee_infos.col_empl_cmid LIKE '%$search%' 
        OR CONCAT(col_last_name, ' ', col_frst_name, ' ', col_midl_name) LIKE '%$search%') 
        ORDER BY id ASC";
        $query = $this->db->query($sql);
    ...
    {
        $sql = "SELECT * FROM tbl_employee_infos WHERE (termination_date IS NULL OR termination_date IS NULL) AND disabled=0
        ORDER BY col_empl_cmid +0 ASC";
        $query = $this->db->query($sql);
        $query->next_result();
        return $query->result();
    ...
    function GET_FILTERED_EMPLOYEELIST_COUNT($branch, $dept, $division, $section, $group, $team, $line)
    {
        ...
        $sql = "SELECT id,col_empl_posi,col_empl_cmid,col_last_name,col_imag_path,col_midl_name,col_frst_name,col_empl_branch,col_empl_dept,col_empl_divi, col_empl_sect,col_empl_group,col_empl_team,col_empl_line FROM tbl_employee_infos WHERE termination_date IS NULL
         AND disabled=0
        AND col_empl_branch  = $branch
        AND col_empl_dept    = $dept
        AND col_empl_divi    = $division
    ...
    {
        $sql = "SELECT date,time_in,time_out,time_in_address,time_out_address,snapshot_in,snapshot_out,break_in,break_out FROM tbl_attendance_records WHERE empl_id=?";
        $query = $this->db->query($sql, array($user_id));
        $query->next_result();
        return $query->result();
    }
    ...
    {
        $sql = "SELECT id,col_empl_cmid,col_last_name,col_midl_name,col_frst_name FROM tbl_employee_infos WHERE termination_date IS NULL ORDER BY id ASC";
        $query = $this->db->query($sql, array());
        $query->next_result();
        return $query->result();
    }
    ...
    function GET_EMPLOYEELIST_SUMMARY($offset, $row)
    {
        ...
        FROM tbl_employee_infos WHERE  termination_date IS NULL AND disabled=0 ORDER BY col_empl_cmid + 0 ASC
        -- LIMIT " . $offset . ", " . $row . " 
        ";
        $query = $this->db->query($sql);
        $query->next_result();
    ...
    function GET_EMPLOYEELIST_SUMMARY_EDIT()
    {
        ...
        FROM tbl_employee_infos WHERE  termination_date IS NULL AND disabled=0 ";
        $query = $this->db->query($sql);
        $query->next_result();
        return $query->result();
    }
    ...
    function GET_EMPLOYEELIST_DAILY_ALL($branch, $dept, $division, $section, $group, $team, $line, $company, $type){
        if ($branch    == "all") {
            $branch     = "col_empl_branch";
        }
        if ($dept      == "all") {
    ...
    function GET_EMPLOYEELIST_DAILY_COUNT($branch, $dept, $division, $section, $group, $team, $line, $company, $type){
        if ($branch    == "all") {
            $branch     = "col_empl_branch";
        }
        if ($dept      == "all") {
    ...
    function GET_EMPLOYEELIST_COUNT(){
        $sql = "SELECT id FROM tbl_employee_infos WHERE  termination_date IS NULL AND disabled=0";
        $query = $this->db->query($sql);
        return $query->num_rows();
    }
    ...
    function GET_ATTENDANCE_REMOTE_TODAY_DATA($date){
        $sql = "SELECT date, empl_id, time_in, time_out, break_in, break_out FROM tbl_attendance_records WHERE  date=?";
        $query = $this->db->query($sql,$date);
        $query->next_result();
        return $query->result();
    }
    ...
    function upload_data($data, $cutOffVal){
        ...
        if($is_duplicate > 0){
            ...
            $query = $this->db->query($sql, array($create_date, $present, $AWOL, $TARD, $UT, $PAID, $REG_REG, $REG_OT, $REG_ND, $REG_NDOT, $RST_REG, $RST_OT, $RST_ND, $RST_NDOT, 
            $LEG_REG, $LEG_OT, $LEG_ND, $LEG_NDOT, $RST_LEG_REG, $RST_LEG_OT, $RST_LEG_ND, $RST_LEG_NDOT, $SPE_REG, $SPE_OT, $SPE_ND, $SPE_NDOT, $RST_SPE_REG, $RST_SPE_OT, $RST_SPE_ND, $RST_SPE_NDOT, $empl_id, $cutOffVal));
            ...
            $this->db->query($sql, array($create_date, $create_date, $empl_id, $cutOffVal, $present, $AWOL, $TARD, $UT, $PAID, $REG_REG, $REG_OT, $REG_ND, $REG_NDOT, $RST_REG, $RST_OT, $RST_ND, $RST_NDOT, $LEG_REG, $LEG_OT, $LEG_ND, $LEG_NDOT, 
            $RST_LEG_REG, $RST_LEG_OT, $RST_LEG_ND, $RST_LEG_NDOT, $SPE_REG, $SPE_OT, $SPE_ND, $SPE_NDOT, $RST_SPE_REG, $RST_SPE_OT, $RST_SPE_ND, $RST_SPE_NDOT));
            return $this->db->insert_id();
        }
    }
