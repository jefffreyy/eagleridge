  ...
  <div class="container-fluid p-4">
    ...
    <div class="row pt-1">
      ...
      <div class="col-md-6 button-title">
        <a href="<?=base_url().'messages/add_sms_messages'?>" id="btn_new" class=" btn technos-button-green shadow-none rounded"><i class="fas fa-plus"></i>&nbsp;Add New Message</a>
          ...
          <table class="table table-hover m-0" id="TableToExport" style="width:100%">
            <thead>
              <tr>
                ...
                <th class="text-center d-none" >Messages</th>
            ...
            <tbody id="tbl_application_container">
                ...
                <?php if($MESSAGES){
                  ...
                  <tr>
                    ...
                    <td class="text-center" ><?= 'MSG'.str_pad($MESSAGE_ROW->id, 5, '0', STR_PAD_LEFT) ; ?></td>
                    <td class="text-center" ><?=date('M d Y H:i A',strtotime($MESSAGE_ROW->schedule_date))?></td>
                    ...
                    <td class="text-center d-none" ><?=$MESSAGE_ROW->message?></td>
                    <td class="text-center" ><?=$MESSAGE_ROW->mobile_number?></td>
                  </tr>
              <?php  }
...
<form id='builk_activate' method='post' action="<?=base_url('messages/bulk_activate')?>">
    <input type='hidden' name='active' id='active_loans'/>
</form>
<form id='builk_inactivate' method='post' action="<?=base_url('messages/bulk_inactivate')?>">
...
<script>
  $(document).ready(function() {
    $('#row_dropdown').on('change',function(){
        let row = $(this).val();
        // alert(row);
        window.location="<?=base_url()?>messages/sms_messages?"+"page="+1+"&row="+row+'&tab=<?=$TAB?>';
    });
