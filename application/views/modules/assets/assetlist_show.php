...
<div class="content-wrapper">
    ...
    <div class='row'>
        ...
        <h2><a href="<?= base_url() . 'assets/assetslists'; ?>"><img style="width: 32px; height: 32px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt=""></a></h2>
            <!-- <h2><a href="<?= base_url('assets/assetslists') ?>"><i class="fa-duotone fa-circle-left"></i></a></h2> -->
        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="<?= $DISP_ASSET->col_asset_warranty_exp ?>" type="date" name="col_asset_warranty_exp" id="INSRT_ASSET_WARRANTY_EXP" readonly>
                                        </div>
