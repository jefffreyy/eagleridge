      ...
      <div class="row mb-2">
        ...
        <div class="col-md-6">
          <h1 class="page-title d-flex align-items-center">
            <a href="<?= base_url('assets') ?>"> <img style="width: 24px; height: 24px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" />
            </a>&nbsp;Stock Room
          </h1>
        </div>

        <div class="col ml-auto">
          <a class="btn btn-primary float-right" title="Add" href="<?= base_url('assets/add_stockroom') ?>">
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover table-xs">
              ...
              <tbody>
                ...
                ?>
                    <tr>
                      <td class="text-center" class="text-center" id="select_item">

                        <input type="checkbox" name="brand" class="check_single" row_id="<?= $ROW_STOCKROOM_INFO->id ?>">
                      ...
                      <td class="text-center">
                        ...
                        <div class="btn-action">
                          ...
                          <a href="<?= base_url('assets/edit_stockroom/' . $ROW_STOCKROOM_INFO->id) ?>" class="select_edit_row m-1" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important" row_id="9"> <img src="<?= base_url('assets_system/icons/pen-to-square-solid.svg') ?>" alt="">
                          </a>
  ...
  <div class="modal-dialog modal-md" role="document">
    ...
    <div class="modal-content">
      ...
      <form id='form_activation' action="" method="post">
        ...
        <input type='hidden' name='table' value="tbl_std_stockrooms">

        <input type='hidden' name='sub_url' value="stockrooms">
