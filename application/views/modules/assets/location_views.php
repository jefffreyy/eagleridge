    ...
    <div class="flex-fill">
      ...
      <div class="row mb-2">
        ...
        <div class="col ml-auto">
          <a class="btn btn-primary float-right" title="Add" href="<?= base_url('assets/add_location') ?>">
                ...
                foreach ($DISP_LOCATION_INFO as $ROW_LOCATION_INFO) {
                  ...
                  <tr>
                    <td class="text-center" id="select_item">
                      ...
                      <input type="checkbox" name="brand" class="check_single" row_id="<?= $ROW_LOCATION_INFO->id ?>">
                    ...
                    <td class="text-center">
                      ...
                      <div class="btn-action">
                        ...
                        <a href="<?= base_url('assets/edit_location/' . $ROW_LOCATION_INFO->id) ?>" class="select_edit_row m-1" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important" row_id="9"> <img src="<?= base_url('assets_system/icons/pen-to-square-solid.svg') ?>" alt="">
                        </a>
  ...
  <div class="modal-dialog modal-md" role="document">
    ...
    <div class="modal-content">
      ...
      <form id='form_activation' action="" method="post">
        ...
        <input type='hidden' name='table' value="tbl_std_companylocations">

        <input type='hidden' name='sub_url' value="locations">
...
<div class="modal fade" id="modal_add_location" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="<?php echo base_url('assets/add_location'); ?>" id="LOC_FORM_ADD" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input class="form-control form-control " type="text" name="name" id="LOC_INPF_NAME">
              </div>
            </div>
          </div>
        </div>
