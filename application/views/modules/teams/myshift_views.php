        ...
        <div class="card border-0 p-0 m-0">
            ...
            <div>
                ...
                <div class='row py-1 justify-content-between'>
                    ...
                    <a onclick="afterRenderFunction()" href="<?= base_url('teams/shift_assignments') ?>" class=" btn btn-info shadow-none rounded d-flex align-items-center">
                    &nbsp;View Shifts</a>
                </div>
            ...
            <table class="table table-bordered table-hover m-0" id="TableToExport" style="width:100%">
                ...
                <?php if ($DISP_SHIFT) {
                    ...
                    <tr >
                        ...
                        <a class="btn btn-info" style="width:70px;  font-size: 13px;" href="<?= base_url() . 'teams/my_requested_shift/'.$DISP_SHIFT_ROW->empl_id.'/'.$DISP_SHIFT_ROW->cutoff_period ?>">
                         View
                        </a>
                        ...
                        ?>
                        <span class="btn <?= $color ?> disabled p-2 m-auto" style="width:100px;  font-size: 13px; <?=$color2?>">
                        <?php
