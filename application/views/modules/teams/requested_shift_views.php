  ...
  <div class="content-wrapper">
    <div class="row">
        <div class="col-md-8 ml-4 mt-3">
            <h2><a href="<?= base_url('teams/myshifts') ?>"> <img style="width: 24px; height: 24px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" /></a></h2>
        </div>
    </div>
  ...
  <script>
    ...
    //   }
      ...
      $("#cut_off_period").on("change", function () {
        ...
        window.location = base_url + "teams/shift_assignments?period=" + cut_off;
      })
