            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="modal-body pb-5">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- <form action="<?= base_url('teams/add_request_shift') ?>" method='post'> -->
                                <form id="requestForm" style="width:100%">
                                    ...
                                    <div class="mr-2" style="float: right !important">
                                        <button id="btn_add" type='button' onclick="submitForm()" class="btn technos-button-blue shadow-none rounded btn_submit" ;="">
                                            Submit</button>
                                    </div>
                                </form>
                            </div>
        ...
        fetch(apiUrl, {
            ...
            .then(data => {
                ...
                if (data.messageError) {
                    ...
                    window.location.href = '<?= base_url() ?>teams/mychange_shift';
                }
            })
            .catch(error => {
                $(document).Toasts('create', {
