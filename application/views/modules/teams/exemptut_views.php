...
<body>
    ...
    <div class="container-fluid p-4">
      <div class="row pt-1">
        ...
        <div class="col-md-6 button-title">
          ...
          <a onclick="afterRenderFunction()" href="<?= base_url('teams/request_exemptut') ?>" class=" btn btn-primary shadow-none rounded d-flex align-items-center"><img src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
            &nbsp;Add Request</a>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        if ($row_data->status == 'Pending 1' || $row_data->status == 'Pending 2' || $row_data->status == 'Pending 3' || $row_data->status == 'Approved') { 
                          ...
                          ?>
                          <a href="<?= base_url('teams/exemptut_withdraw/'.$row_data->id) ?>" class="btn btn-secondary">Withdraw</a>
                        <?php } ?>
                      </td>
                    </tr>
                  <?php } ?>
  ...
  <script>
    $(document).ready(function() {
      ...
      function reloadPage() {
        ...
        var page = "<?= $PAGE ?>";
        window.location.href = "<?= base_url('teams/exemptut') ?>" + "?status=" + status + "&page=" + page + "&row=" + row;
      }
    })
  </script>
  ...
  <script>
    document.getElementById("btn_export").addEventListener('click', function() {
      ...
      XLSX.writeFile(wb, "<?php echo 'exempt_undertime.xlsx' ?>");
    });
  </script>
</body>
