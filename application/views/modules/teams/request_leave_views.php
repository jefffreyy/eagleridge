...
<div class="content-wrapper" style="min-height: 624px;">
    <div class='row'>
        <div class='col-md-8 ml-4 mt-3'>
            <h2>
                <a href="<?= base_url('teams/apply_leaves'); ?>"><img style="width: 32px; height: 32px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="">
                </a>
            </h2>
        </div>
    </div>
                        ...
                        <div class="row">
                            <form id="leaveForm" style="width:100%">
                                <div class="col-md-12">
                                    ...
                                    <!-- <?php echo form_open('teams/add_new_leave'); ?> -->
...
<script>
    ...
    const apiUrl = baseUrl + 'teams/get_request_leave_by_date';
    const input_empl_id = document.getElementById('input_empl_id');
    ...
    // console.log('input_leave_date', input_leave_date)
            ...
            fetch(apiUrl, {
                ...
                .then(data => {
                    ...
                    if (data.messageError) {
                        ...
                        // document.getElementById('diplayBalanceAfter').value = data.messageError;
                        // console.log('Error');
                        ...
                        // document.getElementById('diplayBalanceAfter').value = '';
                    }
...
<script>
    function submitForm() {
        ...
        const apiUrl = baseUrl + 'teams/add_team_leaves_api';
        fetch(apiUrl, {
                method: 'POST',
                body: formData
            })
            ...
            .then(data => {
                ...
                if (data.messageError) {
                    ...
                    window.location.href = '<?= base_url() ?>teams/apply_leaves';
                }
            })
            .catch(error => {
                $(document).Toasts('create', {
