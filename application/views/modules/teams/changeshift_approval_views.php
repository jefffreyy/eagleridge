        ...
        <table class="table table-bordered table-hover m-0" id="TableToExport" style="width:100%">
          <thead>
            <tr>
              ...
              <th class="text-left">CURRENT SHIFT</th>
              <th class="text-left">REQUEST SHIFT</th>
            ...
            <?php if ($DISP_SHIFT) {
              foreach ($DISP_SHIFT as $DISP_SHIFT_ROW) { ?>
                <tr data-leave_id="<?= $DISP_SHIFT_ROW->id ?>">
                  ...
                  <td class="text-left"> <?= date(($DATE_FORMAT) ? $DATE_FORMAT : "d/m/Y", strtotime($DISP_SHIFT_ROW->date_shift)) ?> </td>
                  ...
                  <td>
                    <a href="<?= base_url('teams/changeshiftapproval/approve/' . $DISP_SHIFT_ROW->id) ?>" class="btn btn-success approve_req">Approve</a>
                    <a href="<?= base_url('teams/changeshiftapproval/reject/' . $DISP_SHIFT_ROW->id) ?>" class="btn btn-danger reject_req">Reject</a>
                  </td>
...
<script>
  $(document).ready(function() {
    ...
    function reloadPage() {
      ...
      window.location.href = "<?= base_url('teams/mychange_approval') ?>" + "?status=" + status + "&page=" + page + "&row=" + row;
    }
