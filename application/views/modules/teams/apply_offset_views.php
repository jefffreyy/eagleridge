      ...
      <div class="row pt-1">
        ...
        <?php if ($DISP_VIEW_REQUIREDAPPROVERS == 1) { ?>
          <div class="col-md-6 button-title">
            <a onclick="afterRenderFunction()" href="<?= base_url('teams/acquire_offset') ?>" class=" btn btn-primary shadow-none rounded d-flex align-items-center"><img src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
              &nbsp;Acquire </a>

            <a onclick="afterRenderFunction()" href="<?= base_url('teams/redeemed_offset') ?>" class=" btn btn-primary shadow-none rounded d-flex align-items-center"><img src="<?= base_url('assets_system/icons/minus-solid.svg') ?>" alt="">
              &nbsp;Redeemed</a>
                    ...
                    <div class="d-flex row align-items-end">
                      <div class="'col-12 col-xl-6 d-flex ml-1">
                        <div class="row justify-content-center justify-content-lg-start">
                          ...
                          <a href="<?= base_url('teams/apply_offsets') ?>" id="btn_clear_filter" class="mt-2 mt-lg-0 btn btn btn-primary mx-1"><img src="<?= base_url('assets_system/icons/clear_filter.svg') ?>" alt="">&nbsp;Clear</a>
    ...
    <script>
      $(document).ready(function() {
        ...
        $('a.paginate').on('click', function() {
          ...
          window.location.href = "<?= base_url('teams/apply_offsets') ?>" + $(this).attr('href') + filter_url;
          return false;
        })
        ...
        function reloadPage() {
          ...
          window.location.href = "<?= base_url('teams/apply_offsets') ?>" + "?status=" + status + "&page=" + page + "&row=" + row + '&search=' + search + filter_url;
        }
      })
    </script>
    <!-------------------- Export ----------------->
