...
<?php $index--; } ?>
    ...
    <form action="<?= base_url('selfservices/update_approve_changeoff') ?>" method="POST" id="form_approved">
    ...
    <form action="<?= base_url('selfservices/reject_changeoff_assign') ?>" method="POST" id="form_reject">
        <input type="hidden" name="id" value="<?= $CHANGEOFF->id ?>">
        <input type='hidden' name="approver_1" value="<?= $CHANGEOFF->approver1 ?>">
        <input type='hidden' name="approver_2" value="<?= $CHANGEOFF->approver2 ?>">
        <input type='hidden' name="approver_3" value="<?= $CHANGEOFF->approver3 ?>">
        ...
        <button class="btn btn-danger reject_btn" type="button" reject_id="<?= $CHANGEOFF->id?>" <?=$btn_status?> >Reject</button>
    </form>
