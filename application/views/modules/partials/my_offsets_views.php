...
<body>
  <div class="content-wrapper">
    <div class="container-fluid p-4">
      <div class="row pt-1">
        <div class="col-md-6">
          <h1 class="page-title"><a href="<?= base_url('selfservices') ?>"> <img style="width: 24px; height: 24px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" />
        ...
        <div class="col-md-6 button-title">
          ...
          <a href="<?= base_url('selfservices/request_offset') ?>" class=" btn technos-button-green shadow-none rounded d-flex align-items-center"><img src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
            &nbsp;Add Request</a>
          <a id="btn_export" class=" btn technos-button-green shadow-none rounded d-flex align-items-center"><img src="<?= base_url('assets_system/icons/file-export-solid.svg') ?>" alt="">
            &nbsp;Export XLSXs</a>
          ...
          <div class="table-responsive">
            ...
            <table class="table table-bordered m-0" id="table_main" style="width:100%">
              <thead>
                ...
                <th style='width:10%;text-align: center;'>TIME RANGE</th>
                ...
                <?php if ($TABLE_DATA) {  ?>
                  <?php foreach ($TABLE_DATA as $row_data) { ?>
                    <tr data-id="<?= $row_data->id ?>" data-toggle="modal" data-target="#modal_approval">
                      <td class="text-center"><?= $id_prefix . str_pad($row_data->id, 5, '0', STR_PAD_LEFT) ?></td>
                      <td class="text-center"><?= date_format(date_create($row_data->offset_date), 'd/m/Y') ?></td>
                      <td class="text-center"><?= $row_data->time_range ?></td>
                      <td class="text-center"><?= $row_data->duration ?></td>
                      <td class="text-center"><?= $row_data->reason ?></td>
                      <!-- <td class="text-center"><?= $row_data->remarks ?></td> -->
