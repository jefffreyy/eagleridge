...
<div class="content-wrapper">
    <div class="container-fluid p-4">
        <div class="row pt-1">
            <div class="col-md-6">
                <h1 class="page-title d-flex align-items-center"><a href="<?= base_url() . 'superadministrators'; ?>"><img style="width: 24px; height: 24px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" /></a>&nbsp;Requests List </h1>
            </div>
                            ...
                            foreach ($dataTable as $row) { ?>
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-center">
                                        <button class="btn btn-sm btn_edit indigo lighten-2 edit_position ml-2" data-id="<?= $row->id ?>" >
...
<script>
    $(document).ready(function() {
        ...
        var url_add = '<?= base_url() ?>superadministrators/add_request_list';
        var url_update = '<?= base_url() ?>superadministrators/update_request_list';
        ...
        $(".btn_edit").on("click", function() {
            let id = $(this).attr("data-id");
            $("#ModalLabel").text(`Edit Request (RQT${ id.padStart(5, '0')})`);
            $("#modal_form").modal("show");
            $(".btn-submit").removeClass("d-none");
            $("#status-div").removeClass("d-none");
            $("#request_details").prop("disabled", false); 
