                        ...
                        <div class="col-md-9">
                            <div class="row">
                                <div class="col-md-12 ml-3">
                                    <span style="font-weight: 500; font-size: 18px">Attendance Record</span>
                                </div>
                            ...
                            <form action="<?= base_url('superadministrators/update_attendance_record_setting') ?>" method="post">
                                <div class="row">
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <div class="row m-2 d-flex align-items-center justify-content-between">
                                            <div class="col-6">
                                                <label for="">Eagle Ridge Attendance Record Setting</label>
                                            </div>
                                            <div class="col-6 d-flex justify-content-center justify-content-lg-end">
                                                <label class="switch ml-3">
                                                    <input class="switch_on" value='0' type="hidden" id='eagleridge_attendace_record' name="eagleridge_attendace_record" >
                                                    <input class="switch_on" value='1' type="checkbox" id='eagleridge_attendace_record' name="eagleridge_attendace_record" <?= $eagleridge_attendace_record != '0' ? 'checked' : ''; ?>>
