...
<div class="content-wrapper">
  <div class="container-fluid p-4">
    <div class="row pt-1">
      <div class="col-md-6">
        <h1 class="page-title"><a href="<?= base_url('reports/goverment_forms'); ?>"><img style="width: 24px; height: 24px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" /></a>&nbsp;BIR ALPHA LIST<h1>
      </div>
    </div>
    ...
    <div class="card">
      <div class="py-2">
        <div class="row d-flex justify-content-between">
          ...
          <div class="col-12 col-lg-10 d-none d-lg-flex justify-content-center justify-content-lg-end align-items-center row">
            <div class="col-12 col-lg-6 d-flex justify-content-center justify-content-lg-end py-1">
  ...
  (function() {
    ...
    //================================== HANDSONTABLE ENDS HERE ================================================
      ...
      $('#row_dropdown').on('change', function() {
        var page = "<?= $PAGE ?>";
        window.location.href = "<?= base_url('reports/bir_alpha_list?page=') ?>" + page + '&row=' + $(this).val();
      })
