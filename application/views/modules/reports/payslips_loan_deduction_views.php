  ...
  <div class="container-fluid p-4">
    <div class="row pt-1">
      <div class="col-md-6 ">
        <h1 class="page-title d-flex justify-content-center justify-content-lg-start">
          ...
          </a>&nbsp;Payslips: Cutoff / Loans and Deductions
        </h1>
      </div>
    ...
    <div class="row">
      ...
      <div class="col col-md-3">
        <div class="card p-2 small-box position-relative" id="probationary_employees">
          <div style="padding: 10px 10px;" class="text-left">
            <text style="font-size: 2.2rem; font-weight: 700;" id="prob_employees">
              <?= sprintf("%.2f", $TOTAL_DEDUCTIONS) ?>
            </text><br>
            <text>Total Deducted</text>
          </div>
          <div class="icon" style="position: absolute; top: 28px; right: 17px;">
            <img style="width: 80px; height: 60px; opacity: 0.8;" src="<?= base_url('assets_system/icons/money-bill-1-wave-duotone.svg') ?>" alt="" />
          </div>
    ...
    <!-- <div class="card border-0 p-0 m-0">
      <div class="card border-0 py-1 m-0">
        <div>
          <p class=" m-2 bg-primary p-1  text-center ml-auto" style="color: gray;width:150px;border-radius:15px">Showing <?= count($LOANS) ?> entries&nbsp;</p>
        </div>
          ...
          <table class="table table-bordered table-hover m-0" id="TableToExport">
            <thead style="position: sticky; top: 0;">
              <tr>
                ...
                <th class="text-left" style="min-width: 100px !important">LOAN TOTAL</th>
              </tr>
            </thead>
            <tbody id="tbl_application_container">
              ...
              ?>
                  <tr>
                    <td class="text-left"><?= $loan->col_empl_cmid ?></td>
                    <td class="text-left"><?= $loan->fullname
                                          ?></td>
                    <td class="text-left"><?= sprintf("%.2f", $loan->LOAN_TOTAL ? $loan->LOAN_TOTAL : 0) ?></td>
                  </tr>
                <?php  }
              } else { ?>
...
<script>
  ...
  hot = new Handsontable(container, {
    data: LOANS,
    colHeaders: ['ID', 'Employee ID', 'Employee Name', 'Loan Total'],
    rowHeaders: true,
    height: 'auto',
...
<script>
  function printFunction() {
    ...
    var leavesData = <?php echo json_encode($LOANS); ?>;
...
<script>
  document.getElementById("btn_export").addEventListener('click', function() {
    ...
    XLSX.writeFile(wb, "<?php echo 'employees_loan.xlsx' ?>");
  });
</script>
</body>
