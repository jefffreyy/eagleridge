...
<div class="content-wrapper">
  <div class="container-fluid p-4">
    <div class="row pt-1">
      <div class="col-md-6">
        <h1 class="page-title">
          ...
          </a>&nbsp;Payslips: Cutoff Remittance
        </h1>
      </div>
      <div class="col-md-6 button-title d-none justify-content-end">
    ...
    <div class="row">
      <div class="col-6 col-lg-3 card p-2 small-box position-relative w-25" id="probationary_employees">
        <div style="padding: 10px 10px;" class="text-left">
          <text style="font-size: 2.2rem; font-weight: 700;" id="prob_employees">
            <?= sprintf("%.2f", $TOTAL) ?>
          </text><br>
          <text>Total Remittance</text>
        </div>
    ...
    <!-- <div class="card border-0 p-0 m-0">
      <div class="card border-0 py-1 m-0">
        <div>
          <p class=" m-2 bg-primary p-1  text-center ml-auto" style="color: gray;width:150px;border-radius:15px">Showing <?= count($REMITTANCES) ?> entries&nbsp;</p>
        </div>
          ...
          <table class="table table-bordered table-hover m-0" id="TableToExport">
            <thead style="position: sticky; top: 0;">
              <tr>
                ...
                <th class="text-left" style="min-width: 100px !important">NET INCOME</th>
              </tr>
            </thead>
            <tbody id="tbl_application_container">
              ...
              ?>
                  <tr>
                    <td class="text-left"><?= $remittance->col_empl_cmid ?></td>
                    <td class="text-left"><?= $remittance->fullname
                                          ?></td>
                    <td class="text-left"><?= sprintf("%.2f", $remittance->NET_INCOME ? $remittance->NET_INCOME : 0) ?></td>
                  </tr>
                <?php  }
              } else { ?>
...
<script>
  let REMITTANCES = <?= json_encode($REMITTANCES); ?>;
  ...
  hot = new Handsontable(container, {
    data: REMITTANCES,
    colHeaders: ['ID', 'Employee ID', 'Employee Name', 'Net Income'],
    rowHeaders: true,
    height: 'auto',
...
<script>
  function printFunction() {
    ...
    var leavesData = <?php echo json_encode($REMITTANCES); ?>;
...
<script>
  document.getElementById("btn_export").addEventListener('click', function() {
    ...
    XLSX.writeFile(wb, "<?php echo 'employees_remittances.xlsx' ?>");
  });
</script>
</body>
</html>