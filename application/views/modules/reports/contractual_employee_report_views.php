                ...
                <tr>
                  <th colspan="5">
                    <div style="
                      ...
                      <div>
                        <h5 style="margin: 0; padding: 2px 0;">Contractual Employees</h5>
...
<script>
  $(document).ready(function() {
    $('input[name="daterange"]').daterangepicker({
      ...
      window.location.href = "<?= base_url('reports/contractual_employees?date_from=') ?>" + start.format('YYYY-MM-DD') + '&date_to=' + end.format('YYYY-MM-DD');
    });
    $('select.cut_off_period').on('change', function() {
      window.location.href = "<?= base_url('reports/contractual_employees?period=') ?>" + $(this).val()
    });

    $('#daily_add').on('change', function() {
      window.location.href = "<?= base_url('reports/contractual_employees?date=') ?>" + $(this).val();
    })
    ...
    function filter_type() {
      ...
      if (filter_type === 'period') {
        ...
        window.location.href = "<?= base_url('reports/contractual_employees?period=') ?>" + period;
      }
    }
    ...
    //     let url                 ="<?= base_url('reports/get_contractual_data?date_from=') ?>"+date_from_formatted+'&date_to='+date_to_formatted;
    //     fetch(url)
    //     .then(res=>res.json())
    //     .then((data)=>{
    //         let data_formatted=[];
    ...
    //         const title = 'Contractual Employees';
