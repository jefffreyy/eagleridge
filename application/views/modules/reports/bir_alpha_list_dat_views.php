...
<div class="content-wrapper">
  <div class="container-fluid p-4">
    <div class="row pt-1">
      <div class="col-md-6">
        <h1 class="page-title"><a href="<?= base_url('reports/goverment_forms'); ?>"><img style="width: 24px; height: 24px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" /></a>&nbsp;BIR ALPHA LIST DAT<h1>
      </div>
    </div>
    ...
    <div class="card">
      <div class="py-2">
        <div class="row d-flex justify-content-between">
          <div class="col-12 col-lg-4 d-flex justify-content-center justify-content-lg-start ml-2">
            <button class="generate_pdfs btn btn-primary m-1" hidden>Generate PDF1</button>
          ...
          <div class="col-12 col-lg-10 d-none d-lg-flex justify-content-center justify-content-lg-end align-items-center row my-lg-2">
            <div class="col-12 col-lg-6 d-lg-flex justify-content-center justify-content-lg-end my-lg-2">
          ...
          <div class="col-12 col-lg-2 d-none d-lg-flex justify-content-center my-0 my-lg-2 align-items-center">
  ...
  (function() {
    ...
    //================================== HANDSONTABLE ENDS HERE ================================================
      ...
      $('#row_dropdown').on('change', function() {
        var page = "<?= $PAGE ?>";
        window.location.href = "<?= base_url('reports/bir_alpha_list_dat?page=') ?>" + page + '&row=' + $(this).val();
      })
