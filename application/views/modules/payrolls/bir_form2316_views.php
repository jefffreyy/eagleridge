...
<div class="content-wrapper">
    <div class="container-fluid p-4">
        ...
        <h1 class="page-title"><a href="<?= base_url().'payrolls';?>"><i class="fa-duotone fa-circle-left"></i></a>&nbsp;BIR form 2316<h1>
        <div class="row  d-flex justify-content-center">
        <div class="col-sm-8 form_font">
            <div class="card mt-3">
