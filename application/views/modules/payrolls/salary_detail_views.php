...
<body>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?= base_url() ?>payrolls">Employee
                        </a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Salary Details
                    </li>
                </ol>
            </nav>
            ...
            <div class="filter-container <?= $filter ? 'visible' : '' ?>">
                <div class=" mb-4  d-flex row "><!-- Filter Starts -->
                    ...
                    <div class="col-md-2">
                        ...
                        <a href=<?= base_url() . "payrolls/salary_details" ?> id="btn_clear_filter" class="col btn btn-secondary mx-1">Clear Filter</a>
                    </div> -->
                        ...
                        <div class="">
                            <div class="justify-content-between">
                                ...
                                <div class="d-flex row align-items-center">
                                    <div class="form-group row d-flex justify-content-center justify-content-lg-start col-12 col-md-6 ">
                                        ...
                                        <a href="<?= base_url('payrolls/salary_details') ?>" id="btn_clear_filter" class="btn btn-primary mx-1"><img src="<?= base_url('assets_system/icons/clear_filter.svg') ?>" alt="">&nbsp;Clear</a>

                                    </div>

                                    <div class="d-none d-lg-flex col-sm-7 col-md-10 col-lg-6 justify-content-center my-lg-0 my-2">
                                        <div class="col-12 col-lg-9 d-flex justify-content-lg-end align-items-end ">
                                            <div class="d-flex align-items-center row">
                                                ...
                                                <div class="d-lg-inline d-flex col-12 col-lg-5 justify-content-center justify-content-lg-start">
    ...
    <div class="modal fade  class_modal_update_list" id="modela_update" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url() . 'payrolls/update_salary_detail_bulk'; ?>" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
    ...
    <script>
        ...
        function filter_clear() {
            document.location.href = "salary_details";
        }
    </script>
    ...
    <script>
        ...
        hot = new Handsontable(container, {
            data: data,
            colHeaders: ['ID', 'Employee ID', 'Employee Name', 'Salary Type', 'Salary Amount', 'History'],
            rowHeaders: true,
                ...
                },
                {
                    ...
                    renderer: function(instance, td, row, col, prop, value, cellProperties) {
                        ...
                        function handleInvalidInput() {
                            ...
                            alert(`Invalid input. Please enter a valid salary amount.`);
                            cellProperties.alertTriggered = true; 
                        }
                        ...
                        if (value === null || value === undefined || value === '') {
                            ...
                            if (numericValue >= 0 && numericValue <= 1000000) {
                                    ...
                                    cellProperties.alertTriggered = false; 
                            } else {
                                td.innerHTML = '<span style="color: red;">Invalid value</span>';
                                if (!cellProperties.alertTriggered) {
                                    handleInvalidInput();
                                }
                            }
                        } else {
                ...
                },
                {
                    ...
                    renderer: function(instance, td, row, col, prop, value, cellProperties) {
                        ...
                        button.addEventListener('click', function() {
                            ...
                            if (id) {
                                window.location.href = 'salary_history/' + id;
                            }
                        });
        ...
        update_date.addEventListener('click', function() {
            ...
            fetch(url + 'payrolls/update_salary_detail', {
                    method: 'POST',
                    headers: {
    ...
    <script>
        $(document).ready(function() {
            ...
            function filter_data(page_row) {
                ...
                filterUrl = page_row + "&branch=" + branch + "&dept=" + department + "&division=" + division + "&clubhouse=" + clubhouse + "&section=" + section + "&group=" + group + "&team=" + team + "&line=" + line + "&company=" + company;

                if (document.querySelector('.filter-container').classList.contains('visible')) {
                    filterUrl = filterUrl + '&filter=1';
                }
                window.location = base_url + "payrolls/salary_details" + filterUrl;
            }
            $('.salary_val').on('keydown', function(event) {
                if (event.key === "Enter") {
                    ...
                    if (default_val != salary_val) {
                        window.location = base_url + "payrolls/process_salary_update/" + employee_id + "/" + salary_val;
                    }
                }
            })
            ...
            $('.salary_type').on('change', function() {
                ...
                window.location = base_url + "payrolls/process_salary_type_update/" + employee_id + "/" + type_val;
            })
