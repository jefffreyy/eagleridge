        ...
        <div class="card border-0 p-0 m-0">
          <div class="p-2">
            <div class="float-right mb-2" id="view_details" hidden>
              ...
              <a href="<?= base_url() . 'payrolls/view_details?period=' . $PERIOD. '&tab='.$TAB; ?>" class=" btn technos-button-green shadow-none rounded" <?= ($GENERATED_LIST_COUNT == '0') ? "hidden" : ''; ?>><img style="height: 15px; width: 15px;" class="mb-1" src="<?= base_url('assets_system/icons/eye-solid_new.svg') ?>" alt="">&nbsp;Generated View Details</a>
            ...
            <div class="float-right mb-2" id="published_view_details" hidden>
              ...
              <a href="<?= base_url() . 'payrolls/published_view_details?period=' . $PERIOD. '&tab='.$TAB; ?>" class=" btn technos-button-green shadow-none rounded" <?= ($PUBLISHED_LIST_COUNT == '0') ? "hidden" : ''; ?>><img style="height: 15px; width: 15px;" class="mb-1" src="<?= base_url('assets_system/icons/eye-solid_new.svg') ?>" alt="">&nbsp;Published View Details</a>
            ...
            <div class="float-right mb-2" id="generate_payslip" hidden>
              <a href="<?= base_url() . 'payrolls/payroll_summary?period=' . $PERIOD. '&tab='.$TAB; ?>" class=" btn technos-button-green shadow-none rounded"><img style="height: 15px; width: 15px;" class="mb-1" src="<?= base_url('assets_system/icons/eye-solid_new.svg') ?>" alt="">&nbsp;Generate Payslip</a>
            </div>
            ...
            <ul class="nav nav-tabs border-0">
              <li class="nav-item">
                <a class="nav-link "   href="<?= base_url() . 'payrolls/pending' ?>"  id="payslip_pending" pending_name='pending'><img style="width: 15px; height: 15px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/hand-solid.svg') ?>" alt="" />&nbsp;&nbsp;Pending
...
// Government Contributions    ================ End ===============
      ...
      //     // let newUrl = base_url + "payrolls/payroll_status?period=" + cut_off + "&tab=" + tabId;
      ...
      function filter_data(tabId) {
        ...
        let cut_off = $("#cut_off_period").find(":selected").val();
        window.location = base_url + "payrolls/payroll_status?period="+cut_off+"&tab="+tabId;
      }
