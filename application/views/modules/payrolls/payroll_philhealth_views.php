    ...
    <div class="container-fluid p-4">
        ...
        <div class="row pt-1">
            ...
            <div class="col-md-6">
                ...
                <h1 class="page-title d-flex align-items-center"><a href="<?= base_url('payrolls') ?>"><img style="width: 24px; height: 24px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" /></a>&nbsp;PhilHealth Contribution Table<h1>
        ...
        <hr>
            ...
            <div class="col-md-2 my-3">
                ...
                <select name="contribution_type" id="contribution_type" class="form-control">
                    ...
                    <option value="philhealth" selected readonly>Philhealth</option>
...
<script>
    ...
    function initializeHandsontable(data) {
        ...
        hot = new Handsontable(container, {
            ...
            readOnly: true,
            nestedHeaders: [
                ['id', 'Year', 'Basic Min', 'Basic Max', 'Rate', 'Premium Min', 'Premium Max'],
            ],
            rowHeaders: true,
            height: 'auto',
