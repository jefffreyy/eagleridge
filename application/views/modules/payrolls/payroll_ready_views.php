        ...
        <div class="card border-0 p-0 m-0">
          <div class="p-2">
            ...
            <div class="float-right mb-2" id="generate_payslip" <?= ($DISP_EMP_LIST) ? "" : "hidden" ?>>
              <a href="<?= base_url() . 'payrolls/payroll_summary?period=' . $PERIOD . '&tab=' . $TAB; ?>" class=" btn btn-primary shadow-none rounded"><img style="height: 15px; width: 15px;" class="mb-1" src="<?= base_url('assets_system/icons/eye-solid_new.svg') ?>" alt="">&nbsp;Generate Payslip</a>
            </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      function filter_data(tabId) {
        ...
        let cut_off = $("#cut_off_period").find(":selected").val();
        window.location = base_url + "payrolls/ready?period=" + cut_off;
      }
