...
<body>
  ...
  <div class="content-wrapper">
    <div class="container-fluid p-4">
      <div class="row  pt-1">
        <!-- Title Text -->
        <div class="col-md-6">
          <h1 class="page-title"><a href="<?= base_url() . 'payrolls/'; ?>"><img
                style="width: 24px; height: 24px; margin-bottom: 3px;"
                src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" />
            </a>&nbsp;Payroll Generation <button type="button" title="How to generate payroll?" class="d-inline-flex align-items-start border-0 bg-transparent video-btn" data-toggle="modal"
              data-src="https://technos-systems.com/_eyeboxroot/videos/payroll/Generate_Payslip.mp4"
              data-target="#myModal">
              <img src="<?= base_url('assets_system/icons/info-circle.svg.svg') ?>" alt=""
        ...
        <div class="col-md-6 button-title">
          ...
          <a href="<?= base_url() . 'payrolls/payslip_setting'; ?>" id="" class="btn btn-primary shadow-none"> <img
              style="width: 18px; height: 18px; margin-bottom: 4px;"
              src="<?= base_url('assets_system/icons/gears-duotone_xs.svg') ?>" alt="" />&nbsp;Payslip Setting</a>
        </div>
      </div>
      <hr>
      <div class="row mb-4">
        <div class=" col-md-2 ">
          ...
          <select class="form-control cut_off_period" id="cut_off_period">
            <?php foreach ($CUTOFF_PERIODS as $cut_off) { ?>
              <option value="<?= $cut_off->id ?>" <?= $PERIOD == $cut_off->id ? 'selected' : '' ?>><?= $cut_off->name ?>
              </option>
            <?php } ?>
          </select>
        </div>
        ...
        <div class="col-3 hover mt-0 p-0" id="view_details_total" hidden>
          <div class="card p-0 small-box">
            <div style="padding: 5px 20px; " class="text-left">
              ...
              <text
                style="padding: 5px; font-size: 1rem; font-weight: 600;">₱<?= number_format($DISP_GENERATED_SUM_NET_INCOME, 2) ?></text>
            </div>
          </div>
        </div>
        <div class="col-3 hover mt-0 p-0" id="published_view_details_total" hidden>
          <div class="card p-0 small-box">
            <div style="padding: 5px 20px; " class="text-left">
              <text style="font-size: 1rem; font-weight: 400;">Total net income :</text>
              <text
                style="padding: 5px; font-size: 1rem; font-weight: 600;">₱<?= number_format($DISP_PUBLISHED_SUM_NET_INCOME, 2) ?></text>
            </div>
          </div>
        </div>
        ...
        <div class="card border-0 p-0 m-0">
          <div class="p-2">
            ...
            <ul class="nav nav-tabs border-0 d-none d-lg-flex">
              <li class="nav-item" style="background-color:#e8e8e8;">
                <a class="nav-link " href="<?= base_url() . 'payrolls/pending?period=' . $PERIOD ?>"><img
                    style="width: 15px; height: 15px; margin-bottom: 3px;"
                    src="<?= base_url('assets_system/icons/hand-solid.svg') ?>" alt="" />&nbsp;&nbsp;Pending
                  <span class="ml-2 badge badge-pill badge-secondary"> <?= $DISP_PENDING_COUNT; ?> </span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link " href="<?= base_url() . 'payrolls/ready?period=' . $PERIOD ?>"><img
                    style="width: 15px; height: 15px; margin-bottom: 3px;"
                    src="<?= base_url('assets_system/icons/circle-x-solid.svg') ?>" alt="" />&nbsp;&nbsp;Ready
                  <span class="ml-2 badge badge-pill badge-secondary"> <?= $DISP_EMP_LIST_COUNT; ?> </span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link " href="<?= base_url() . 'payrolls/generated?period=' . $PERIOD ?>"><img
                    style="width: 15px; height: 15px; margin-bottom: 3px;"
                    src="<?= base_url('assets_system/icons/circle-check-solid_payslip.svg') ?>"
                    alt="" />&nbsp;&nbsp;Generated
                  <span class="ml-2 badge badge-pill badge-secondary"> <?= $GENERATED_LIST_COUNT; ?> </span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link " href="<?= base_url() . 'payrolls/published?period=' . $PERIOD ?>"><img
                    style="width: 15px; height: 15px; margin-bottom: 3px;"
                    src="<?= base_url('assets_system/icons/file-pdf-solid.svg') ?>" alt="" />&nbsp;&nbsp;Published
          ...
          <div class="tab-content">
            <div class="card border-0 mt-2 p-0 "
              style="margin-top: -1px !important; margin-bottom: 0px !important; border-top: none !important; ">
              <div class="row">
                <div class="col">
  ...
  <!-- =============== APPY TEMPLATE ================= -->
  <!-- Modal -->
  <div class="modal fade" id="assign_shift" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
  ...
  <!-- =============== APPY TEMPLATE ================= -->
  <div class="modal fade  class_modal_update_list" id="modela_update" tabindex="-1" role="dialog"
  ...
  <div class="modal fade  class_modal_update_list1" id="modela_update1" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header" style="border-bottom: none;">
        ...
        <form action="<?= base_url() . 'payrolls/add_payslip_published'; ?>" method="post" accept-charset="utf-8"
          autocomplete='off' class="m-2">
          <div class="modal-body">
            <div class="row">
              <div class="col-md-12">
  ...
  <div class="modal fade  class_modal_update_list2" id="modela_update2" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header" style="border-bottom: none;">
  ...
  <script>
    $(document).ready(function () {
      ...
      function filter_data(tabId) {
        ...
        let cut_off = $("#cut_off_period").find(":selected").val();
        window.location = base_url + "payrolls/pending?period=" + cut_off;
      }
