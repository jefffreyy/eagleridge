        ...
        <div class="container-fluid p-4">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Custom Pag-IBIG Contributions
                    </li>
                </ol>
            </nav>
            ...
            <div class="row  pt-1"> <!-- Title starts -->
                <div class="col-md-6">
                    <h1 class="page-title">Custom Pag-IBIG Contributions</h1>
                </div>
    ...
    <div class="modal fade  class_modal_update_list" id="modela_update" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url() . 'payrolls/update_pagibig_custom_contribution'; ?>" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
    ...
    <script>
        $(document).ready(function() {
            ...
            function filter_data() {
                ...
                window.location = base_url + "payrolls/pagibig_contributions?branch=" + branch +
