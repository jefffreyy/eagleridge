    ...
    <div class="container-fluid p-4">
        <div class="row pt-1">
            ...
            <div class="col-md-6 button-title">
                <a href="<?= base_url() . 'payrolls/add_payroll_sched'; ?>" class=" btn btn-primary shadow-none rounded"><img class="mb-1" src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
                    &nbsp;Add Period</a>
            </div>
        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center d-flex justify-content-center ">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                        <a class="dropdown-item" href="<?= site_url('payrolls/payroll_sched/' . $row_data->id) ?>">Details</a>
                                                        <a class="dropdown-item" href="<?= site_url('payrolls/payroll_status') ?>?period=<?= $row_data->id ?>&tab=pending">Payroll status</a>
                                                        <a class="dropdown-item" href="<?= site_url('payrolls/edit_payroll_sched/' . $row_data->id) ?>">Edit</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php } ?>
    ...
    (function() {
            $(document).ready(function() {
                $('select.paysched-year,select.paysched-frequency').on('change', function() {
                    ...
                    window.location.href = "<?= site_url('payrolls/payroll_schedules') ?>" + "?year=" + year + '&pay_frequency=' + frequency;
                })
