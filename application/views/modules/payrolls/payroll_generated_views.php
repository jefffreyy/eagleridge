...
<body>
        ...
        <div class="card border-0 p-0 m-0">
          <div class="p-2">
            ...
            <div class="row d-block d-lg-none mb-2">
              <div class="col-12">
                <label for="" class="col-12">Action</label>
                <select name="" class="form-control" id="action">
                  <option value="delete">Delete</option>
                  <option value="publish">Publish</option>
                </select>
                <button class="btn btn-primary shadow-none rounded mt-1" onclick="performAction()">Perform Action</button>
              </div>

              <div class="col-12 my-3" >
                <a href="<?= base_url() . 'payrolls/view_details?period=' . $PERIOD . '&tab=' . $TAB; ?>" class="mr-1 btn btn-primary shadow-none rounded"><img style="height: 15px; width: 15px;" class="mb-1" src="<?= base_url('assets_system/icons/eye-solid_new.svg') ?>" alt="">&nbsp;Generated View Details</a>
              </div>

            </div>
            <div class="float-right mb-2 d-none d-lg-flex" id="view_details">
              <!-- <span style="font-size: 20px; margin-right: 30px;" >TOTAL NET INCOME : ₱<?= number_format($DISP_GENERATED_SUM_NET_INCOME, 2) ?></span> -->
              <a style="width: 150px;" href="#" class="mr-1 btn btn-primary shadow-none rounded" id="bulk_delete" data-toggle="modal" data-target="#modal_bulk_delete"><img style="height: 14px; width: 14px;" class="mb-1" src="<?= base_url('assets_system/icons/circle-check-solid_mark.svg') ?>" alt="">&nbsp;Bulk Delete</a>
              <a  <?= ($PAYROLL_PAYSLIP_GENERATED_LIST) ? "" : "hidden" ?> href="<?= base_url() . 'payrolls/view_details?period=' . $PERIOD . '&tab=' . $TAB; ?>" class="mr-1 btn btn-primary shadow-none rounded"><img style="height: 15px; width: 15px;" class="mb-1" src="<?= base_url('assets_system/icons/eye-solid_new.svg') ?>" alt="">&nbsp;Generated View Details</a>
              <a style="width: 150px;" href="#" class=" btn btn-primary shadow-none rounded" id="update1" data-toggle="modal" data-target="#modela_update1"><img style="height: 14px; width: 14px;" class="mb-1" src="<?= base_url('assets_system/icons/circle-check-solid_mark.svg') ?>" alt="">&nbsp;Publish</a>
            </div>
              ...
              <div class="row">
                <div class="col">
                  <div class="table-responsive">
                    <table class="table table-bordered table-hover pt-0" id="tbl_payslip" style="margin-bottom: 0px; padding-bottom: 0px;">
                      <thead>
                        ...
                        <th class="text-center">NET&nbsp;INCOME
                          <?php if ($PAYROLL_PAYSLIP_GENERATED_LIST_NEGATIVE_COUNT != '0') { ?>
                            <span style="font-size:12px !important ;font-weight:500; word-wrap:break-word !important;" class="ml-2 badge badge-pill badge-danger"> <?= $PAYROLL_PAYSLIP_GENERATED_LIST_NEGATIVE_COUNT; ?> </span>
                          <?php } ?>
                        </th>
                        <th class="text-left">ACTION</th>
                      </thead>
                      <tbody>
                        <?php if ($PAYROLL_PAYSLIP_GENERATED_LIST) {
                          foreach ($PAYROLL_PAYSLIP_GENERATED_LIST as $GENERATED_LIST) {; ?>

                            <tr class="payslip_row">
                              <td class="text-center" id="select_item">
                                <input type="checkbox" name="brand" class="check_single" empl_id='<?= $GENERATED_LIST->empl_id ?>' bulk_other_deduction_list="<?= $GENERATED_LIST->OTHER_DEDUCTION_LIST; ?>" loan_id_list="<?= $GENERATED_LIST->LOAN_ID; ?>" empl_name="<?= $GENERATED_LIST->PAYSLIP_EMPLOYEE_NAME ?>" net_income="<?= $GENERATED_LIST->NET_INCOME; ?>" value="<?= $GENERATED_LIST->id ?>">
                              </td>
                              <td class="text-left">PAY<?= str_pad($GENERATED_LIST->id, 5, '0', STR_PAD_LEFT) ?></td>
                              <td class="text-left"><?= $GENERATED_LIST->PAYSLIP_EMPLOYEE_CMID; ?></td>
                              <td class="text-left"><?= $GENERATED_LIST->PAYSLIP_EMPLOYEE_NAME; ?></td>
                              <td class="text-right">
                              <span style="float: left;">&#8369;</span><?= number_format($GENERATED_LIST->NET_INCOME, 2); ?>
                                <?php if ($GENERATED_LIST->NET_INCOME < 0) : ?>
                              ...
                              <td class="text-center">
                                <a payslip_id='<?= $GENERATED_LIST->id ?>' empl_id='<?= $GENERATED_LIST->empl_id ?>' class="btn-generate_payslip_pdf" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important"><img src="" alt=""></a>
                                <a href="<?= base_url(); ?>payrolls/generated_payslip/<?= $GENERATED_LIST->empl_id; ?>/<?= $GENERATED_LIST->PAYSLIP_PERIOD; ?>" class="select_edit_row m-1" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important" hidden><i class="fa-duotone fa-eye"></i></a>
                                <a class="select_edit_row m-1 btn_delete" empl_id='<?= $GENERATED_LIST->empl_id ?>' delete_other_deduction="<?= $GENERATED_LIST->OTHER_DEDUCTION_LIST; ?>" delete_key="<?= $GENERATED_LIST->LOAN_ID; ?>" delete_id="<?= $GENERATED_LIST->id; ?>" style="background-color: transparent; border: none;color: gray; cursor: pointer;"><img class="mb-1" src="<?= base_url('assets_system/icons/trash-solid.svg') ?>" alt="" /></a>
                                <!-- <a href="<?= base_url(); ?>payrolls/edit_generated_payslip/<?= $GENERATED_LIST->empl_id; ?>/<?= $GENERATED_LIST->PAYSLIP_PERIOD; ?>" class="select_edit_row m-1" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important"><i class="far fa-edit" id="edit"></i></a> -->
                              </td>
                            </tr>
                          <?php }
                        } else { ?>
      ...
      <div class="modal-content">
        ...
        <form action="<?= base_url() . 'payrolls/add_payslip_published'; ?>" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
          ...
          <div class="modal-footer">
            ...
            <input type="hidden" name="UPDATE_NET_INCOME" id="UPDATE_NET_INCOME">
            <button type="submit" class='btn btn-primary text-light' id="save_button">&nbsp; Save
            </button>
          </div>
        </form>
  ...
  <div class="modal fade  class_modal_bulk_delete" id="modal_bulk_delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header" style="border-bottom: none;">
          <h4 class="modal-title ml-1" id="exampleModalLabel">Bulk Delete Payslip
          </h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;
            </span>
        ...
        <form action="<?= base_url() . 'payrolls/bulk_delete_payslip_published'; ?>" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
          <div class="modal-body">
            <div class="row">
              <div class="col-md-12">
                <ul id="delete_published_id" class="row" style="background: #e7f4e4;"></ul>
              </div>
            </div>
          </div>
          <div class="modal-footer">
            <input type="hidden" name="DELETE_PUBLISH_ID" id="DELETE_PUBLISH_ID">
            <input type="hidden" name="DELETE_EMPLOYEE_LOAN_LIST" id="DELETE_EMPLOYEE_LOAN_LIST">
            <input type="hidden" name="DELETE_EMPLOYEE_OTHER_DEDUCTION_LIST" id="DELETE_EMPLOYEE_OTHER_DEDUCTION_LIST">
            <input type="hidden" name="DELETE_EMPL_ID" id="DELETE_EMPL_ID">
            <input type="hidden" name="DELETE_CUTOFF_PERIOD" id="DELETE_CUTOFF_PERIOD">
            <button type="submit" class='btn btn-primary text-light' id="save_button">&nbsp; Save
            </button>
          </div>
        </form>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('.btn_delete').click(function(e) {
        e.preventDefault();
        let cut_off_period = $("#cut_off_period").find(":selected").val();
        var delete_other_deduction = $(this).attr('delete_other_deduction');
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            $.ajax({
              ...
              data: {
                ids: [user_deleteKey],
                otherDeduction: [delete_other_deduction],
      ...
      $('#update1').click(function() {
        ...
        $('#select_item input[type=checkbox]:checked').each(function() {
          ...
          let att_net_income = $(this).attr('net_income')

          if (Number(att_net_income) >= 0) {
            selected_id.push(selected_item);
            att_empl_names.push(att_empl_name);
        ...
        if (selected_id.length > 0) {
          ...
          $('#UPDATE_NET_INCOME').val(att_net_incomes);
          ...
          Swal.fire(
            'Something went wrong. Please select employee!',
            '',
            'warning'
          )
        }
      ...
      $('#bulk_delete').click(function() {
        ...
        let att_empl_names              = [];
        let att_loan_lists              = [];
        let att_other_deduction_lists   = [];
        let att_empl_ids                = [];

        $('#DELETE_EMPLOYEE_LOAN_LIST').empty();
        $('#DELETE_EMPLOYEE_OTHER_DEDUCTION_LIST').empty();
        $('#DELETE_EMPL_ID').empty();
        $('#DELETE_PUBLISH_ID').empty();
        $('#DELETE_CUTOFF_PERIOD').empty();
        $('#delete_published_id').empty();

        $('#select_item input[type=checkbox]:checked').each(function() {
          let selected_item               = $(this).val();
          let att_empl_name               = $(this).attr('empl_name')
          let att_loan_list               = $(this).attr('loan_id_list');
          let att_other_deduction_list    = $(this).attr('bulk_other_deduction_list');
          let empl_id                     = $(this).attr('empl_id')

          selected_id.push(selected_item);
          att_empl_names.push(att_empl_name);
          att_loan_lists.push(att_loan_list);
          att_other_deduction_lists.push(att_other_deduction_list);
          att_empl_ids.push(empl_id);
        })
        if (selected_id.length > 0) {
          $('.class_modal_bulk_delete').prop('id', 'modal_bulk_delete');
          $('#DELETE_PUBLISH_ID').val(selected_id);
          $('#DELETE_EMPLOYEE_LOAN_LIST').val(att_loan_lists);
          $('#DELETE_EMPLOYEE_OTHER_DEDUCTION_LIST').val(att_other_deduction_lists);
          $('#DELETE_EMPL_ID').val(att_empl_ids);
          $('#DELETE_CUTOFF_PERIOD').val(cut_off_period);

          att_empl_names.forEach(function(data) {
            $('#delete_published_id').append(`<li class="col-md-6"> <strong>${data}</strong></li>`);
          })
        } else {
          $('.class_modal_bulk_delete').prop('id', '');
          Swal.fire(
            'Please Select Employee!',
            '',
            'warning'
      ...
      //   window.location = base_url + "payrolls/payroll_status" + "?status=" + data;
      // }
      ...
      function filter_data(tabId) {
        ...
        window.location = base_url + "payrolls/generated?period=" + cut_off;
      }
      // $('select.cut_off_period').on('change', function() {
      //   window.location.href = "<?= base_url('payrolls/payrolls?period=') ?>" + $(this).val()
      // })
    })
  </script>
  ...
  <script>
    function performAction() {
      ...
      if (selectedValue === "delete") {
        // Trigger the delete link
        $("#bulk_delete").click();
      } else if (selectedValue === "publish") {
        // Trigger the publish link
        $("#update1").click();
      }
