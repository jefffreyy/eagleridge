...
<div class="content-wrapper" style="min-height: 624px;">
    <div class='row'>
        <div class='col-md-8 ml-4 mt-3'>
            <h2><a href="<?= base_url() . 'requests/leave_lists'; ?>"><img style="width: 32px; height: 32px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt=""></a></h2>
        </div>
    </div>
                    ...
                    <div class="modal-body pb-5">
                        ...
                        <div class="row">
                            <!-- <form id="leaveForm" style="width:100%"> -->
                                ...
                                <div class="col-md-12">
                                <?php echo form_open('leaves/update_leaves'); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?=$LEAVE->employee?>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label class="">Type</label>
                                        <select class="form-control" name="type" id="type" enabled="">
                                            <?php foreach ($LEAVE_TYPES as $type) { ?>
                                                <option value="<?= $type->id ?>" data-name="<?= $type->name ?>" <?= ($type->id == $LEAVE->type) ? 'selected' : '' ?>>
                                                    <?= $type->name ?>
                                                </option>
                                            <?php } ?>
                                        </select>
                                    ...
                                    <table id="timeTable">
                                        ...
                                        <tbody>
                                            <?php if($CHILD_LEAVES){ 
                                                    foreach($CHILD_LEAVES as $LEAVE_ROW){
                                                ?> 
                                            <tr>
                                                <input type="hidden" id="" name="id[]" value="<?= $LEAVE_ROW->id ?>" class="date form-control">
                                                <td><input type="text" id="" name="dates[]" value="<?= $LEAVE_ROW->leave_date ?>" class="date form-control" readonly></td>
                                                <td>
                                                <input type="text" name="current_shift[]" id="" class="current_shift form-control" value="<?= ($LEAVE->current_shift) ? $LEAVE->current_shift : 'No shift assign' ?> " readonly>
                                                </td>
                                                <td>
                                                    <div class="input-group">
                                                        <input type="text" name="leave_range[]" value="<?= $LEAVE->leave_range ?>" class=" leaverange form-control" placeholder="Select time range" readonly>
                                                    </div>
                                                </td>
                                                ...
                                                <?php } ?>
                                                class="hours form-control" readonly></td>
                                            </tr>
                                            <?php
                                            }
                                                }?>
                                    ...
                                    <div class="form-group" id="reason">
                                        ...
                                        <textarea name="reason" class="form-control" id="remarks" rows="4" cols="50" enabled="" readonly><?= $LEAVE->reason ?></textarea>
                                    </div>
...
<!-- <script>
    function submitForm() {
        ...
        const apiUrl = baseUrl + 'leaves/update_leaves';
        fetch(apiUrl, {
                method: 'POST',
                body: formData
            })
