    ...
    <div class="container-fluid p-4">
      ...
      <div class="row pt-1">
        <div class="col-md-6">
          ...
          <a href="<?= base_url('leaves/leave_lists') ?>" class=" btn btn-primary"><img class="mb-1" src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
              &nbsp;Normal Request</a>
            ...
            <a href="<?= base_url('leaves/new_request_leave_direct') ?>" class=" btn btn-primary"><img class="mb-1" src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">&nbsp;Add Request</a>
          </div>
            ...
            <div class="d-flex justify-content-between align-items-end">
              <div class="mx-1">
                ...
                <div class="d-flex">
                    ...
                    <a href="<?= base_url('leaves/leave_lists_multi') ?>" id="btn_clear_filter" class="btn btn-primary mx-1"><img src="<?= base_url('assets_system/icons/clear_filter.svg')?>" alt=""/>&nbsp;Clear</a>
                </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('a.paginate').on('click', function() {
        ...
        window.location.href = "<?= base_url('leaves/leave_lists_multi') ?>" + $(this).attr('href') + filter_url;
        return false;
      })
      ...
      function reloadPage() {
        ...
        window.location.href = "<?= base_url('leaves/leave_lists_multi') ?>" + "?status=" + status + "&page=" + page + "&row=" + row + '&search=' + search + filter_url;
      }
