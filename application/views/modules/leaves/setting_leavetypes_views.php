            ...
            <div class="mx-auto card d-block d-lg-none col-11">
                <div class="form-group row d-flex justify-content-center">
                    ...
                    <select name="" class="form-control col-10" id="settingsDropdown">
                        <option value="leave_policies" >
                            Leave Policies
                        </option>
                        <option value="leave_types" selected>
                            Leave Types
                        </option>
                    </select>
                </div>
                ...
                <div class="card col-xl-8 col-lg-4 col-md-8 col-11" style="min-height:700px ">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="row mx-2">
                                <div class="col-md-12">
                                    <span style="font-weight: 500; font-size: 18px">Leave Types</span>
                                </div>
...
<script>
    ...
    update.addEventListener('click', function() {
        ...
        // insert data
        fetch(url + 'leaves/update_leaves_type', {
                method: 'POST',
                headers: {
