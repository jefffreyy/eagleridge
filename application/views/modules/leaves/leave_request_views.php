      ...
      <div class="row pt-1">
        ...
        <div class="col-md-6 button-title d-flex justify-content-center justify-content-lg-end">
          <?php if ($multiple_request == 1) { ?>
            `<a href="<?= base_url('leaves/leave_recommendation') ?>" class=" btn btn-primary shadow-none rounded"><img class="mb-1" src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
              &nbsp;Recommendation</a>
            <a href="<?= base_url('leaves/leave_lists_multi') ?>" class=" btn btn-primary shadow-none rounded"><img class="mb-1" src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
              &nbsp;Multi Request</a> <?php } ?>
          <a href="<?= base_url('leaves/request_leave') ?>" class=" btn btn-primary shadow-none rounded"><img class="mb-1" src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
            &nbsp;Add Request</a>
                ...
                <div class="col-md-12 col-lg-12">
                  <div class="d-flex row justify-content-between align-items-center">
                    <div class="row d-flex justify-content-center justify-content-lg-start col-12 col-md-5 col-lg-5 mx-1">
                      ...
                      <a href="<?= base_url('leaves/leave_lists') ?>" id="btn_clear_filter" class="my-1 my-lg-0 btn btn-primary mx-1"><img src="<?= base_url('assets_system/icons/clear_filter.svg') ?>" alt="" />&nbsp;Clear</a>
                    </div>
