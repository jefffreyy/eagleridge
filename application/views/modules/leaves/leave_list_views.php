    ...
    <div class="container-fluid p-4">
      ...
      <div class="row">
        ...
        <div class="col-md-6" style="text-align: right;">
          <a href="#" class="btn btn-primary shadow-none" id="btn_export"><img class="mb-1" src="<?= base_url('assets_system/icons/file-export-solid.svg') ?>" alt="">
            &nbsp;Export XLSX</a>
          <a href="#" class="btn btn-primary shadow-none" data-toggle="modal" data-target="#modal_assign_leave"><img class="mb-1" src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
            Assign Leave</a>
        </div>
      </div>
      <!-- Title Header Line -->
        ...
        <table class="table table-hover" id="TableToExport">
          ...
          <tbody id="tbl_application_container">
            ...
            if ($C_LEAVE_LIST) {
              ...
              ?>
              <tr>
                <td colspan="12" class="p-4 text-center">No Records</td>
              </tr>
            <?php
            }
            ?>
