...
<body>
        ...
        <div class="p-3">
            <div class="flex-fill">
                <div class="row pr-3 mb-3">
                    <div class="col">
                        <h1 class="page-title"><a href="<?= base_url() . 'employees/directories'; ?>"><i class="fa-duotone fa-circle-left"></i></a>&nbsp;Quick Add Employees</h1>
                    </div>
    ...
    <script>
        ...
        function initializeHandsonTable(data){
            ...
            data,
            colHeaders: ['Employee ID', 'Last Name', 'Middle Name', 'First Name', 'Suffix', 'Birthday','Marital Status', 'Home Address', 'Current Address', 'Gender', 'Nationality', 'Shirt Size', 'Email Address', 'Mobile Number', 'Hired Date', 'Regularization Date', 'Resignation Date', 'Last Day Date', 'Employment Type', 'Position', 'Company', 'Branch', 'Department', 'Division', 'Section', 'Groups', 'Team', 'Line', 'Image File', 'SSS Number', 'Pagibig', 'Philhealth', 'TIN', 'Drivers License', 'National ID', 'Passport', 'HMO', 'HMO Number', 'Salary Rate', 'Salary Type', 'Status'],
            rowHeaders: true,
            height: 'auto',
