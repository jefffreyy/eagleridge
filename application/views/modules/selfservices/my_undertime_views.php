    ...
    <div class="container-fluid p-4">
      <div class="row pt-1">
        ...
        <div class="col-md-6 button-title">
          ...
          <a onclick="afterRenderFunction()" href="<?= base_url('selfservices/request_my_undertime') ?>" class=" btn btn-primary shadow-none rounded d-flex align-items-center"><img src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
            &nbsp;Add Request</a>
                  ...
                  <?php foreach ($TABLE_DATA as $row_data) {
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        ?>
                        <a href="<?= base_url('selfservices/undertime_withdraw/' . $row_data->id) ?>" class="btn btn-default withdraw_req <?=$disabled?>"  >Withdraw</a>
                    </td>
                    </tr>
                  <?php } ?>
                <?php } else { ?>
  ...
  <script>
    $(document).ready(function() {
      ...
      function reloadPage() {
        ...
        var page = "<?= $PAGE ?>";
        window.location.href = "<?= base_url('selfservices/my_undetime') ?>" + "?status=" + status + "&page=" + page + "&row=" + row;
      }
    })
  </script>
