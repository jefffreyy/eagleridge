              ...
              <?php if ($DISP_SHIFT) {
                foreach ($DISP_SHIFT as $DISP_SHIFT_ROW) { ?>
                  <tr data-leave_id="<?= $DISP_SHIFT_ROW->id ?>">
                    ...
                    <td class="text-center"> <a href="<?= base_url('assets_user/files/leaves/' . $DISP_SHIFT_ROW->attachment) ?>"><?= $DISP_SHIFT_ROW->attachment ?></a></td>
                    ...
                    <td>
                      <a href="<?= base_url('selfservices/nurseapproval/approve/' . $DISP_SHIFT_ROW->id) ?>" class="btn btn-success approve_req">Approve</a>
                      <a href="<?= base_url('selfservices/nurseapproval/reject/' . $DISP_SHIFT_ROW->id) ?>" class="btn btn-danger reject_req">Reject</a>
                    </td>
