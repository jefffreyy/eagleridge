...
<div class="content-wrapper">
  <div class="container-fluid p-4">
    <div class="">
      <!-- <h1 class="page-title"><a href="<?= base_url('selfservices') ?>"><i class="fa-duotone fa-circle-left"></i></a>&nbsp;Offset Approval<h1> -->

      <h1 class="page-title d-flex align-items-center"><a href="<?= base_url('selfservices/offset_approval') ?>"> <img style="width: 24px; height: 24px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" />
        </a>&nbsp;Offset Approval List<h1>
    ...
    <div class="row mb-4" hidden>
      ...
      <div class="col-md-2">
        ...
        <a href=<?= base_url() . "selfservices/offset_approval" ?> id="btn_clear_filter" class="col btn btn-secondary mx-1">Clear Filter</a>
      </div>
          ...
          <table class="table table-bordered table-hover m-0" id="TableToExport" style="width:100%">
            <thead>
              <tr>
                ...
                <th class="text-center">Offset ID</th>
              ...
              <?php if ($DISP_SHIFT) {
                foreach ($DISP_SHIFT as $DISP_SHIFT_ROW) { ?>
                  ...
                  <tr>
                    ...
                    <td class="text-center">OFS<?= str_pad($DISP_SHIFT_ROW->id, 5, '0', STR_PAD_LEFT) ?></td>
                    <td class="text-center hover td-directs text-primary" data-empl_id="<?= $DISP_SHIFT_ROW->empl_id ?>">
                    ...
                    <td class="text-center"> <?=  $DISP_SHIFT_ROW->offset_type ?></td>
                    <td class="text-center"> <?= date("d/m/Y", strtotime($DISP_SHIFT_ROW->offset_date)) ?> </td>
                    <td class="text-center"> <?= $DISP_SHIFT_ROW->duration ?></td>
                    <td class="text-center"> <?= $DISP_SHIFT_ROW->reason ?></td>
                    ...
                    <!-- <td class="text-center"> -->
                      ...
                      <td class="text-center">
                        ...
                        <?php } elseif ($DISP_SHIFT_ROW->status == "Withdrawn") { ?>
                          <div class='bg-secondary p-2 rounded disabled m-auto' style="width:100px"><?= $DISP_SHIFT_ROW->status ?></div>
...
<!-- 
                    <td>
                      <a class="select_row p-1 request_id" data-leave_id="<?= $DISP_SHIFT_ROW->id ?>" data-toggle="modal" data-target="#modal_approval" style="display: block; margin: 0 auto;">
                      <img src="<?= base_url('assets_system/icons/eye-sharp-solid_dark.svg') ?>" alt="" style="display: block; margin: 0 auto;">
                      </a>
                    </td> -->
                  </tr>
                <?php
...
<div class="modal fade class_modal_reject" id="modal_bulk_reject" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="<?php echo base_url(); ?>selfservices/offset_bulk_reject" id="form_bulk_reject" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
        <div class="modal-body">
          <div class="row">
            <div class="col-md-12">
...
<script>
  ...
  $(document).ready(function() {
    ...
    //   window.location = base_url + "selfservices/offset_list_approval" + page_row + "&status="+status+ "&company=" + company + "&branch=" + branch +
    //     "&dept=" + department + "&division=" + division +
    //     "&section=" + section + "&group=" + group +
    //     "&team=" + team + "&line=" + line;

    window.location.href = page_row + "&status="+status;
    }
