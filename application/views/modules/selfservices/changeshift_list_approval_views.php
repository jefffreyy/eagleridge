...
<div class="content-wrapper">
  <div class="container-fluid p-4">
    <div class="">
      <h1 class="page-title d-flex align-items-center"><a onclick="afterRenderFunction()" href="<?= base_url('selfservices/mychange_approval') ?>"> <img style="width: 24px; height: 24px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" />
        </a>&nbsp;Change Shift Approval List<h1>
    </div>
    <hr class="title-line">
        ...
        <table class="table table-bordered table-hover m-0" id="TableToExport" style="width:100%">
          <thead>
            <tr>
              ...
              <th class="text-left" style='width:10%'>CURRENT SHIFT</th>
              <th class="text-left" style='width:10%'>REQUEST SHIFT</th>
            ...
            <?php if ($DISP_SHIFT) {
              foreach ($DISP_SHIFT as $DISP_SHIFT_ROW) { ?>
                <tr data-leave_id="<?= $DISP_SHIFT_ROW->id ?>">
                  ...
                  <!-- <td>
                    <a href="<?= base_url('selfservices/changeshiftapproval/approve/' . $DISP_SHIFT_ROW->id) ?>" class="btn btn-success approve_req">Approve</a>
                    <a href="<?= base_url('selfservices/changeshiftapproval/reject/' . $DISP_SHIFT_ROW->id) ?>" class="btn btn-danger reject_req">Reject</a>
                  </td> -->
