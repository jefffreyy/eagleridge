...
<div class="content-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-md-8 ml-4 mt-3 ">
            ...
            <h2><a href="<?= base_url('selfservices/my_complaints') ?>"><img style="width: 32px; height: 32px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="">
</a></h2>
                    ...
                    <div class="modal-body pb-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <form action="<?=base_url('selfservices/update_complaint/'.$COMPLAINT->id)?>" method="POST">
                                    ...
                                    <select class="form-control" name="edit_user" id="input_edit_user" disabled>
                                        ...
                                        <option><?=$COMPLAINT->editor?></option>
                                    ...
                                    <select class="form-control" name="employee_id" id="input_employee_id" disabled>
                                        ...
                                        <option><?=$COMPLAINT->employee?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="file_uploader" data-type="self_services">
                                            ...
                                            <input type="hidden" name="attachment" value="<?=$COMPLAINT->attachment?>" class="selected_images d-block w-100"/>

                                        </div>

                                        <a href="<?=base_url('assets_user/files/selfservices/'.$COMPLAINT->attachment)?>"

                                            download><?=$COMPLAINT->attachment?></a>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status" enabled>
                                            ...
                                            <option value="Inactive" <?= $COMPLAINT->status=='Inactive'? 'selected' : '' ?>>Inactive</option>
