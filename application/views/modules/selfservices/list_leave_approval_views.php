...
<div class="content-wrapper">
  <div class="container-fluid p-4">
    <div class="">
      <h1 class="page-title d-flex align-items-center"><a onclick="afterRenderFunction()" href="<?= base_url('selfservices/leave_approval') ?>"> <img style="width: 24px; height: 24px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" />
        </a>&nbsp;Leave Approval List<h1>
    </div>
    <hr class="title-line">
          ...
          <table class="table table-bordered table-hover m-0" id="TableToExport" style="width:100%">
            <thead>
              <tr>
                ...
                <th class="text-left">LEAVE&nbsp;DATE</th>
            ...
            <tbody id="tbl_application_container">
              <!-- <?php var_dump($DISP_SHIFT) ?>
              <?php var_dump($C_DATA_COUNT) ?> -->
              <?php if ($DISP_SHIFT) {
                foreach ($DISP_SHIFT as $DISP_SHIFT_ROW) { ?>
                  <!-- <tr data-leave_id="<?= $DISP_SHIFT_ROW->id ?>" data-toggle="modal" data-target="#modal_approval" class="hover"> -->
                    ...
                    <td class="text-left"> <?= convert_type($DISP_TYPES, $DISP_SHIFT_ROW->type) ?></td>
                    <td class="text-left"> <?= date(($DATE_FORMAT) ? $DATE_FORMAT: "d/m/Y", strtotime($DISP_SHIFT_ROW->leave_date)) ?> </td>
...
<script>
  ...
  $(document).ready(function() {
    ...
    function filter_data(page_row) {
      ...
      // window.location = base_url + "selfservices/list_leave_approval" + page_row + filterUrl;
