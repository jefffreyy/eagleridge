  ...
  <div class="container-fluid p-4">
      <div class="row pt-1">
        ...
        <div class="col-md-6 button-title">
          <a onclick="afterRenderFunction()" href="<?= base_url('selfservices/request_time_adjustment') ?>" class=" btn btn-primary shadow-none rounded d-flex align-items-center"><img src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
            </i>&nbsp;Add Request</a>
          ...
          <div class="p-0">
            <div>
              <div class="d-none d-lg-block">
                <div class="pb-2 row d-flex align-items-center justify-content-center mx-1">
                  <div class="d-flex col-sm-9 col-md-10 col-lg-10 justify-content-lg-end justify-content-center my-lg-0 my-2">
                  ...
                  <div class="col-4 col-md-2 col-lg-2  d-flex align-items-center justify-content-end">
