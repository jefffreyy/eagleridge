        ...
        <div class="container-fluid p-4">
            ...
            <div class="row pt-1">
                ...
                <div class="col-md-6 button-title">
                    ...
                    <a onclick="afterRenderFunction()" href="<?= base_url('selfservices/request_support') ?>" class=" btn btn-primary shadow-none rounded d-flex align-items-center"><img src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
                        &nbsp;Add Request</a>
            ...
            <div class="card border-0 p-0 m-0">
                <div class="card border-0 pt-1 m-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4">
                                <div class="input-group pb-1 ">
                                    <?php
                                    if ($search_data) { ?>
                                        <button id="clear_search_btn" class="input-group-prepend btn btn-primary shadow-none d-flex align-items-center" <?php if (!$add_button[0])  echo "hidden"; ?>><img src="<?= base_url('assets_system/icons/broom-wide-sharp-solid.svg') ?>" alt="">&nbsp;Clear</button>
                                    <?php } else { ?>
                    ...
                    <div class="p-2">
                        <div class="row py-1 justify-content-between">
                            <div class="col-12 col-lg-3 d-flex justify-content-lg-start justify-content-center">
                                ...
                                ?>
                                    <button style="height: 36px; margin-left:6px;" id=<?= $C_BULK_BUTTON_ROW[1] ?> class=" btn <?= $buttonClass ?> shadow-none rounded bulk-button" data-toggle="modal" data-id=<?= $C_BULK_BUTTON_ROW[5] ?> data-target="#modal_set_ssa" <?php if (!$C_BULK_BUTTON_ROW[0])  echo "hidden"; ?> status=<?= $C_BULK_BUTTON_ROW[3] ?>><img style="height: 1rem; width: 1rem; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/' . $C_BULK_BUTTON_ROW[2])  ?>" alt="">&nbsp;<?= $C_BULK_BUTTON_ROW[3] ?></button>
                                <?php
                                } ?>

                            </div>

                            <div class="col-12 col-lg-9 d-lg-flex align-items-center justify-content-between d-none row">
                                <div class="col-12 col-lg-11 ml-auto my-2 my-lg-0 row">
                                    <div class="d-inline d-flex col-12 col-lg-4 col-xl-8 justify-content-lg-end justify-content-center align-items-center">
                                ...
                                <div class="col-sm-3 col-md-2 col-lg-1  d-flex align-items-center justify-content-center justify-content-lg-end mr-lg-0 ">
                                        ...
                                        <tr>
                                                    ...
                                                    if ($parameter == "id") {
                                                        ...
                                                        foreach ($C_DATA_EMPL_NAME as $C_DATA_EMPL_NAME_ROW) {
                                                            if ($column_data_raw == $C_DATA_EMPL_NAME_ROW->id) {
                                                                ...
                                                                if (!empty($C_DATA_EMPL_NAME_ROW->col_suffix)) {
                                            ...
                                            <td class="text-center" <?= $hide_eye ?>>
                                                <div class="action_btn">
                                                    <a class="m-2" href="<?= base_url('selfservices/show_support/' . $id_raw) ?>" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important" row_id="<?= $id_raw ?>">
                                                        <img src="<?= base_url('assets_system/icons/eye-sharp-solid_dark.svg') ?>" alt="" id="view">
                                                    </a>
                                                    <a class="m-1" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important" href="<?= base_url('selfservices/edit_support/' . $id_raw) ?>"><img src="<?= base_url('assets_system/icons/pen-to-square-solid.svg') ?>" alt="" id="edit">
                                                    </a>
                    ...
                    <div class="col-12 col-lg-8 d-lg-none d-block">
                        <div class="col-12 col-lg-7 ml-auto my-2 my-lg-0 row">
