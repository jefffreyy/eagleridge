            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="modal-body pb-5">
                        <div class="row">
                            <div class="col-md-12">
                                 <?php echo form_open('selfservices/add_new_warning'); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" required class="form-control" id="input_description" rows="4" cols="50" enabled=""></textarea>
