    ...
    <div class="container-fluid p-4">
      <div class="row pt-1">
        ...
        <div class="col-md-6 button-title">
          ...
          <a onclick="afterRenderFunction()" href="<?= base_url('selfservices/request_myoff') ?>" class=" btn btn-primary shadow-none rounded d-flex align-items-center"><img src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
            &nbsp;Add Request</a>
          ...
          <div class="table-responsive">
            ...
            <table class="table table-bordered m-0" id="table_main" style="width:100%">
              <thead>
                ...
                <th style='width:15%;'>REQUEST SHIFT</th> -->
              ...
              <tbody id="tbl_application_container">
                <?php if ($TABLE_DATA) {  ?>
                  <?php foreach ($TABLE_DATA as $row_data) {
                    $formatted_date = date(($DATE_FORMAT) ? $DATE_FORMAT : "d/m/Y", strtotime($row_data->date_shift)); ?>
                    <tr>
                      ...
                      <td><?= $row_data->request_shift ?></td>
                        ...
                        <td> <?= ($row_data->date_shift_to) ? date(($DATE_FORMAT) ? $DATE_FORMAT : "d/m/Y", strtotime($row_data->date_shift_to)) : ""; ?> </td>
                      ...
                      ?>
                      <a href="<?= base_url('selfservices/changeoff_withdraw/' . $row_data->id) ?>" class="btn btn-default withdraw_req <?=$disabled?>"  >Withdraw</a>
                      </td>
  ...
  <script>
    $(document).ready(function() {
      ...
      function reloadPage() {
        ...
        var page = "<?= $PAGE ?>";
        window.location.href = "<?= base_url('selfservices/mychange_shift') ?>" + "?status=" + status + "&page=" + page + "&row=" + row;
      }
    })
  </script>
