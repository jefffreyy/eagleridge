    ...
    <div class="filter-container  <?= $filter ? 'visible' : '' ?>">
      <div class=" row mb-4 d-flex">
        ...
        <!-- <div class="col-md-2">
          ...
          <a href=<?= base_url() . "selfservices/holidaywork_approval" ?> id="btn_clear_filter" class="col btn btn-secondary mx-1">Clear Filter</a>
        </div> -->
      </div>
    ...
    <div class="card border-0 p-0 m-0">
      ...
      <div class="card border-0 p-0 m-0">
              ...
              <!-- <div class=' align-items-center mt-2'>
                <div class='row d-flex align-items-center'>
                  ...
                  <div class="d-flex col-sm-12 col-lg-4 justify-content-center justify-content-lg-start">
                    ...
                    <a href="<?= base_url('selfservices/holidaywork_approval') ?>" id="btn_clear_filter" class="mt-1 btn btn-primary mx-1"><img src="<?= base_url('assets_system/icons/clear_filter.svg') ?>" alt="">&nbsp;Clear</a> -->
                  </div>
                </div>
              </div>

              <div class='row mt-3 py-1 align-items-center'>
                <div class='col-12 col-md-4 d-flex justify-content-lg-start justify-content-center'>
                ...
                <div class="col-12 col-md-7 d-lg-flex d-none justify-content-lg-end">
                  <div class='col-12 col-lg-6 ml-auto my-2 my-lg-0 row'>
                    ...
                    <div class="d-lg-inline col-12 col-md-4 d-flex justify-content-lg-end justify-content-center ">
                ...
                <div class="col-3 col-md-1 col-lg-1  d-flex align-items-center justify-content-center justify-content-lg-start mr-lg-0 mr-2">
          ...
          <table class="table table-bordered table-hover m-0" id="TableToExport" style="width:100%">
            <thead>
              <tr>
                ...
                <th class="text-left">HOLIDAY WORK ID</th>
            ...
            <tbody id="tbl_application_container">
              <?php if ($DISP_HOLIDAYWORK) {
                foreach ($DISP_HOLIDAYWORK as $DISP_HOLIDAYWORK_ROW) { ?>
                  <tr data-id="<?= $DISP_HOLIDAYWORK_ROW->id ?>" data-toggle="modal" data-target="#modal_approval" class="hover">
                    <!-- <td class="text-center select-item-td" id="select_item">
                      <input type="checkbox" name="approval_name" class="check_single" approval_id="<?= convert_cmid($DISP_EMPLOYEES, $DISP_HOLIDAYWORK_ROW->empl_id) ?>" employee_id="<?= $DISP_HOLIDAYWORK_ROW->empl_id ?>" row_id="<?= $DISP_HOLIDAYWORK_ROW->id ?>" value="<?= $DISP_HOLIDAYWORK_ROW->empl_id ?>" checkbox_stat="">
                    </td> -->
                    <td class="text-left"><?= 'HDW' . str_pad($DISP_HOLIDAYWORK_ROW->id, 5, '0', STR_PAD_LEFT); ?></td>
                    <td class="text-left hover td-directs  text-primary" data-empl_id="<?= $DISP_HOLIDAYWORK_ROW->empl_id ?>">
                      <?= convert_cmid($DISP_EMPLOYEES, $DISP_HOLIDAYWORK_ROW->empl_id) ?> - <?= convert_data($DISP_EMPLOYEES, $DISP_HOLIDAYWORK_ROW->empl_id) ?>
                    </td>
                    <td class="text-left"> <?= $DISP_HOLIDAYWORK_ROW->type ?></td>
                    <td><?= date(($DATE_FORMAT) ? $DATE_FORMAT : "d/m/Y", strtotime($DISP_HOLIDAYWORK_ROW->date)) ?></td>
                    <td class="text-left"> <?= $DISP_HOLIDAYWORK_ROW->hours ?></td>
                    <td class="text-left"> <?= $DISP_HOLIDAYWORK_ROW->reason ?></td>
                    <td class="text-center">
                      <!-- <span class="btn btn-warning disabled">
                        <?= $DISP_HOLIDAYWORK_ROW->status ?>
                      </span> -->
                      
                      <span class="btn btn-warning disabled">
                <?php
                        preg_match('/pending/i', $DISP_HOLIDAYWORK_ROW->status, $matches);
                        if (!empty($matches)) {
                          echo 'Pending';
                        } else {
                          echo $DISP_HOLIDAYWORK_ROW->status;
                        }
                ?>
                </span>
                    ...
                    <td style="width:15%" class="text-center">
                      ...
                      <a class="select_row p-1 request_id" data-id="<?= $DISP_HOLIDAYWORK_ROW->id ?>" data-toggle="modal" data-target="#modal_approval">
        ...
        <div class="col-12 col-lg-7 d-lg-none d-block justify-content-lg-end">
          ...
          <div class="col-sm-3 col-md-2 col-lg-2  d-flex align-items-center justify-content-center justify-content-lg-start mr-lg-0 mr-2r">
            <p class="p-0 m-0 d-inline" style="color: gray">&nbsp;&nbsp;Rows:&nbsp;</p>
          ...
          <div id="modalContentEmployee" class="p-0">
            <div class="d-flex justify-content-between align-items-start">
              <div class="d-flex  align-items-center">
                ...
                <!-- <img style="height: 100px; width: 100px;" class="img-circle rounded-circle avatar m-3  elevation-2" onerror="setDefaultImage(this)" id="employee_img" style="cursor: pointer;" data-toggle="tooltip" data-placement="right" title="Profile Image" src="<?= base_url() ?>/assets_system/images/default_user.jpg"> -->
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header" style="border-bottom: none;">
        <h4 class="modal-title ml-1" id="exampleModalLabel">Holiday Work Bulk Approve
        </h4>
      ...
      <form action="<?php echo base_url(); ?>selfservices/holidaywork_bulk_approve" id="form_bulk_approve" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
...
<div class="modal fade class_modal_reject" id="modal_bulk_reject" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header" style="border-bottom: none;">
        <h4 class="modal-title ml-1" id="exampleModalLabel">Holiday Work Bulk Reject
        </h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;
          </span>
      ...
      <form action="<?php echo base_url(); ?>selfservices/holidaywork_bulk_reject" id="form_bulk_reject" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
        <div class="modal-body">
          <div class="row">
            <div class="col-md-12">
...
<script>
  $(document).ready(function() {
    ...
    function filter_data(page_row) {
      ...
      window.location = base_url + "selfservices/holidaywork_approval" + filterUrl;
    }
    ...
    $('#bulk_approved').click(function() {
      ...
      if (selected_id.length > 0) {
        ...
        selected_row_id.forEach(function(data) {
          $('#approve_list_id').append(`<li class="col-md-6">ID : <strong>HWA${("00000" + data).slice(-5)}</strong></li>`);
        })
      } else {
    ...
    $('#bulk_reject').click(function() {
      ...
      if (selected_id.length > 0) {
        ...
        selected_row_id.forEach(function(data) {
          $('#reject_list_id').append(`<li class="col-md-6">ID : <strong>HWA${("00000" + data).slice(-5)}</strong></li>`);
        })
      } else {
    ...
    $('.request_id').on('click', function() {
      ...
      fetch(url)
        ...
        .then((data) => {
          ...
          let holiday_work_id = "HWA" + ("00000" + data[0]['id']).slice(-5);
          $('#holiday_work_id').val(holiday_work_id);
          $('#request_by').val(data['name']);
          $('#overtime_type').val(data[0]['type']);

          $('#date').val(data[0]['date']);
          $('#hours').val(data[0]['hours']);
          $('#status').val(data[0]['status']);
          $('#remarks').val(data[0]['comment']);
