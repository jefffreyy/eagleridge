                            ...
                            <tbody id=" tbl_application_container">
                                ...
                                ?>
                                        <tr style="cursor: pointer;">
                                            ...
                                            <td class="text-center">
                                                <?= $DISP_ASSETS_INFO_ROW->assign_by_cmid . ' - ' . $DISP_ASSETS_INFO_ROW->assign_by_fname . ' ' . $DISP_ASSETS_INFO_ROW->assign_by_lname  ?>
                                            </td>
                                            <td class="text-center">

                                                <div class="btn-action">

                                                    <a href="<?= base_url('selfservices/show_asset/' . $DISP_ASSETS_INFO_ROW->id) ?>" type="submit" class="select_edit_row m-1 " style="background-color: transparent; border: none;color: gray; cursor: pointer; !important" row_id="9"><img src="<?= base_url('assets_system/icons/eye-sharp-solid_dark.svg') ?>" alt="">
                                                    </a>
