            ...
            <div class=''>
              <div class=' align-items-center mt-2'>
                ...
                <div class='col-12 col-xl-4 d-flex justify-content-lg-start justify-content-center'>
                  ...
                  <div class="col-12 col-xl-12 d-lg-flex d-none justify-content-between mb-2">
                    <a onclick="afterRenderFunction()" href="<?= base_url('selfservices/list_leave_approval') ?>" class="btn btn-primary shadow-none rounded">
                      &nbsp;Approval List
                    </a>
