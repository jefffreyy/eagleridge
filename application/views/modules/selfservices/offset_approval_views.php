            ...
            <div class='justify-content-between'>
              ...
              <div class='row mt-3'>
                <div class='col-md-6'>
                 ...
                 -->
                  <a onclick="afterRenderFunction()" href="<?= base_url('selfservices/offset_list_approval') ?>" class="btn btn-primary shadow-none rounded">
                    &nbsp;Approval List
                  </a>
                </div>
...
<script>
  ...
  $(document).ready(function() {
    ...
    function filter_data(page_row) {
      ...
      // window.location = base_url + "selfservices/offset_approval" + page_row + "&company=" + company + "&branch=" + branch +
      //   "&dept=" + department + "&division=" + division +
      //   "&section=" + section + "&group=" + group +
      //   "&team=" + team + "&line=" + line;

        window.location.href =  page_row;
    }
