                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <form action="<?=base_url('selfservices/update_task/'.$TASK->id)?>" method="post">
                                    ...
                                    <select class="form-control" name="input_edit_user" id="edit_user" disabled>
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <input type="text" class="form-control" name="task_title"
                                            ...
                                            id="task_title" enabled value=" <?=$TASK->task_title?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="task_description" class="form-control" id="task_description"
                                            ...
                                            rows="4" cols="50" enabled> <?=$TASK->task_description?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="task_date_from"
                                            ...
                                            id="task_date_from" enabled value=<?=$TASK->task_date_from ?> >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="task_date_to"
                                            ...
                                            id="task_date_to" enabled value=<?=$TASK->task_date_to?> >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="file_uploader" data-type="self_services">
                                            ...
                                            <input type="hidden" name="attachment" value="<?=$TASK->attachment?>" class="selected_images d-block w-100"/>

                                        </div>

                                        <a href="<?=base_url('assets_user/files/selfservices/'.$TASK->attachment)?>"

                                            download><?=$TASK->attachment?></a>
