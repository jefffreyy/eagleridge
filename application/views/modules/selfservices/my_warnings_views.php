...
<body>
    <div class="content-wrapper">
        <div class="container-fluid p-4">
            ...
            <div class="row pt-1">
                <div class="col-md-6">
                    <h1 class="page-title d-flex align-items-center"><a onclick="afterRenderFunction()" href="<?= $module[0] ?>"> <img style="width: 24px; height: 24px; margin: 0 5px 2px; 0" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" />
                        </a>&nbsp;<?= $module[2] ?><h1>
                </div>
                <?php
                ...
                <div class="col-md-6 button-title">
                    <a onclick="afterRenderFunction()" href="<?= base_url('selfservices/add_warning') ?>" class=" btn btn-primary shadow-none rounded  d-flex align-items-center"><img src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
                        &nbsp;Add Warnings</a>
                        ...
                        <div class="row py-1 justify-content-between">
                            <div class="col-12 col-lg-3 d-flex justify-content-lg-start justify-content-center">
                                ...
                                foreach ($C_BULK_BUTTON as $C_BULK_BUTTON_ROW) { ?>
                                    <button style="height: 36px; margin-left: 6px;" id=<?= $C_BULK_BUTTON_ROW[1] ?> class="<?= $C_BULK_BUTTON_ROW[6] ?>" data-toggle="modal" data-id=<?= $C_BULK_BUTTON_ROW[5] ?> data-target="#modal_set_ssa" <?php if (!$C_BULK_BUTTON_ROW[0])  echo "hidden"; ?> status=<?= $C_BULK_BUTTON_ROW[3] ?>><img style="height: 1rem; width: 1rem; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/' . $C_BULK_BUTTON_ROW[2])  ?>" alt="">&nbsp;<?= $C_BULK_BUTTON_ROW[3] ?></button>
                                <?php
                                } ?>
                            </div>
                                        ...
                                        <tr>
                                                        ...
                                                        foreach ($C_DATA_EMPL_NAME as $C_DATA_EMPL_NAME_ROW) {
                                                            if ($column_data_raw == $C_DATA_EMPL_NAME_ROW->id) {
                                                                ...
                                                                if ($C_DATA_EMPL_NAME_ROW->col_midl_name) {
                                                                    $column_data = $column_data . ' ' . $C_DATA_EMPL_NAME_ROW->col_midl_name[0] . '.';
                                                                }
                                                            }
                                                        }
                                            ...
                                            <td class="text-center">
                                                <div class="action_btn">
                                                    <a class='m-1' onclick="afterRenderFunction()" href="<?= base_url('selfservices/show_warning/' . $id_raw) ?>" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important">
                                                    ...
                                                    <a class="m-1" onclick="afterRenderFunction()" href="<?= base_url('selfservices/edit_warning/' . $id_raw) ?>" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important"><img src="<?= base_url('assets_system/icons/pen-to-square-solid.svg') ?>" alt="" id="edit">
                                                    </a>
                                                </div>
                                            </td>
                                        </tr>
