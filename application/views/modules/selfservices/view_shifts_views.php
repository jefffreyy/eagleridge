...
<body>
  <div class="content-wrapper">
    <div class="row">
        <div class="col-md-8 ml-4 mt-3">
            <h2><a href="<?= base_url('selfservices/shift_request_approval')?>?page=<?= $page ?>&row=<?= $row ?>"> <img style="width: 24px; height: 24px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" /></a></h2>
        </div>
    </div>
  ...
  <script>
    $(document).ready(function() {
        ...
        // afterRenderFunction();
        window.location.href = "<?= base_url('selfservices/view_shifts?period=') ?>" + $(this).val();
        });
    });
