...
<style>
  ...
  @media (min-width: 1920px){
    .col-xl-3-custom {
    flex-basis: calc(25% - 12px); /* 25% width with 12px margin right */
...
<body>
    ...
    <div class="container-fluid p-4">
      <div class="row pt-1">
        ...
        <div class="col-md-6 button-title">
          ...
          <a onclick="afterRenderFunction()" href="<?= base_url('selfservices/request_leave') ?>" class=" btn btn-primary shadow-none rounded d-flex align-items-center"><img src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
            &nbsp;Add Request</a>
      ...
      <div class="row d-flex">
        <div class="col-6 col-lg-4 col-xl-3 py-3 w-25">
      ...
      <div class="card border-0 p-0 m-0">
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <div class="row d-flex  align-items-center" style="padding: 10px">
                  <div class="col-12 col-lg-7 col-xl-7 d-flex row">
                    <?php if ($LEAVE_SETTINGS['sil_enable'] == 1) : ?>
                      <div class="col-6 col-xl-4 col-xl-3-custom d-flex ">
                        ...
                        <div class="ml-2">
                          <div class="text-nowrap" style="font-size:14px;font-weight:500;color:#2b2a32eb"><?= $REMAINING_SIL_HOURS ?> Hours</div>
                    ...
                    <?php if ($LEAVE_SETTINGS['vacation_enable'] == 1) : ?>
                      <div class="col-6 col-xl-4 col-xl-3-custom d-flex">
                        ...
                        <div class="ml-2">
                          <div class="text-nowrap" style="font-size:14px;font-weight:500;color:#2b2a32eb"><?= $REMAINING_VACATION_HOURS ?> Hours</div>
                          <div style="font-size:13px;font-weight:500;color:#292b4199">Available</div>
                        </div>
                      </div>
                    <?php else : ?>
                    ...
                    <?php if ($LEAVE_SETTINGS['sick_enable'] == 1) : ?>
                      <div class="col-6 col-xl-4 col-xl-3-custom d-flex">
                        ...
                        <div class="ml-2">
                          <div class="text-nowrap" style="font-size:14px;font-weight:500;color:#2b2a32eb"><?= $REMAINING_SICK_HOURS ?> Hours</div>
                          <div style="font-size:13px;font-weight:500;color:#292b4199">Available</div>
                        </div>
                      </div>
                    ...
                    <?php if ($LEAVE_SETTINGS['offset_enable'] == 1) : ?>
                      <div class="col-6 col-xl-4 col-xl-3-custom d-flex">
                        ...
                        <div class="ml-0 mt-2 d-flex align-items-start">
                          <div style="font-size:14px;font-weight:500;color:#2b2a32eb">Offset</div>
                          <div style="font-size:13px;font-weight:500;color:#292b4199"></div>
                        </div>

                        <div class="ml-2">
                          <div class="text-nowrap" style="font-size:14px;font-weight:500;color:#2b2a32eb"><?= $REMAINING_OFFSET_HOURS ?> Hours</div>
                          <div style="font-size:13px;font-weight:500;color:#292b4199">Available</div>
                        </div>
                      </div>
                    <?php else : ?>
                  ...
                  <div class="col-12 col-lg-4 col-xl-5 d-lg-flex d-none justify-content-center justify-content-xl-start  align-items-center my-lg-0 my-2" style="width:max-content">
                    <div class=" d-flex  justify-content-center  align-items-center row my-1 col-9">
                      <div class="col-12 col-lg-4 d-flex justify-content-start justify-content-xl-start">
                        <p class="p-0 m-0 text-end" style="color: gray">Showing <?= $low_limit ?> to <?= $high_limit ?> of <?= $C_DATA_COUNT ?> entries&nbsp;</p>
                      </div>
                      <div class="d-flex col-12 col-lg-3  ">
                        <ul class="pagination m-0 p-0 text-end">
                    ...
                    <div class=" col-sm-12 col-lg-1 d-none d-lg-flex align-items-center justify-content-lg-between  justify-content-center my-lg-0 my-3 col-6">
                      <p class="p-0 m-0 d-inline" style="color: gray">&nbsp;&nbsp;Rows:&nbsp;</p>
                      <select id="row_dropdown" class="custom-select mx-3" style="width: auto;">
                        <?php
              ...
              <?php if ($TABLE_DATA) {  ?>
                <?php foreach ($TABLE_DATA as $row_data) { ?>
                  <tr data-id="<?= $row_data->id ?>" data-toggle="modal" data-target="#modal_approval">
                    ...
                    <td class="text-left"> <?= date(($DATE_FORMAT) ? $DATE_FORMAT: "d/m/Y", strtotime($row_data->leave_date)) ?></td>
                    <!-- <td><?= date_format(date_create($row_data->leave_date), '$DATE_FORMAT') ?></td> -->
                    <td><?= $row_data->type ?></td>
                    ...
                    <td class="text-center">
                      ...
                      <?php } elseif ($row_data->status == "Withdrawed" || $row_data->status == "Withdrawn") { ?>
                        <div class='bg-secondary p-2 rounded disabled m-auto' style="width:100px">Withdrawn</div>
                      <?php } elseif ($row_data->status == "Nurse") { ?>
        ...
        <div class="d-lg-none d-block  justify-content-center">
          <div class="row col-sm-12 col-lg-4 justify-content-center align-items-center my-lg-0 my-2" style="width:max-content">
            <div class=" d-flex justify-content-lg-end justify-content-sm-center  align-items-center row ">
            ...
            <div class=" col-sm-12 col-lg-1 d-flex align-items-center justify-content-lg-end  justify-content-center my-lg-0 my-2">
              <p class="p-0 m-0 d-inline" style="color: gray">&nbsp;&nbsp;Rows:&nbsp;</p>
              <select id="row_dropdown" class="custom-select mx-3" style="width: auto;">
                <?php
                foreach ($C_ROW_DISPLAY as $C_ROW_DISPLAY_ROW) { ?>
  ...
  <script>
    $(document).ready(function() {
      ...
      function reloadPage() {
        ...
        var page = "<?= $PAGE ?>";
        window.location.href = "<?= base_url('selfservices/my_leaves') ?>" + "?status=" + status + "&page=" + page + "&row=" + row;
      }
  ...
  <script>
    document.getElementById("btn_export").addEventListener('click', function() {
      ...
      XLSX.writeFile(wb, "<?php echo 'my_leaves.xlsx' ?>");
    });
  </script>
