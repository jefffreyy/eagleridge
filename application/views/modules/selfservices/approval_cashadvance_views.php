...
<div class="content-wrapper" style="min-height: 624px;">
    <div class='row'>
        <div class='col-md-8 ml-4 mt-3'>
            <h2><a href="<?= base_url() . 'selfservices/my_cashadvance'; ?>"><img style="width: 32px; height: 32px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt=""></a></h2>
        </div>
    </div>
    ...
    <div class="modal-dialog approval">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Cash Advances Request (<?= 'CA' . str_pad($data[0]->id, 5, '0', STR_PAD_LEFT) ?>)</h5>
            </div>
            <div class="modal-body">
                <form action="<?= base_url()?>selfservices/cashadvance_approval_action" id="approval_form" method="post">
                    <div class="row">
                        <div class="col-6">
                            <p class="mb-1">Date: <span><?= date("$DATE_FORMAT", strtotime($data[0]->create_date)) ?></span></p>
                        </div>
                        <div class="col-6">
                ...
                <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <div>
                            <!-- <span><?= date_format(date_create($data[0]->create_date), 'd/m/Y H:i:s A') ?></span> -->
                        </div>
                    </div>
