...
<div class="content-wrapper">
  <div class="container-fluid p-4">
    <div class="">
      <h1 class="page-title d-flex align-items-center"><a onclick="afterRenderFunction()" href="<?= base_url('selfservices/exemptut_approval') ?>"> <img style="width: 24px; height: 24px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" />
        </a>&nbsp;Exempt Undertime Approval List<h1>
    </div>
    <hr class="title-line">
          ...
          <table class="table table-bordered table-hover m-0" id="TableToExport" style="width:100%">
            <thead>
              <tr>
                ...
                <th class="text-left">SHIFT OUT</th>
                <th class="text-left">ACTUAL OUT</th>
              ...
              <?php if ($DISP_SHIFT) {
                foreach ($DISP_SHIFT as $DISP_SHIFT_ROW) { ?>
                  <tr data-leave_id="<?= $DISP_SHIFT_ROW->id ?>">
                    ...
                    <td class="text-left">EUT<?= str_pad($DISP_SHIFT_ROW->id, 5, '0', STR_PAD_LEFT) ?></td>
                    ...
                    <td class="text-left"> <?= date(($DATE_FORMAT) ? $DATE_FORMAT: "d/m/Y", strtotime($DISP_SHIFT_ROW->date_undertime)) ?> </td>
                    <td class="text-center"> <?= $DISP_SHIFT_ROW->shift_out ?></td>
                    <td class="text-center"><?= $DISP_SHIFT_ROW->actual_out ?></td>
                    ...
                    <td class="text-center">
                      ...
                      <?php } elseif ($DISP_SHIFT_ROW->status == "Nurse") { ?>
                        <div class='bg-warning p-2 rounded disabled m-auto' style="width:100px"><?= $DISP_SHIFT_ROW->status ?></div>
                      <?php } else { ?>
                    ...
                    <!-- <td>
                    <a href="<?= base_url('selfservices/exemptutapproval/approve/'.$DISP_SHIFT_ROW->id) ?>" class="btn btn-success">Approve</a>
                    <a href="<?= base_url('selfservices/exemptutapproval/reject/'.$DISP_SHIFT_ROW->id) ?>" class="btn btn-danger">Reject</a>
                    </td> -->
...
<script>
  ...
  $(document).ready(function() {
    ...
    function filter_data(page_row) {
      ...
      // window.location = base_url + "selfservices/exemptut_list_approval" + page_row + filterUrl;
