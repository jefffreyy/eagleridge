            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="modal-body pb-5">
                        <div class="row">
                            <div class="col-md-12">
                                <?php echo form_open('selfservices/add_new_task'); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" name="task_title" id="input_task_title" enabled="" value="">
                                </div>

                                <div class="form-group">
                                    <label class="required" for="input_task_description">Description</label>
                                    <textarea required name="task_description" class="form-control" id="task_description" rows="4" cols="50" enabled=""></textarea>
                                </div>

                                <div class="form-group">
                                    <label class="required" for="input_task_date_from">Date From</label>
                                    <input type="date" required class="form-control" name="task_date_from" id="input_task_date_from" enabled="" value="">
                                </div>
