...
<body>
    <div class="content-wrapper">
        <div class="container-fluid p-4">
            ...
            <div class="row pt-1">
                <div class="col-md-6">
                    <h1 class="page-title d-flex align-items-center">
                        <a onclick="afterRenderFunction()" href="<?= $module[0] ?>">
                ...
                <div class="col-md-6 button-title">
                    ...
                    <a onclick="afterRenderFunction()" href="<?= base_url('selfservices/request_task') ?>" class=" btn btn-primary shadow-none rounded d-flex align-items-center" ">
                        <img src=" <?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
                        &nbsp;Add Task
                    </a>
                    <!-- <a href="<?php echo base_url('main_table_02/csv_import?' . $url_csv_encrypted); ?>" id="bulk_import" class=" btn technos-button-green shadow-none rounded d-flex align-items-center" <?php if (!$excel_import[0])  echo "hidden"; ?>><img src="<?= base_url('assets_system/icons/file-import-solid.svg') ?>" alt="">&nbsp;Bulk Import</a> -->
                    <a id="btn_export" class=" btn btn-primary text-light shadow-none rounded d-flex align-items-center" <?php if (!$excel_output[0])  echo "hidden"; ?>><img src="<?= base_url('assets_system/icons/file-export-solid.svg') ?>" alt="">&nbsp;Export XLSX</a>
                </div>
            </div>
            ...
            ?>
            <div class="card border-0 p-0 m-0" style="min-height: 760px;">
                                ...
                                <div class="input-group pb-1 ">
                                    ...
                                    if ($search_data) { ?>
                                        <button id="clear_search_btn" class="input-group-prepend btn btn-primary  shadow-none d-flex align-items-center" <?php if (!$add_button[0])  echo "hidden"; ?>><img src="<?= base_url('assets_system/icons/broom-wide-sharp-solid.svg') ?>" alt="">
                                            &nbsp;Clear</button>
                                    <?php } else { ?>
                                        <button id="search_btn" class="input-group-prepend btn  btn-primary shadow-none d-flex align-items-center" <?php if (!$add_button[0])  echo "hidden"; ?>><img src="<?= base_url('assets_system/icons/magnifying-glass-solid.svg') ?>" alt="">&nbsp;Search</button>
                                    <?php } ?>
                    ...
                    <div class="p-2">
                        <div class="row py-1  align-items-center">
                            ...
                            <div class="col-12 col-xl-4 d-flex justify-content-lg-start justify-content-center">
                                ...
                                ?>
                                    <button style="height: 36px; margin-left: 6px;" id=<?= $C_BULK_BUTTON_ROW[1] ?> class="btn <?= $buttonClass ?> shadow-none rounded bulk-button" data-toggle="modal" data-id=<?= $C_BULK_BUTTON_ROW[5] ?> data-target="#modal_set_ssa" <?php if (!$C_BULK_BUTTON_ROW[0])  echo "hidden"; ?> status=<?= $C_BULK_BUTTON_ROW[3] ?>><img style="height: 1rem; width: 1rem; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/' . $C_BULK_BUTTON_ROW[2])  ?>" alt="">
                                        &nbsp;<?= $C_BULK_BUTTON_ROW[3] ?></button>
                                <?php
                                } ?>
                            ...
                            <div class="col-12 col-xl-8 d-lg-flex d-none justify-content-around row">
                                <div class="col-12 col-xl-8 d-flex justify-content-end my-2 my-lg-0 row">
                                    <div class="row d-flex align-items-center justify-content-end">
                                        <div class="d-inline d-flex col-12 col-xl-6 justify-content-lg-end justify-content-center align-items-center">
                                ...
                                <div class="col-sm-3 col-md-2 col-xl-2 d-flex align-items-center justify-content-end mr-lg-0 mr-2">
                                        ...
                                        <tr>
                                                ...
                                                if ($table_display == true) {
                                                    ...
                                                    if ($parameter == "id") {
                                                        ...
                                                        if ($column_data_raw != "0000-00-00") {
                                                            $column_data = date(($DATE_FORMAT) ? $DATE_FORMAT: "d/m/Y", strtotime($column_data_raw));
                                                        } else {
                                            ...
                                            <td class="text-center" <?= $hide_eye ?>>
                                                <div class="action_btn">
                                                    <!-- <form action="<?= base_url('selfservices/view_task/'); ?>" method="post">
                                                        <input type="text" name="show_encrypted_data" value="<?= $url_edit_encrypted ?>" hidden>
                                                        <button type="submit" class="select_edit_row" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important" row_id="<?= $id_raw ?>">
                                                    ...
                                                    ?>
                                                    <a class="mr-2" onclick="afterRenderFunction()" href='<?= base_url('selfservices/view_task/' . $id_raw) ?>' class="select_edit_row" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important">
                                                        <img src="<?= base_url('assets_system/icons/eye-sharp-solid_dark.svg') ?>" alt="" id="edit">
                                                    </a>
                                                    <a onclick="afterRenderFunction()" href='<?= base_url('selfservices/edit_task/' . $id_raw) ?>' class="select_edit_row" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important">
            ...
            <div class="col-12 col-lg-8 d-lg-none d-block justify-content-lg-end">
                <div class="col-12 col-lg-5 ml-auto my-2 my-lg-0 row">
