...
<body>
      ...
      <div class="row pt-1">
        <div class="col-md-6">
          <h1 class="page-title d-flex align-items-center"><a onclick="afterRenderFunction()" href="<?= base_url('selfservices') ?>"> <img style="width: 24px; height: 24px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" />
            ...
            </a>&nbsp;My Cash Advances<h1>
        </div>

        <div class="col-md-6 button-title">

          <a onclick="afterRenderFunction()" href="<?= base_url('selfservices/add_cashadvance') ?>" class=" btn btn-primary shadow-none rounded d-flex align-items-center"><img src="<?= base_url('assets_system/icons/plus-solid.svg') ?>" alt="">
            &nbsp;Add Request</a>
            ...
            <div>
              <div class="">
                <div class="pb-2 row d-flex align-items-center justify-content-center">
                  <div class="d-flex col-8 col-md-10 col-lg-11 justify-content-lg-end justify-content-center my-lg-0 my-2">
                  ...
                  <?php foreach ($TABLE_DATA as $tableDatarow) { ?>
                    <tr>
                      ...
                      <td class="d-flex justify-content-center">
                        <a class="btn btn-sm btn_edit indigo lighten-2 ml-2" href="<?= base_url() . 'selfservices/approval_cashadvance/' . $tableDatarow->id ?>">
  ...
  <script>
    ...
    function reloadPage() {
      ...
      var page = "<?= $PAGE ?>";
      window.location.href = "<?= base_url('selfservices/my_cashadvance') ?>" + "?status=" + status + "&page=" + page + "&row=" + row;
    }
  </script>
  ...
  <script>
    document.getElementById("btn_export").addEventListener('click', function() {
      ...
      XLSX.writeFile(wb, "<?php echo 'my_cashadvance.xlsx' ?>");
    });
  </script>
</body>
