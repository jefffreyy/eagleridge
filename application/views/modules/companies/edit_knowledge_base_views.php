                    ...
                    <div class="modal-body pb-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <?php echo form_open('companies/update_knowledge_base/'.$KNOWLEDGE_BASE->id); ?>
                                <div class="form-group">

                                    <label>ID</label>

                                    <input type="text" disabled class="form-control" id="input_title" enabled="" value="<?='KNB' . str_pad($KNOWLEDGE_BASE->id, 5, '0', STR_PAD_LEFT)?>">
...
<?php foreach($EMPLOYEES as $employee) : ?>
                                    <option value="<?=$employee->id?>" <?=$KNOWLEDGE_BASE->employee_id==$employee->id? 'selected' :  '' ?>><?=$employee->fullname?></option>
<?php endforeach ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" name="title" id="input_title" enabled="" value="<?=$KNOWLEDGE_BASE->title?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea required name="description" class="form-control" id="input_description" rows="4" cols="50" enabled=""><?=$KNOWLEDGE_BASE->description?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="file_uploader" data-type="hressentials">
                                        <input type="hidden" name="attachment" disabled class="selected_images d-block w-100" value="<?=$KNOWLEDGE_BASE->attachment?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label  for="input_feedback">Feedback</label>
                                    <textarea name="feedback" class="form-control" id="input_feedback" rows="4" cols="50" enabled=""><?=$KNOWLEDGE_BASE->feedback?></textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status" id="input_status" enabled="">
                                        ...
                                        <option <?=$KNOWLEDGE_BASE->status=='Inactive'? 'selected' : '' ?>>Inactive</option>
