...
<div class="content-wrapper" style="min-height: 624px;">
    ...
    <div class='row'>
        ...
        <div class='col-md-8 ml-4 mt-3'>
            ...
            <h2><a href="<?= base_url() . 'companies/knowledges_bases'; ?>"> <img style="width: 28px; height: 28px; margin-bottom: 3px;" src="<?= base_url('assets_system/icons/circle-left-duotone.svg') ?>" alt="" /></a></h2>
                    ...
                    <div class="modal-body pb-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <?php echo form_open('companies/add_new_knowledge_base'); ?>
