    ...
    <div class="flex-fill">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Holiday
          </li>
        </ol>
      </nav>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header pb-0" style="border-bottom: none;">
        <h4 class="modal-title ml-1" id="exampleModalLabel">Add Holiday
        </h4>
      ...
      <form action="<?php echo base_url('settings/insrt_holiday'); ?>" id="HOLIDAY_FORM_ADD" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
        <div class="modal-body">
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label class="required " for="HOLIDAY_INPF_NAME">Name
                </label>
                <input class="form-control form-control " type="text" name="HOLIDAY_INPF_NAME" id="HOLIDAY_INPF_NAME" required>
              </div>
              <div class="form-group">
                <label class="required " for="HOLIDAY_INPF_DATE">Date
                </label>
...
<div class="modal fade" id="modal_edit_holiday" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header pb-0" style="border-bottom: none;">
        <h4 class="modal-title ml-1" id="exampleModalLabel">Edit Holiday
        </h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;
          </span>
      ...
      <form action="<?php echo base_url('settings/updt_holiday'); ?>" id="HOLIDAY_FORM_EDIT" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
        <div class="modal-body">
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label class="required " for="UPDT_HOLIDAY_INPF_NAME">Name
                </label>
                <input class="form-control form-control " type="text" name="UPDT_HOLIDAY_INPF_NAME" id="UPDT_HOLIDAY_INPF_NAME" required>
              </div>
              <div class="form-group">
                <label class="required " for="UPDT_HOLIDAY_INPF_DATE">Date
                </label>
                <input class="form-control form-control " type="date" name="UPDT_HOLIDAY_INPF_DATE" id="UPDT_HOLIDAY_INPF_DATE" required>
              </div>
              <div class="form-group">
                <label class="required " for="UPDT_HOLIDAY_INPF_TYPE">Type
                </label>
  ...
  $(document).ready(function(){
    ...
    $('.HOLIDAY_BTN_DLT').click(function(e){
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          window.location.href = "<?= base_url(); ?>settings/dlt_holiday?delete_id="+user_deleteKey;
        }
      })
    })
  })
