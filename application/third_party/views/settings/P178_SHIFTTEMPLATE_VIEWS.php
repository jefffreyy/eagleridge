    ...
    <div class="flex-fill">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Shift Template
          </li>
        </ol>
      </nav>
      <div class="row pr-3 mb-2">
        <div class="col">
          <h1 class="page-title">Shift Template
          </h1>
        </div>
      </div>
      <div class="row mb-2">
...
foreach($DISP_SHIFTTEMPLATE_INFO as $ROW_SHIFTTEMPLATE_INFO){ ?>
            <tr>
              ...
              <td>
                <?php 
                    $monday = $this->p171_workshifts_mod->MOD_GET_WRK_SHFT_DATA($ROW_SHIFTTEMPLATE_INFO->monday);
                    echo $monday[0]->name;
                ?>
              </td>
              <td>
                <?php 
                    $tuesday = $this->p171_workshifts_mod->MOD_GET_WRK_SHFT_DATA($ROW_SHIFTTEMPLATE_INFO->tuesday);
                    echo $tuesday[0]->name;
                ?>
              </td>
              <td>
                <?php 
                    $wednesday = $this->p171_workshifts_mod->MOD_GET_WRK_SHFT_DATA($ROW_SHIFTTEMPLATE_INFO->wednesday);
                    echo $wednesday[0]->name;
                ?>
              </td>
              <td>
                <?php 
                    $thursday = $this->p171_workshifts_mod->MOD_GET_WRK_SHFT_DATA($ROW_SHIFTTEMPLATE_INFO->thursday);
                    echo $thursday[0]->name;
                ?>
              </td>
              <td>
                <?php 
                    $friday = $this->p171_workshifts_mod->MOD_GET_WRK_SHFT_DATA($ROW_SHIFTTEMPLATE_INFO->friday);
                    echo $friday[0]->name;
                ?>
              </td>
              <td>
                <?php 
                    $saturday = $this->p171_workshifts_mod->MOD_GET_WRK_SHFT_DATA($ROW_SHIFTTEMPLATE_INFO->monday);
                    echo $saturday[0]->name;
                ?>
              </td>
              <td>
                <?php 
                    $sunday = $this->p171_workshifts_mod->MOD_GET_WRK_SHFT_DATA($ROW_SHIFTTEMPLATE_INFO->sunday);
                    echo $sunday[0]->name;
                ?>
              </td>
              <td class="">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header pb-0" style="border-bottom: none;">
        <h4 class="modal-title ml-1" id="exampleModalLabel">Add Shift Template
        </h4>
      ...
      <form action="<?php echo base_url('settings/insrt_shiftTemplate'); ?>" id="SHIFTTEMPLATE_FORM_ADD" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
        <div class="modal-body">
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label class="required " for="SHIFTTEMPLATE_INPF_NAME">Code
                </label>
                <input class="form-control form-control " type="text" name="SHIFTTEMPLATE_INPF_CODE" id="SHIFTTEMPLATE_INPF_CODE">
              </div>
              <div class="form-group">
                <label class="required " for="SHIFTTEMPLATE_INPF_NAME">Template Name
                </label>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label class="required " for="SHIFTTEMPLATE_INPF_NAME">Monday
                </label>
              ...
              <div class="form-group">
                <label class="required " for="SHIFTTEMPLATE_INPF_NAME">Tuesday
                </label>
              ...
              <div class="form-group">
                <label class="required " for="SHIFTTEMPLATE_INPF_NAME">Wednesday
                </label>
...
<div class="modal fade" id="modal_edit_ShiftTemplate" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header pb-0" style="border-bottom: none;">
        <h4 class="modal-title ml-1" id="exampleModalLabel">Edit Shift Template
        </h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;
          </span>
      ...
      <form action="<?php echo base_url('settings/updt_shiftTemplate'); ?>" id="SHIFTTEMPLATE_FORM_EDIT" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
        <div class="modal-body">
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label class="required " for="UPDT_SHIFTTEMPLATE_INPF_NAME">Monday
                </label>
              ...
              <div class="form-group">
                <label class="required " for="UPDT_SHIFTTEMPLATE_INPF_NAME">Tuesday
                </label>
              ...
              <div class="form-group">
                <label class="required " for="UPDT_SHIFTTEMPLATE_INPF_NAME">Wednesday
                </label>
              ...
              <div class="form-group">
                <label class="required " for="UPDT_SHIFTTEMPLATE_INPF_NAME">Saturday
                </label>
              ...
              <div class="form-group">
                <label class="required " for="UPDT_SHIFTTEMPLATE_INPF_NAME">Sunday
                </label>
  ...
  $(document).ready(function(){
    ...
    $('.SHIFTTEMPLATE_BTN_DLT').click(function(e){
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          window.location.href = "<?= base_url(); ?>settings/dlt_ShiftTemplate?delete_id="+user_deleteKey;
        }
      })
    })
  })
