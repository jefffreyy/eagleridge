    ...
    <div class="flex-fill">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">HDMF
          </li>
        </ol>
      </nav>
      <div class="row pr-3 mb-2">
        <div class="col">
          <h1 class="page-title">Home Development Mutual Fund (HDMF)
          </h1>
        </div>
      </div>
      <div class="row mb-2">
      ...
      <div class="card">
        <table class="table table-hover table-xs">
          ...
          <tbody>
            <?php
if($DISP_HDMF_INFO){
foreach($DISP_HDMF_INFO as $ROW_HDMF_INFO){ ?>
            <tr>
                <td><?=$ROW_HDMF_INFO->year?></td>
                <td><?=$ROW_HDMF_INFO->salary_min?></td>
                <td><?=$ROW_HDMF_INFO->salary_max?></td>
                <td><?=$ROW_HDMF_INFO->er?></td>
                <td><?=$ROW_HDMF_INFO->ee?></td>
                <td><?=$ROW_HDMF_INFO->total?></td>
            </tr>
            <?php
}
} else { ?>
