    ...
    <div class="flex-fill">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">PhilHealth
          </li>
        </ol>
      </nav>
      <div class="row pr-3 mb-2">
        <div class="col">
          <h1 class="page-title">Philippine Health Insurance (PhilHealth)
          </h1>
        </div>
      </div>
      <div class="row mb-2">
      ...
      <div class="card">
        <table class="table table-hover table-xs">
          ...
          <tbody>
            <?php
if($DISP_PHILHEALTH_INFO){
foreach($DISP_PHILHEALTH_INFO as $ROW_PHILHEALTH_INFO){ ?>
            <tr>
              <td><?=$ROW_PHILHEALTH_INFO->year?></td>
              <td><?=$ROW_PHILHEALTH_INFO->rate?></td>
            </tr>
            <?php
}
} else { ?>
