    ...
    <div class="flex-fill">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Withholding
          </li>
        </ol>
      </nav>
      <div class="row pr-3 mb-2">
        <div class="col">
          <h1 class="page-title">Withholding Tax
          </h1>
        </div>
      </div>
      <div class="row mb-2">
      ...
      <div class="card">
        <table class="table table-hover table-xs">
          ...
          <tbody>
            <?php
if($DISP_WTH_TAX_INFO){
foreach($DISP_WTH_TAX_INFO as $ROW_WTH_TAX_INFO){ ?>
            <tr>
                <td><?=$ROW_WTH_TAX_INFO->year?></td>
                <td><?=$ROW_WTH_TAX_INFO->salary_min?></td>
                <td><?=$ROW_WTH_TAX_INFO->salary_max?></td>
                <td><?=$ROW_WTH_TAX_INFO->fixed?></td>
                <td><?=$ROW_WTH_TAX_INFO->c_level?></td>
                <td><?=$ROW_WTH_TAX_INFO->c_percent?></td>
            </tr>
            <?php
}
} else { ?>
