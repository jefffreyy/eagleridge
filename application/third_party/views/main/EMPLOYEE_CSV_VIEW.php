        ...
        <div class="flex-fill">
            ...
            <div class="row pr-3 mb-3">
                ...
                <div class="col ml-auto">
                    ...
                    <a class="btn btn-primary float-right mt-1" title="Add" href="<?=base_url()?>csv/upload_employee_photo">
                ...
                <div class="container mt-3 mb-3">
                    ...
                    <div class="coud_upload">
                        ...
                        <div class="donwloadFile">
                            ...
                            <p class="ml-2 mr-2">Upload .csv format maximum of 10MB size. Download sample file format <i><a href="<?= base_url("csv/download_Sample_File") ?>">here.</a></i></p>
            ...
            <div class="card">
                ...
                <div class="container mt-4 mb-3">
                    ...
                    <div class="coud_upload">
                        ...
                        <form method='post' action='<?php echo base_url('csv/ImportCsvUpdt'); ?>' enctype="multipart/form-data">
                ...
                if($DISP_ALL_EMPLOYEES){
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->col_mart_stat ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->col_home_addr ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->col_curr_addr ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->col_birt_date ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->col_empl_gend ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->col_empl_nati ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->col_shir_size ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->col_empl_emai ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->col_comp_emai ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->col_mobl_numb ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->col_comp_numb ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->col_hire_date ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->col_empl_type ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->col_empl_posi ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->col_empl_group ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->col_empl_line ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->col_empl_dept ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->col_empl_sect ?></td>
                            ...
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->col_empl_hmoo ?></td>
                            ...
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->pioneer_allowance ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->load_allowance ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->skill_allowance ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->group_leader_allowance ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->transpo_allowance ?></td>

                            <td><?= $DISP_ALL_EMPLOYEES_ROW->sch1_name ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->sch1_deg ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->sch1_from ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->sch1_to ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->sch1_gwa ?></td>

                            <td><?= $DISP_ALL_EMPLOYEES_ROW->sch2_name ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->sch2_deg ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->sch2_from ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->sch2_to ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->sch2_gwa ?></td>

                            <td><?= $DISP_ALL_EMPLOYEES_ROW->sch3_name ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->sch3_deg ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->sch3_from ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->sch3_to ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->sch3_gwa ?></td>

                            <td><?= $DISP_ALL_EMPLOYEES_ROW->skill_name1 ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->skill_lvl1 ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->skill_name2 ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->skill_lvl2 ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->emer_cont_name ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->emer_cont_rel ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->emer_cont_num ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->emer_cont_workphone ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->emer_cont_homephone ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->emer_cont_add ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->dep_name1 ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->dep_birth1 ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->dep_gend1 ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->dep_rel1 ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->dep_name2 ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->dep_birth2 ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->dep_gend2 ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->dep_rel2 ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->dep_name3 ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->dep_birth3 ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->dep_gend3 ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->dep_rel3 ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->dep_name4 ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->dep_birth4 ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->dep_gend4 ?></td>
                            <td><?= $DISP_ALL_EMPLOYEES_ROW->dep_rel4 ?></td>
