        ...
        <div class="flex-fill">
          ...
          <form action="<?php echo base_url('payroll/insrt_payroll_data'); ?>" id="form_insert_data" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
              ...
              <div class="row pr-3 mb-2">
                  ...
                  <a class="btn btn-primary float-right text-white ml-3" id="btn_insert_payroll_data"><i class="fas fa-receipt"></i>&nbsp;&nbsp;&nbsp; Generate Payslip </a>

                  <a class="btn btn-primary float-right text-white px-3" id="calculate">Calculate</a>
                  </div>
              </div>
              <div class="row">
                  <div class="col-8">
                                        ...
                                        <select class="form-control mb-2" name="select_employee" id="select_employee" required>
                                          ...
                                          <?php 
                                            if($DISP_APPROVED_ATTENDANCE_EMPLOYEE){
                                              ...
                                              ?>
                                                <option value="<?= $approved_employees[0]->id ?>" <?php if($approved_employees[0]->id == $EMPLOYEE_ID){echo 'selected';} ?>> <?= $approved_employees[0]->col_empl_cmid.' - '.$approved_employees[0]->col_frst_name.' '.$approved_employees[0]->col_last_name?></option>
                                              <?php
                                              }
                                            }
                                          ?>
              ...
              <div class="col-6">
                ...
                <div class="card">
                  <div class="card-body">
                      ...
                      <div class="d-flex ml-1">
                          <p class="text-right mb-3 mt-1" style="font-size: 14px;width:150px;">Legal Hol (Hourly): </p>
              ...
              <div class="col-6">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex ml-1">
                        <p class="text-right mb-3 mt-1" style="font-size: 14px;width:150px;">SIL 2020 </p>
    ...
    $('#cutoff_period').change(function(){
        ...
        get_approved_employee_attendance_data(url_get_approved_employee_attendance_data, cutoff_period).then(function(data){
            ...
            Array.from(data).forEach(function(x){
                var id = x[0].id;
                var col_empl_cmid = x[0].col_empl_cmid;
                var col_frst_name = x[0].col_frst_name;
                var col_last_name = x[0].col_last_name;
...
    });
    ...
    function display_loans(){
      ...
      get_loan_payable_data(url_get_loan_payable_data, employee_cmid, cutoff_period).then(function(data){
        ...
        total_LOAN = sss_salary_loan+sss_calamity_loan+hdmf_salary_loan+hdmf_calamity_loan+emergency_loan;
    ...
    function track_attendance(){
      ...
      get_attendance_count(url_attendance_count, employee_id, cutoff_period).then(function(data){
        ...
        // TI_reg_M = data.bp_reg;
        // TI_rest_M = data.bp_rest;
        // TI_spec_hol_M = data.bp_sp_hol;
        // TI_spec_hol_rest_M = data.bp_sp_rest;
        // TI_reg_hol_M = data.bp_reg_hol;
        // TI_reg_hol_rest_M = data.bp_reg_hol_rest;
        // TI_double_hol_M = data.bp_dbl_hol;
        // TI_double_hol_rest_M = data.bp_dbl_hol_rest;
        // TI_regular_ns_M = data.bp_reg_ns;
        // TI_rest_ns_M = data.bp_sp_hol_ns;
        // TI_spec_hol_ns_M = data.bp_sp_rest_ns;
        // TI_spec_hol_rest_ns_M = data.bp_sp_rest_ns;
        // TI_reg_hol_ns_M = data.bp_reg_hol_ns;
        // TI_reg_hol_rest_ns_M = data.bp_reg_hol_rest_ns;
        // TI_double_hol_ns_M = data.bp_dbl_hol_ns;
        // TI_double_hol_rest_ns_M = data.bp_dbl_hol_rest_ns;

        // TI_reg_ot_M = data.ot_reg;
        // TI_rest_ot_M = data.ot_rest;
        // TI_spec_hol_ot_M = data.ot_sp_hol;
        // TI_spec_hol_rest_ot_M = data.ot_sp_rest;
        // TI_reg_hol_ot_M = data.ot_reg_hol;
        // TI_reg_hol_rest_ot_M = data.ot_reg_hol_rest;
        // TI_double_hol_ot_M = data.ot_dbl_hol;
        // TI_double_hol_rest_ot_M = data.ot_dbl_hol_rest;
        // TI_reg_ot_ns_M = data.ot_reg_ns;
        // TI_rest_ot_ns_M = data.ot_rest_ns;
        // TI_spec_hol_ot_ns_M = data.ot_sp_hol_ns;
        // TI_spec_hol_rest_ot_ns_M = data.ot_sp_rest_ns;
        // TI_reg_hol_ot_ns_M = data.ot_reg_hol_ns;
        // TI_reg_hol_rest_ot_ns_M = data.ot_reg_hol_rest_ns;
        // TI_double_hol_ot_ns_M = data.ot_dbl_hol_ns;
        // TI_double_hol_rest_ot_ns_M = data.ot_dbl_hol_rest_ns;

        // TI_absent_M = data.absences;
        // TI_late_undertime_M = data.late;
        // TI_leave_M = data.leaves;   
        // TI_work_days = data.working_days; 

        // $('#TI_reg_multiplier').val(TI_reg_M);
        // $('#TI_rest_multiplier').val(TI_rest_M);
        // $('#TI_spec_hol_multiplier').val(TI_spec_hol_M);
        // $('#TI_spec_hol_rest_multiplier').val(TI_spec_hol_rest_M);
        // $('#TI_reg_hol_multiplier').val(TI_reg_hol_M);
        // $('#TI_reg_hol_rest_multiplier').val(TI_reg_hol_rest_M);
        // $('#TI_double_hol_multiplier').val(TI_double_hol_M);
        // $('#TI_double_hol_rest_multiplier').val(TI_double_hol_rest_M);
        // $('#TI_regular_ns_multiplier').val(TI_regular_ns_M);
        // $('#TI_rest_ns_multiplier').val(TI_rest_ns_M);
        // $('#TI_spec_hol_ns_multiplier').val(TI_spec_hol_ns_M);
        // $('#TI_spec_hol_rest_ns_multiplier').val(TI_spec_hol_rest_ns_M);
        // $('#TI_reg_hol_ns_multiplier').val(TI_reg_hol_ns_M);
        // $('#TI_reg_hol_rest_ns_multiplier').val(TI_reg_hol_rest_ns_M);
        // $('#TI_double_hol_ns_multiplier').val(TI_double_hol_ns_M);
        // $('#TI_double_hol_rest_ns_multiplier').val(TI_double_hol_rest_ns_M);
        // $('#TI_reg_ot_multiplier').val(TI_reg_ot_M);
        // $('#TI_rest_ot_multiplier').val(TI_rest_ot_M);
        // $('#TI_spec_hol_ot_multiplier').val(TI_spec_hol_ot_M);
        // $('#TI_spec_hol_rest_ot_multiplier').val(TI_spec_hol_rest_ot_M);
        // $('#TI_reg_hol_ot_multiplier').val(TI_reg_hol_ot_M);
        // $('#TI_reg_hol_rest_ot_multiplier').val(TI_reg_hol_rest_ot_M);
        // $('#TI_double_hol_ot_multiplier').val(TI_double_hol_ot_M);
        // $('#TI_double_hol_rest_ot_multiplier').val(TI_double_hol_rest_ot_M);
        // $('#TI_reg_ot_ns_multiplier').val(TI_reg_ot_ns_M);
        // $('#TI_rest_ot_ns_multiplier').val(TI_rest_ot_ns_M);
        // $('#TI_spec_hol_ot_ns_multiplier').val(TI_spec_hol_ot_ns_M);
        // $('#TI_spec_hol_rest_ot_ns_multiplier').val(TI_spec_hol_rest_ot_ns_M);
        // $('#TI_reg_hol_ot_ns_multiplier').val(TI_reg_hol_ot_ns_M);
        // $('#TI_reg_hol_rest_ot_ns_multiplier').val(TI_reg_hol_rest_ot_ns_M);
        // $('#TI_double_hol_ot_ns_multiplier').val(TI_double_hol_ot_ns_M);
        // $('#TI_double_hol_rest_ot_ns_multiplier').val(TI_double_hol_rest_ot_ns_M);

        // $('#TI_absent_multiplier').val(TI_absent_M);
        // $('#TI_late_undertime_multiplier').val(TI_late_undertime_M);
        // $('#TI_leave_multiplier').val(TI_leave_M);
        // $('#working_days').val(TI_work_days);
    ...
    function contribution_calc(){
      ...
      getSssTax(url,total_GTI_OVERALL).then(data => {
        data.sss.forEach((x) => {
          ...
          if(philhealth_salary >= 60000){      
            philhealth_ee_val = 1800/philhealth_constant;
            philhealth_er_val = 1800/philhealth_constant;
          } else if((philhealth_salary > 10000) && (philhealth_salary < 60000)) {
            philhealth_ee_val = (philhealth_salary * (3.00 / 100)/philhealth_constant);
            philhealth_er_val = (philhealth_salary * (3.00 / 100)/philhealth_constant);
          } else {
            philhealth_ee_val = 300/philhealth_constant;
            philhealth_er_val = 300/philhealth_constant;
          }
          ...
          if(integrated_cutoff_period == 'not_connected'){
            ...
            if(salary_type == 'Monthly')
            {
              philhealth_ee_val = philhealth_half_val*2;
              philhealth_er_val = philhealth_half_val*2;

              philhealth_ee_val_diff = philhealth_half_val;
              philhealth_er_val_diff = philhealth_half_val;
            }
            else{
              philhealth_ee_val = philhealth_half_val;
              philhealth_er_val = philhealth_half_val;
          ...
          // ------------------- Computation ------------------------------
          tax_allow_tot = tax_load + tax_trans + tax_skill + tax_pioneer + tax_group_leader;
         ...
         // $('#GROSS_TAX_TI_total').val(toDisplay(gross_TI));
          ...
          getSalaryWitholdingTax(url_wtax,TOT_tax_income).then(data => {
            data.witholding_tax.forEach((x) => {
                ...
                net_pay = TOT_tax_income - total_wtax - total_DED - total_LOAN;
    ...
    function save_to_db(){
      ...
      var loan_sss_salary = sss_salary_loan;
      var loan_sss_calamity = sss_calamity_loan;
      var loan_pagibig_salary = hdmf_salary_loan;
      var loan_pagibig_calamity = hdmf_calamity_loan;
      var loan_emergency = emergency_loan;
