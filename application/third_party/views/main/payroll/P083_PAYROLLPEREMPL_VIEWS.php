...
<?php
    ...
    if($DISP_PAYROLL_DATA){
        foreach($DISP_PAYROLL_DATA as $DISP_PAYROLL_DATA_ROW){
            ...
            $salary_rate =  $DISP_PAYROLL_DATA_ROW->salary_rate;
                                ...
                                <div class="col-6">
                                  ...
                                  <div class="row">
                                    <div class="col-12 d-flex">
                                      ...
                                      <div class="flex-fill" style="width: auto;">
                                        <input type="text" name="salary_rate" value="<?= $salary_rate ?>" id="salary_rate" placeholder="Enter Monthly Salary" class="form-control ml-0" disabled>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="row mt-2">
                                ...
                                <div class="col-6">
                                  <div class="row">
                                    <div class="col-12 d-flex">
                                      ...
                                      <div class="flex-fill" style="width: auto;">
                                        ...
                                        <select name="payroll_period" class="form-control" id="cutoff_period" required disabled>
                                            <?php 
                                  ...
                                  <div class="row">
                                    <div class="col-12 d-flex">
                                      ...
                                      <div class="flex-fill" style="width: auto;">
                                        <input type="text" name="working_days" id="working_days" value="<?= $working_days ?>" placeholder="# of Working Days" class="form-control ml-0" disabled>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="row mt-2">
                                    <div class="col-12 d-flex">
                                      ...
                                      <div class="flex-fill" style="width: auto;">
                                        <input type="text" name="work_hours" id="work_hours" value="<?= $hours_of_work ?>" placeholder="# of Work hours per day" value="8" class="form-control ml-0" disabled>
                                      </div>
                                    </div>
                                  </div>
                                </div>
...
<script>
  $(document).ready(function(){
    ...
    // PHILHEALTH CHECKBOX
    $('#philhealth_deduction').change(function(){
      var isChecked = $('#philhealth_deduction:checkbox:checked').length > 0;
      if(isChecked){
        var total_GTI = $('#GROSS_TAX_total').val();
        $('#GOV_CONT_philhealth_total').val( ((parseFloat(total_GTI) * (3.5 / 100)) / 2).toFixed(2) );
        $('#GOV_CONT_EMPLYR_philhealth_total').val( ((parseFloat(total_GTI) * (3.5 / 100))/2).toFixed(2) );
        
        var wth_tax = $('#GOV_CONT_with_tax_total').val();
        var sss = $('#GOV_CONT_SSS_total').val();
        var philhealth = $('#GOV_CONT_philhealth_total').val();
        var pagibig = $('#GOV_CONT_pagibig_total').val();
        ...
        $('#OVR_total').val(( ( parseFloat($('#OVR_total_TI').val()) + parseFloat($('#OVR_total_NTI').val()) ) - ( parseFloat(gov_cont_total.toFixed(2)) + parseFloat($('#LOAN_total').val()) + parseFloat($('#OVR_total_DED').val()) ) ).toFixed(2));
      } else {
        $('#GOV_CONT_philhealth_total').val(0);
        $('#GOV_CONT_EMPLYR_philhealth_total').val(0);
    ...
    // PAGIBIG CHECKBOX
    $('#pagibig_deduction').change(function(){
      var isChecked = $('#pagibig_deduction:checkbox:checked').length > 0;
      if(isChecked){
        var total_GTI = $('#GROSS_TAX_total').val();
        
        if(total_GTI >= 5000){
          $('#GOV_CONT_pagibig_total').val( 100 );
        } else if((total_GTI >= 1500) && (total_GTI < 5000)) {
          $('#GOV_CONT_pagibig_total').val( (parseFloat(total_GTI * 0.02)).toFixed(2) );
        } else {
          $('#GOV_CONT_pagibig_total').val( (parseFloat(total_GTI * 0.01)).toFixed(2) );
        }

        if(total_GTI >= 5000){
          $('#GOV_CONT_EMPLYR_pagibig_total').val( 100 );
        } else {
          $('#GOV_CONT_EMPLYR_pagibig_total').val( (parseFloat(total_GTI * 0.02)).toFixed(2) );
        }
        ...
        $('#GOV_CONT_pagibig_total').val(0);
        $('#GOV_CONT_EMPLYR_pagibig_total').val(0);
    ...
    // SSS CHECKBOX
    $('#sss_deduction').change(function(){
      var isChecked = $('#sss_deduction:checkbox:checked').length > 0;
      if(isChecked){
        ...
        $('#GOV_CONT_SSS_total').val(0);
        $('#GOV_CONT_EMPLYR_SSS_total').val(0);
    ...
    // Witholding tax CHECKBOX
    $('#tax_deduction').change(function(){
      var isChecked = $('#tax_deduction:checkbox:checked').length > 0;
      if(isChecked){
        ...
        getSalaryWitholdingTax(url,total_GTI).then(data => {
          data.witholding_tax.forEach((x) => {
            var wtax =  parseFloat(x.fixed) + (parseFloat(total_GTI) - parseFloat(x.c_level)) * ( parseFloat(x.c_percent) / 100);
            $('#GOV_CONT_with_tax_total').val(wtax.toFixed(2));
      ...
      getSalaryWitholdingTax(url,total_GTI).then(data => {
        ...
        data.sss.forEach((x) => {
          ...
          if(total_GTI >= 5000){
            ...
            document.getElementById('GOV_CONT_pagibig_total').value = (parseFloat(total_GTI * 0.02)).toFixed(2);
          } else {
            document.getElementById('GOV_CONT_pagibig_total').value = (parseFloat(total_GTI * 0.01)).toFixed(2);
          }
          // gov contributions (employer)
          document.getElementById('GOV_CONT_EMPLYR_SSS_total').value = x.er;
          ...
          if(total_GTI >= 5000){
            ...
            document.getElementById('GOV_CONT_EMPLYR_pagibig_total').value = (parseFloat(total_GTI * 0.02)).toFixed(2);
          }
    ...
    function computeTI(day_rate){
      payroll_to_tbl();
      var salary_rate = parseFloat($('#salary_rate').val());
      var hours_per_day = parseFloat($('#work_hours').val());
      var daily_salary = salary_rate / day_rate;
