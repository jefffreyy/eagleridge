    ...
    <div class="p-3">
        <div class="flex-fill">
            <div class="row pr-3 mb-3">
                <div class="col">
                    <h1 class="page-title">Upload Accounting Record</h1>
                </div>
            ...
            <div class="row mb-3">
                <div class="col-6">
                    <h1 class="page-title mb-0 " style="font-size: 20px;">Update Bank Details</h1>
                </div>
                <div class="col-6">
                ...
                <div class="container mt-3 mb-3">
                    <div class="coud_upload">
                        <div class="donwloadFile">
                            <p class="ml-2 mr-2">Upload .csv format maximum of 10MB size. Download sample file format <i><a href="<?= base_url() ?>sample_file/Sample_bank_details_format.csv" download>here.</a></i></p>
                        </div>
                        <form method='post' action='<?php echo base_url('csv/ImportAccountingRecords'); ?>' enctype="multipart/form-data">
                            <div class="ml-2 mr-2">
                        ...
                        <p>
                            ...
                            2. Write the proper format of the account numbers. Add dashes " - " if possible ( e.g 1023-4567-8090 )<br>
                        </p>
                    </div>
                </div>
            </div>
