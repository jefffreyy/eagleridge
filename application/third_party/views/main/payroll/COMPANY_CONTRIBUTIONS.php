...
<?php 
    ...
    if($DISP_PAYROLL_DATA){
        foreach($DISP_PAYROLL_DATA as $payroll_data){
            array_push($total_sss_arr, (floatval($payroll_data->comp_cont_sss) + floatval($payroll_data->gov_sss_ee)));
	...
	<div class="content-wrapper">
		<div class="container-fluid p-4">
            <form action="<?php echo base_url('payroll/generator'); ?>" id="payslip_period" method="post" accept-charset="utf-8" autocomplete='off' >
                <div class="row">
                    <div class = "col-md-6">
                    <h1 class="page-title">Company Contributions<h1>
                    </div>
                                ...
                                <select name="date_period" class="form-control" id="date_period" required>
                                    <?php
                                        if($DISP_PAYROLL_SCHED){
                                            ...
                                            ?>
                                                <option value="<?= $schedule_id ?>" selected><?= $DISP_PAYROLL_SCHED_ROW->name ?></option>
                                            <?php
                                                }
                                            ?>
                                    ...
                                    if($DISP_PAYROLL_DATA){
                                        ...
                                        ?>
                                            <tr class="payslip_row">
                                                ...
                                                <td>
                                                    <?php
                                                        echo number_format($DISP_PAYROLL_DATA_ROW->gov_sss_ee,2);
                                                    ?>
                                                </td>
                                                <td><?= number_format($DISP_PAYROLL_DATA_ROW->comp_cont_sss,2) ?></td>
                                                <td sss_total="<?= floatval($DISP_PAYROLL_DATA_ROW->gov_sss_ee) + floatval($DISP_PAYROLL_DATA_ROW->comp_cont_sss) ?>"><?= number_format((floatval($DISP_PAYROLL_DATA_ROW->gov_sss_ee) + floatval($DISP_PAYROLL_DATA_ROW->comp_cont_sss)),2) ?></td>
                                            </tr>
                                        <?php
                                            }
                                        } else {
                                    ...
                                    if($DISP_PAYROLL_DATA){
                                        ...
                                        ?>
                                            <tr class="payslip_row">
                                                ...
                                                <td><?= number_format($DISP_PAYROLL_DATA_ROW->gov_pagibig_ee, 2) ?></td>
                                                <td><?= number_format($DISP_PAYROLL_DATA_ROW->comp_cont_pagibig, 2) ?></td>
                                                <td pagibig_total="<?= floatval($DISP_PAYROLL_DATA_ROW->gov_pagibig_ee) + floatval($DISP_PAYROLL_DATA_ROW->comp_cont_pagibig) ?>"><?= number_format((floatval($DISP_PAYROLL_DATA_ROW->gov_pagibig_ee) + floatval($DISP_PAYROLL_DATA_ROW->comp_cont_pagibig)),2) ?></td>
                                        </tr>
                                        <?php
                                            }
                                        } else {
                                    ...
                                    if($DISP_PAYROLL_DATA){
                                        ...
                                        ?>
                                            <tr class="payslip_row">
                                                ...
                                                <td><?= $DISP_PAYROLL_DATA_ROW->gov_philhealth_ee ?></td>
                                                <td><?= $DISP_PAYROLL_DATA_ROW->comp_cont_philhealth ?></td>
                                                <td philhealth_total="<?= floatval($DISP_PAYROLL_DATA_ROW->gov_philhealth_ee) + floatval($DISP_PAYROLL_DATA_ROW->comp_cont_philhealth) ?>"><?= number_format((floatval($DISP_PAYROLL_DATA_ROW->gov_philhealth_ee) + floatval($DISP_PAYROLL_DATA_ROW->comp_cont_philhealth)),2) ?></td>
                                        </tr>
                                        <?php
                                            }
                                        } else {
                ...
                if($DISP_PAYROLL_DATA){
                    ...
                    ?>
                        <tr class="payslip_row">
                            ...
                            <!-- SSS -->
                            <td><?= $employee[0]->col_empl_sssc ?></td>
                            <td><?php echo number_format($DISP_PAYROLL_DATA_ROW->gov_sss_ee,2);?></td>
                            <td><?= number_format($DISP_PAYROLL_DATA_ROW->comp_cont_sss,2) ?></td>
                            <td><?= number_format((floatval($DISP_PAYROLL_DATA_ROW->gov_sss_ee) + floatval($DISP_PAYROLL_DATA_ROW->comp_cont_sss)),2) ?></td>
                            
                            <!-- Pagibig -->
                            <td><?= $employee[0]->col_empl_hdmf ?></td>
                            <td><?php echo number_format($DISP_PAYROLL_DATA_ROW->gov_pagibig_ee,2);?></td>
                            <td><?= number_format($DISP_PAYROLL_DATA_ROW->comp_cont_pagibig,2) ?></td>
                            <td><?= number_format((floatval($DISP_PAYROLL_DATA_ROW->gov_pagibig_ee) + floatval($DISP_PAYROLL_DATA_ROW->comp_cont_pagibig)),2) ?></td>
                            
                            <!-- Philhealth -->
                            <td><?= $employee[0]->col_empl_phil ?></td>
                            <td><?php echo number_format($DISP_PAYROLL_DATA_ROW->gov_philhealth_ee,2);?></td>
                            <td><?= number_format($DISP_PAYROLL_DATA_ROW->comp_cont_philhealth,2) ?></td>
                            <td><?= number_format((floatval($DISP_PAYROLL_DATA_ROW->gov_philhealth_ee) + floatval($DISP_PAYROLL_DATA_ROW->comp_cont_philhealth)),2) ?></td>
                    </tr>
                    <?php
                        }
                    } else {
