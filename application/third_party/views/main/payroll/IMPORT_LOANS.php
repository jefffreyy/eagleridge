        ...
        <div class="flex-fill">
            ...
            <div class="row pr-3 mb-3">
                ...
                <div class="col">
                    ...
                    <h1 class="page-title">Import Loans</h1>
                ...
                <div class="container mt-3 mb-3">
                    ...
                    <div class="coud_upload">
                        ...
                        <div class="donwloadFile">
                            ...
                            <p class="ml-2 mr-2">Upload .csv format maximum of 10MB size. Download sample file format <i><a href="<?= base_url("csv/download_Sample_Loan_File") ?>">here.</a></i></p>

                        </div>

                        <form method='post' action='<?php echo base_url('csv/ImportSpecificLoan'); ?>' enctype="multipart/form-data">
                        ...
                        <p>
                            ...
                            2. Under the 'Loan Types' column, only the following values are allowed. Otherwise, it will not be uploaded: <br>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SSS Salary Loan <br>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SSS Calamity Loan <br>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pag-ibig Salary Loan <br>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pag-ibig Calamity Loan <br>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Emergency Loan <br>
                            3. Cutoff ID must be based on cut-off period list. Please refer to Settings/Cut-off Period
                        </p>
