                ...
                <div class = "col-md-9">
                    <div class = "row">
                        <div class = "mini-nav">
                            ...
                            <a href = "<?=base_url()?>employees/assets?id=<?=$user_id?>" class = "mini-links active">Assets</a>
                            ...
                            <div class = "modal-btn">
                                <?php 
                                    if(($user_info[0]->col_user_access == 2) || ($user_info[0]->col_user_access == 4)){
                                        ?>
                                            <a type = "button" class = "btn btn-primary mr-2 text-white" data-toggle="modal" data-target="#modal_add_assets"><i class="fas fa-plus mr-2"></i>Assign</a>       
                                        <?php
                                    }
                                ?>
                            ...
                            <table class="table table-xs table-hover table-nowrap mb-0" style="border:none;">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Issued On</th>
                                        <?php 
                                            if($user_info[0]->col_user_access == 2){
                                                ?>
                                                    <th></th>
                                                <?php
                                            }
    ...
    <div class="modal fade" id="modal_add_assets" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url('employees/add_employee_asset'); ?>" id="ADD_ASSET_FORM" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="required" for="INSRT_ASSET_ISSUED_ON">Recieved On</label>
