...
<!-- Sweet Alert CSS -->
                ...
                <div class = "col-md-9">
                    <div class = "row">
                        <div class = "mini-nav">
                            ...
                            <a href = "<?=base_url()?>employees/documents?id=<?=$user_id?>" class = "mini-links active">Documents</a>
                            ...
                            <div class = "modal-btn">
                                ...
                                <?php 
                                    if(($user_info[0]->col_user_access == 2) || ($user_info[0]->col_user_access == 4)){
                                        ?>
                                            <button type = "button" class = "btn btn-primary" data-toggle="modal" data-target="#modal_add_document"><i class="fas fa-plus mr-2"></i>Add Document</button>
                                        <?php
                                    }
                                ?>
                        ...
                        <ul class="mt-2" style="list-style: none;">
                            ...
                            ?>
                                <li class="mt-2 mb-2">
                                    ...
                                    <a href="<?= base_url() ?>employee_files/<?= $DISP_EMPL_DOCS_ROW->col_doc_file ?>" download><?= $DISP_EMPL_DOCS_ROW->col_doc_name ?></a>
                                    <span class="ml-4">
                                        <a href="#" class="text-black-50" data-toggle="dropdown" aria-expanded="false">
                                            <i class="fas fa-ellipsis-v"></i>
                                        </a>
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" target="_blank" href="<?= base_url() ?>employee_files/<?= $DISP_EMPL_DOCS_ROW->col_doc_file ?>" download>Download</a>
                                            <a class="text-danger dropdown-item BTN_DLT_DOC" delete_key="<?= $DISP_EMPL_DOCS_ROW->id ?>" employee_id="<?= $user_id ?>" filename="<?= $DISP_EMPL_DOCS_ROW->col_doc_file ?>">Delete</a>
                                        </div>
                                    </span>
                                </li>
                            <?php
                                ...
                                <div class="text-center mt-4 mb-4">
                                    <i class="fas fa-paperclip  fa-4x text-muted"></i>
                                    <h3 class="text-muted mb-4 mt-2"><?= $firstname ?> hasn't filed any documents</h3>
                                </div>
                            <?php
                            }
                            ?>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url('employees/add_employee_document'); ?>" id="ADD_DOCUMENT_FORM" method="post" accept-charset="utf-8" autocomplete='off' class="m-2" enctype="multipart/form-data">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input fileficker document_file_attachment" id="exampleInputFile" name="employee_file" multiple="" accept=".docx, .pdf, .xlsx, .pptx" required>
                                            <label class="custom-file-label" id="document_file_label" for="exampleInputFile">Choose file</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        <button class='btn btn-primary text-light' type="submit" id="DOC_BTN_INSRT">&nbsp; Add</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
         $(document).ready(function(){
            ...
            // Set filename when document is attached
            $('.document_file_attachment').change(function(){
                if ( this.files && this.files[0] ){
                    $('#document_file_label').text(this.files[0].name);
                }
            })
