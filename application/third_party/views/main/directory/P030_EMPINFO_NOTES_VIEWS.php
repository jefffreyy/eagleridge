...
<!-- Sweet Alert CSS -->
                ...
                <div class = "col-md-9">
                    <div class = "row">
                        <div class = "mini-nav">
                            ...
                            <a href = "<?=base_url()?>employees/notes?id=<?=$user_id?>" class = "mini-links active">Notes</a>
                        ...
                        <div class = "card-title">Notes
                            <?php 
                                if(($user_info[0]->col_user_access == 2) || ($user_info[0]->col_user_access == 4)){
                                    ?>
                                        <div class = "modal-btn"><a href="#" data-target="#modal_add_notes" data-toggle="modal"><i class="fas fa-plus"></i></i></a></div>
                                    <?php
                                }
                            ?>
                            ...
                            <div class="col-md-2" style = "text-align: right;">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="#" DATA_ID="<?= $ROW_NOTES_INFO->id ?>" title="Edit" data-toggle="modal" data-target="#modal_edit_notes">Edit</a>
                                        <a class="dropdown-item text-danger NOTES_BTN_DLT" href="#" employee_id="<?= $user_id ?>" delete_key="<?= $ROW_NOTES_INFO->id ?>">Delete</a>
    ...
    <div class="modal fade" id="modal_add_notes" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url('employees/insert_notes'); ?>" id="ADD_NOTE_FORM" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?php 
                                    ...
                                    if ($DISP_USER_INFO)
                                    {
                                        ...
                                        {
                                            $middlename = $ROW_USER_INFO->col_midl_name;
                                            $CURRENT_USER = $ROW_USER_INFO->col_last_name.$ROW_USER_INFO->col_frst_name." ".ucfirst($middlename[0]).".";
                                        }
                                    }
                                ?>
    ...
    <div class="modal fade" id="modal_edit_notes" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url('employees/update_notes'); ?>" id="EDIT_NOTE_FORM" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
            ...
            <div class="modal-content">
                ...
                <form action="<?php echo base_url('employees/edit_image'); ?>" id="edit_image_form" method="post" accept-charset="utf-8" autocomplete='off' class="m-2" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        ...
                        ?>
                        <input type="hidden" name="URL_DIRECTORY" value="<?= $url_directory ?>">
                        <button class='btn btn-primary text-light px-3' type="submit">Update</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        if (result.isConfirmed) {
        window.location.href = "<?= base_url(); ?>employees/delete_notes?delete_id="+user_deleteKey+"&employee_id="+employee_key;
        }
        })
        })
    })
