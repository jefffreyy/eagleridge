                ...
                <div class = "col-md-9">
                    <div class = "row">
                        <div class = "mini-nav">
                            ...
                            <!-- <a href = "<?=base_url()?>employees/tasks?id=<?=$user_id?>" class = "mini-links active">Tasks</a> -->
                    ...
                    <br>
                    <div class = "card border-0">
                        <div class = "card-title mb-0">My Tasks
                            <div class = "modal-btn">
                                <div class ="row">
                                    <div class = "col-md-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-xs mb-0" style="border: none;">
                                <thead>
                                    <tr>
                                        <th>Title</th>
                                        <th>Type</th>
                                ...
                                <tbody>
                                    <?php 
                                        if($DISP_EMP_TASK){
                                            foreach($DISP_EMP_TASK as $DISP_EMP_TASK_ROW){
                                                $startDate_split = explode(' ',$DISP_EMP_TASK_ROW->col_task_start);
                                                $start = $startDate_split[0];

                                                $endDate_split = explode(' ',$DISP_EMP_TASK_ROW->col_task_end);
                                                $end = $endDate_split[0];
                                    ?>
                                        <tr>
                                            <td><a href="#"><?= $DISP_EMP_TASK_ROW->col_task_title ?></a></td>
                                            <td><?= $DISP_EMP_TASK_ROW->col_task_type ?></td>
                                            <td><?= $start ?></td>
                                            <td><?= $end ?></td>
                                            <td>
                                                <a class="btn btn-sm btn-success" href="#"><i class="fas fa-check"></i></a>
                                            </td>
                                        </tr>
                                    <?php
                                            }
                                        ...
                                        ?>
                                            <tr>
                                                <td colspan="5" class="p-4">No task assigned to this employee</td>
                                            </tr>
                                        <?php
                                        }
                                    ?>
                    ...
                    <!-- <div class = "card border-0">
                        <div class = "card-title">Onboarding Task
                            <div class = "modal-btn">
                                <div class ="row">
                                    <div class = "col-md-12">
                                        <select class="form-control">
                    ...
                    <div class = "card border-0">
                        <div class = "card-title">Offboarding Task
                            <div class = "modal-btn">
                                <div class ="row">
                                    <div class = "col-md-12">
                                        <select class="form-control">
