                ...
                <div class = "col-md-9">
                    <div class = "row">
                        <div class = "mini-nav">
                            ...
                            <a href = "<?=base_url()?>employees/ids?id=<?=$user_id?>" class = "mini-links active">ID's</a>
                    ...
                    <div class = "card border-0">
                        <div class = "card-title">Government ID's
                            <?php 
                                if(($user_info[0]->col_user_access == 2) || ($user_info[0]->col_user_access == 4)){
                                    ?>
                                        <div class = "modal-btn"><a data-toggle="modal" href="#" data-target="#modal_update_ids"><i class="fas fa-pencil-alt"></i></a></div>
                                    <?php
                                }
                            ?>
                        ...
                        <div class = "row mt-4">
                            ...
                            <div class = "col col-md-8">
                                <span style="font-weight:normal"><?php if($sss){echo $sss;}else{echo '<em class="text-muted">Add an ID</em>';}  ?></span>
                            </div>
                        </div>
                        <div class = "row mt-4">
                            <div class = "col col-md-3">
                            ...
                            <div class = "col col-md-8">
                                <span style="font-weight:normal"><?php if($hdmf){echo $hdmf;}else{echo '<em class="text-muted">Add an ID</em>';}  ?></span>
                            </div>
                        </div>
                        <div class = "row mt-4">
                            <div class = "col col-md-3">
                            ...
                            <div class = "col col-md-8">
                                <span style="font-weight:normal"><?php if($philhealth){echo $philhealth;}else{echo '<em class="text-muted">Add an ID</em>';}  ?></span>
                            </div>
                        </div>
                        <div class = "row mt-4">
                            <div class = "col col-md-3">
                            ...
                            <div class = "col col-md-8">
                                <span style="font-weight:normal"><?php if($tin){echo $tin;}else{echo '<em class="text-muted">Add an ID</em>';}  ?></span>
                            </div>
                        </div>
                        <div class = "row mt-4">
                            <div class = "col col-md-3">
                            ...
                            <div class = "col col-md-8">
                                <span style="font-weight:normal"><?php if($drivers_license){echo $drivers_license;}else{echo '<em class="text-muted">Add an ID</em>';}  ?></span>
                            </div>
                        </div>
                        <div class = "row mt-4">
                            <div class = "col col-md-3">
                            ...
                            <div class = "col col-md-8">
                                <span style="font-weight:normal"><?php if($national_id){echo $national_id;}else{echo '<em class="text-muted">Add an ID</em>';}  ?></span>
                            </div>
                        </div>
                        <div class = "row mt-4">
                            <div class = "col col-md-3">
                            ...
                            <div class = "col col-md-8">
                                <span style="font-weight:normal"><?php if($passport){echo $passport;}else{echo '<em class="text-muted">Add an ID</em>';}  ?></span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="modal_update_ids" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url('employees/update_employee_id'); ?>" id="UPDT_FORM" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="UPDT_ID_SSS">SSS</label>
                                    <input class="form-control form-control " type="text" name="UPDT_ID_SSS" value="<?php if($sss){echo $sss;}else{echo '';} ?>" id="UPDT_ID_SSS" required>
                                </div>
                                <div class="form-group">
                                    <label for="UPDT_ID_SSS">Pagibig</label>
                                    <input class="form-control form-control " type="text" name="UPDT_ID_HDMF" value="<?php if($hdmf){echo $hdmf;}else{echo '';} ?>" id="UPDT_ID_HDMF" required>
                                </div>
                                <div class="form-group">
                                    <label for="UPDT_ID_PHIL">Philhealth</label>
                                    <input class="form-control form-control " type="text" name="UPDT_ID_PHIL" value="<?php if($philhealth){echo $philhealth;}else{echo '';} ?>" id="UPDT_ID_PHIL" required>
                                </div>
                                <div class="form-group">
                                    <label for="UPDT_ID_TIN">TIN</label>
                                    <input class="form-control form-control " type="text" name="UPDT_ID_TIN" value="<?php if($drivers_license){echo $drivers_license;}else{echo '';} ?>" id="UPDT_ID_TIN" required>
                                </div>
                                <div class="form-group">
                                    <label for="UPDT_ID_DRV">Driver's License</label>
                                    <input class="form-control form-control " type="text" name="UPDT_ID_DRV" value="<?php if($national_id){echo $national_id;}else{echo '';} ?>" id="UPDT_ID_DRV" required>
                                </div>
                                <div class="form-group">
                                    <label for="UPDT_ID_NAT">National ID</label>
                                    <input class="form-control form-control " type="text" name="UPDT_ID_NAT" value="<?php if($passport){echo $passport;}else{echo '';} ?>" id="UPDT_ID_NAT" required>
                                </div>
                                <div class="form-group">
                                    <label for="UPDT_ID_PSSP">Passport</label>
                                    <input class="form-control form-control " type="text" name="UPDT_ID_PSSP" value="<?php if($sss){echo $sss;}else{echo '';} ?>" id="UPDT_ID_PSSP" required>
                                </div>
                            </div>
