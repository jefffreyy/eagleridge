...
<!-- Sweet Alert CSS -->
                                    ...
                                    <tr class="empl_row" empl_id="<?= $DISP_EMP_LIST_ROW->id ?>">
                                        ...
                                        <td>
                                            <select name="user_access" id="user_access" class="form-control">
                                                <option value="0" <?php if($DISP_EMP_LIST_ROW->col_user_access == 0){ echo 'selected';} ?>>STAFF</option>
                                                <option value="2" <?php if($DISP_EMP_LIST_ROW->col_user_access == 2){ echo 'selected';} ?>>HR</option>
                                                <option value="3" <?php if($DISP_EMP_LIST_ROW->col_user_access == 3){ echo 'selected';} ?>>ACCOUNTING</option>
                                                <option value="4" <?php if($DISP_EMP_LIST_ROW->col_user_access == 4){ echo 'selected';} ?>>ADMIN</option>
                                            </select>
                                        </td>
                                        <td>
                                            <select name="user_access" id="user_access" class="form-control">
                                                <option value="0" <?php if($DISP_EMP_LIST_ROW->remote_att == 0){ echo 'selected';} ?>>Disabled</option>
                                                <option value="1" <?php if($DISP_EMP_LIST_ROW->remote_att == 1){ echo 'selected';} ?>>Enabled</option>
                                            </select>
                                        </td>
    ...
    function save_user_access(){
        ...
        Array.from($('.empl_row')).forEach(function(e){
            ...
            update_empl_user_access(url_update_empl_user_access, empl_id, user_access_id, remote_attendance).then(function(data){
                console.log(empl_id + ' - ' + data);
                // updted_rows++;
                // if(row_length == updted_rows){
                //     $('#loading_indicator_user_access').hide();
                //     $('#save_user_access').show();
                //     Swal.fire(
                //         'Changes Saved',
                //         '',
                //         'success'
