        ...
        <div class="flex-fill">
          ...
          <form action="<?php echo base_url('payroll/insrt_payroll_data'); ?>" id="form_insert_data" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
              ...
              <div class="row">
                  ...
                  <!-- Store Employee Info -->
                  <!-- <input type="hidden" id="info_empl_name">
                  <input type="hidden" id="info_empl_type">
                  <input type="hidden" id="info_empl_position">
                  <input type="hidden" id="info_empl_department">
                  <input type="hidden" id="info_empl_cmid">
                  <input type="hidden" id="info_empl_img"> -->
...
<!-- <div class="card" id="print_div" style="display: none;">
  <h2 class="page-title w-100 text-center">Payslip Details Sample Layout</h2>
  <hr>
  <div class="container">
    <p>Employee Name: <span id='print_empl_name'></span></p>
    <p>Employee Type: <span id='print_empl_type'></span></p>
    <p>Employee Position: <span id='print_empl_position'></span></p>
    <p>Net Pay: <span id='print_net_pay'></span></p>
  </div>
</div> -->
...
<script>
  $(document).ready(function(){
    ...
    $('#select_employee').change(function(){
      ...
      getEmployeeData(url_empl,employee_id).then(data => {
        data.employee_data.forEach((x) => {
          ...
          // Store to Employee Info
          /* $('#info_empl_name').val(fullname);
          $('#info_empl_type').val(x.col_empl_type);
          $('#info_empl_position').val(x.col_empl_posi);
          $('#info_empl_department').val(x.col_empl_dept);
          $('#info_empl_cmid').val(x.col_empl_cmid);
          $('#info_empl_img').val(x.col_imag_path); */
    ...
    function save_to_db(){
      ...
      // append to print div
      /* $('#print_empl_name').text($('#info_empl_name').val());
      $('#print_empl_type').text($('#info_empl_type').val());
      $('#print_empl_position').text($('#info_empl_position').val());
      $('#print_net_pay').text($('#OVR_total').val()); */
    ...
    $('#NTI_other7_multiplier').keyup(function(){
      ...
      /* $('#btn_insert_payroll_data').click(function(e){
        e.preventDefault();
        Swal.fire({
          title: 'Generate a payslip with these records?',
          ...
          if (result.isConfirmed) {
            ...
            // $('#form_insert_data').submit();
              ...
              var getDivToPrint = $('#print_div');
              $('#print_div').hide();
              //Get the HTML of div
              var divElements = $('#print_div').html();
