                ...
                <div class = "col-md-9">
                    <div class = "row">
                        <div class = "mini-nav">
                            ...
                            <a href = "<?=base_url()?>profile/job" class = "mini-links active">Job</a>
                                    ...
                                    <select name="line" id="line" class="form-control" required>
                                        ...
                                        <?php 
                                            if($DISP_Line){
                                                ...
                                                ?>
                                                    <option value="<?= $DISP_Line_ROW->name ?>" <?php if($DISP_Line_ROW->name == $line){echo 'selected';} ?>><?= $DISP_Line_ROW->name ?></option>
                                                <?php
                                                }
                                            }
                                        ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="salary_type" id="salary_type" class="form-control">
                                        ...
                                        <option value="Montlhy" <?php if($salary_type == 'Montlhy'){ echo 'selected';} ?>>Montlhy</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-12">
