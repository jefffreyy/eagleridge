                ...
                <div class = "col-md-9">
                    <div class = "row">
                        <div class = "mini-nav">
                            ...
                            <a href = "<?=base_url()?>profile/documents" class = "mini-links active">Documents</a>
                    ...
                    <div class = "card border-0">
                        <div class = "card-title">Documents
                            <div class = "modal-btn">
                                ...
                                <button type = "button" class = "btn btn-primary" style="display: none;" data-toggle="modal" data-target="#modal_add_document"><i class="fas fa-plus mr-2"></i>Add Document</button>
                            </div>
                        </div>
