                ...
                <div class = "col-md-9">
                    <div class = "row">
                        <div class = "mini-nav">
                            ...
                            <a href = "<?=base_url()?>profile/emergency" class = "mini-links active">Emergency</a>
                            ...
                            if($DISP_EMER_INFO)
                            {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <h1 style="font-weight:600;margin-bottom: 10px;"><?= $ROW_EMER_INFO->name ?>
                                            <a style="display: none;" class="btn btn-sm indigo lighten-2 float-right text-danger EMERGENCY_BTN_DLT" delete_key="<?= $ROW_EMER_INFO->id ?>" employee_id="<?= $user_id ?>"><i class="fas fa-trash text-danger"></i></a>
                                            <a style="display: none;" class="btn btn-sm indigo lighten-2 float-right ml-2" DATA_ID="<?= $ROW_EMER_INFO->id ?>" title="Edit" data-toggle="modal" data-target="#modal_edit_emergency" ><i class="fas fa-edit"></i></a>
                                        </h1>
                                        
                                        <p class="mb-2">Relationship: <?= $ROW_EMER_INFO->relationship ?></p>
                                        <p class="mb-2">Mobile Number: <?= $ROW_EMER_INFO->mobile_number ?></p>
                                        <p class="mb-2">Work Phone: <?= $ROW_EMER_INFO->work_phone ?></p>
                                        <p class="mb-2">Home Phone: <?= $ROW_EMER_INFO->home_phone ?></p>
                                        <p class="mb-2">Current Address: <?= $ROW_EMER_INFO->current_address ?></p>
