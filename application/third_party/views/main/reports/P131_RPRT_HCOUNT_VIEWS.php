		...
		<div class="container-fluid p-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb" style = "background-color: transparent; padding: 0px;">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Headcount</li>
                </ol>
            </nav>
            <div class = "row">
                <div class = "col-md-6">
            ...
            <div class = "row">
                <div class = "col-md-9">
                    <div class="card" style = "padding: 40px 30px;">
                        <h5><b>What is the best headcount accross my workforce?</b></h5>
                ...
                <div class = "col-md-3">
                    <div class="card">
                        <div class = "num">0.0% <text style = "font-size: 16px;color: #aeaeae;">0 People<i class="fas fa-external-link-alt ml-4"></i></text></div>
                        <div class = "t-num">Average Turnover</div>
                        <hr>
                        <div class = "num">0.6% <text style = "font-size: 16px;color: #aeaeae;">8 People<i class="fas fa-external-link-alt ml-4"></i></text></div>
                        <div class = "t-num">Average Growth</div>
                    </div>
                </div>
            </div>
            <div class = "row">
