    ...
    <div class="p-3">
        <div class="flex-fill">
            <div class="row pr-3 mb-3">
                <div class="col">
                    <h1 class="page-title">Import Allowances</h1>
                </div>
            ...
            <div class="row mb-3">
                <div class="col-6">
                    <h1 class="page-title mb-0 " style="font-size: 20px;">Upload Employee Allowances</h1>
                </div>
                <div class="col-6">
                ...
                <div class="container mt-3 mb-3">
                    <div class="coud_upload">
                        <div class="donwloadFile">
                            <p class="ml-2 mr-2">Upload .csv format maximum of 10MB size. Download sample file format <i><a href="<?= base_url() ?>sample_file/Sample_allowances_format.csv" download>here.</a></i></p>
                        </div>
                        <form method='post' action='<?php echo base_url('csv/importAllowances'); ?>' enctype="multipart/form-data">
                            <div class="ml-2 mr-2">
                        ...
                        <p>
                            1. Please Enter the exact amount of allowance for each category - Daily, Pioneer, Group Leader, Skill, Load, Transportation<br>
