            ...
            <div class = "row">
                <div class = "col-md-5">
                    <div class="d-flex mb-3">
                        <input type="date" class="form-control" value="<?php if($this->input->get('date')){ echo $this->input->get('date');} ?>" id="search_date">
                        <a href="#" class="btn btn-primary ml-3" id="btn_filter">Filter</a>
                    </div>
                </div>
                <div class="col-md-7">
                    <div class="w-100">
                        <a href="#" class="btn btn-primary ml-3 float-right" next_day="<?= $next_date ?>" id="btn_filter_next">Next<i class="fas fa-angle-right ml-2"></i></a>
                        <a href="#" class="btn btn-primary ml-3 float-right" today="<?= $today ?>" id="btn_filter_today">Today</a>
                        <a href="#" class="btn btn-primary ml-3 float-right" prev_day="<?= $prev_date ?>" id="btn_filter_prev"><i class="fas fa-angle-left mr-2"></i> Prev</a>
                    </div>
                </div>
            </div>
            <div class = "row">
            ...
            <div class="row">
                        ...
                        ?>
                                    <div class="card-body empl_not_in_office" >
                                        <div class="d-flex">
                                            ...
                                            <div class="ml-2">
                                                <a href = "<?=base_url()?>employees/personal?id=<?= $employee[0]->id ?>"><?= $employee[0]->col_frst_name.' '.$employee[0]->col_last_name?></a>
                        ...
                        ?>
                            <div class="card-body empl_in_office">
                                <div class="d-flex">
                                    ...
                                    <div class="ml-2">
                                        <a href = "<?=base_url()?>employees/personal?id=<?= $employee1[0]->id ?>"><?= $employee1[0]->col_frst_name.' '.$employee1[0]->col_last_name?></a>
                        ...
                        ?>
                            <div class="card-body empl_out_of_office">
                                <div class="d-flex">
                                    ...
                                    <div class="ml-2">
                                        <a href = "<?=base_url()?>employees/personal?id=<?= $employee2[0]->id ?>"><?= $employee2[0]->col_frst_name.' '.$employee2[0]->col_last_name?></a>
                        ...
                        ?>
                            <div class="card-body empl_on_rest">
                                <div class="d-flex">
                                    ...
                                    <div class="ml-2">
                                        <a href = "<?=base_url()?>employees/personal?id=<?= $employee3[0]->id ?>"><?= $employee3[0]->col_frst_name.' '.$employee3[0]->col_last_name?></a>
                ...
                <div class="col-lg-15">
                    <div class="card">
                        ...
                        <?php 
                                $employee4 = $this->p020_emplist_mod->MOD_DISP_EMPLOYEE($DISP_ON_LEAVE_ROW->col_empl_id);
                        ?>
                            <div class="card-body empl_on_leave">
                                <div class="d-flex">
                                    ...
                                    <div class="ml-2">
                                        <a href = "<?=base_url()?>employees/personal?id=<?= $employee4[0]->id ?>"><?= $employee4[0]->col_frst_name.' '.$employee4[0]->col_last_name?></a>
                                        <p class="mb-0" style="font-size: 12px;"><?= $employee4[0]->col_empl_posi ?></p>
                                    </div>
                                    <div class="flex-fill">
                                        <div class="w-100">
                                            <div class="float-right text-center" style="height: 100%; width: 60px;">
                                                <p class="mb-0 text-bold" style="font-size: 12px;"><?= $DISP_ON_LEAVE_ROW->col_leave_type ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#btn_filter').click(function(){
                ...
                window.location.href = base_url+'attendance/daily_attendance?date='+search_date;
            })
