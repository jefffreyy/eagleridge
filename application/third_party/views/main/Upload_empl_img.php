        ...
        <div class="flex-fill">
            ...
            <div class="row pr-3 mb-3">
                ...
                <div class="col ml-auto pr-0">
                    ...
                    <a class="btn btn-primary float-right mt-1" title="Add" href="<?=base_url()?>csv">
            ...
            <div class="card">
                ...
                <div class="edit_profile_pic w-100 text-center mt-5">
                    ...
                    <img class="avatar" id="employee_img_modal" style="cursor: pointer;" width="300" height="300" src="<?php echo base_url().'user_images/default_profile_img3.png';?>">
