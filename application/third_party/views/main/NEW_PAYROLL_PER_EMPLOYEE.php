              ...
              <input type="hidden" value="0" name="comp_cont_pagibig" class="comp_cont_pagibig">
                ...
                <div class="row pr-3 mb-2">
                    ...
                    <div class="col-9 pt-1">
                        <button type="submit" class="btn btn-primary float-right text-white" id="btn_insert_payroll_data"><i class="fas fa-receipt"></i>&nbsp;&nbsp;&nbsp; Generate Payslip </button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-8">
                            ...
                            <div class="card-body" style="height: 324.5px;">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="col-12 d-flex">
                                        ...
                                        <select class="form-control mb-2" name="select_employee" id="select_employee" required>
                                            <option value="divide_by_30">Select Employee...</option>
                                            <?php 
                                            if($DISP_ALL_EMPLOYEES){
                                                foreach($DISP_ALL_EMPLOYEES as $DISP_ALL_EMPLOYEES_ROW){
                                                ?>
                                                <option value="<?= $DISP_ALL_EMPLOYEES_ROW->id ?>" <?php if($DISP_ALL_EMPLOYEES_ROW->id == $DISP_EMPLOYEE_ID){echo 'selected';} ?>> <?= $DISP_ALL_EMPLOYEES_ROW->col_empl_cmid ?></option>
                                                <?php
                                                }
                                            }
                                            ?>
                                    ...
                                    <div class="col-12 d-flex">
                                        ...
                                        <p id="employee_name">
                                            <?php
                                                if($DISP_EMPLOYEE_ID){
                                                    $employee_info = $this->p020_emplist_mod->MOD_DISP_EMPLOYEE($DISP_EMPLOYEE_ID);
                                                    echo $employee_info[0]->col_frst_name.' '.$employee_info[0]->col_last_name;
                                                }
                                            ?>
                                        </p>
                                        </div>
                                    ...
                                    <div class="col-12 d-flex">
                                        ...
                                        <div class="flex-fill" style="width: auto;">
                                        <input type="text" name="monthly_salary" id="monthly_salary" placeholder="Enter Monthly Salary" class="form-control ml-0" required>
                                        <!-- <p id="monthly_salary">30000</p> -->
                                        </div>
                                    </div>
                                    </div>
                                    <div class="row mt-2">
                                    <div class="col-12 d-flex">
                                        ...
                                        <select class="form-control mb-2" name="date_range" id="date_range" required>
                                            <option value="divide_by_30">Divide by 30</option>
                                            <option value="divide_by_26">Divide by 26</option>
                                            <option value="divide_by_24">Divide by 24</option>
                                            <option value="divide_by_22">Divide by 22</option>
                                            <option value="divide_by_20">Divide by 20</option>
                                            <option value="313_days">313 Days</option>
                                            <option value="261_days">261 Days</option>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="col-12 d-flex">
                                        ...
                                        <select name="payroll_period" class="form-control" id="cutoff_period" required>
                                            ...
                                            <?php
                                                ...
                                                ?>
                                                    <option value="<?= $DISP_PAYROLL_SCHED_ROW->id  ?>" <?php if($DISP_PAYROLL_SCHED_ROW->id == $DISP_PAYROLL_PERIOD){echo 'selected';} ?>><?= $DISP_PAYROLL_SCHED_ROW->name ?></option>
                                                <?php
                                                }
                                                }
                                            ?>
                                    ...
                                    <div class="col-12 d-flex">
                                        ...
                                        <div class="flex-fill" style="width: auto;">
                                        <input type="text" name="working_days" id="working_days" placeholder="# of Working Days" class="form-control ml-0" required>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="row mt-2">
                                    <div class="col-12 d-flex">
                                        ...
                                        <div class="flex-fill" style="width: auto;">
                                        <input type="text" name="work_hours" id="work_hours" placeholder="# of Work hours per day" value="8" class="form-control ml-0" required>
                                        </div>
                                    </div>
                                    </div>
                                </div>
                ...
                <div class="card">
                  <div class="card-body" style="min-height: 830px;">
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_reg_multiplier" disabled>
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_rest_multiplier" disabled>
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_spec_hol_multiplier" disabled>
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_spec_hol_rest_multiplier" disabled>
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_reg_hol_multiplier" disabled>
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_reg_hol_rest_multiplier" disabled>
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_double_hol_multiplier" disabled>
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_double_hol_rest_multiplier" disabled>
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_regular_ns_multiplier" disabled>
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_rest_ns_multiplier" disabled>
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_spec_hol_ns_multiplier" disabled>
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_spec_hol_rest_ns_multiplier" disabled>
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_reg_hol_ns_multiplier" disabled>
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_reg_hol_rest_ns_multiplier" disabled>
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_double_hol_ns_multiplier" disabled>
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_double_hol_rest_ns_multiplier" disabled>
                      ...
                      <div class="d-flex ml-1" style="margin-top: 88px;">
                          ...
                          <input type="text" class="form-control ml-1 text-right flex-fill" style="width: 190px;" value="0" id="total_basic_pay" disabled>
                      </div>
                  </div>
                  <!-- ./card-body -->
                </div>
                ...
                <div class="card">
                  <div class="card-body" style="min-height: 830px;">
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_reg_ot_multiplier">
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_rest_ot_multiplier">
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_spec_hol_ot_multiplier">
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_spec_hol_rest_ot_multiplier">
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_reg_hol_ot_multiplier">
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_reg_hol_rest_ot_multiplier">
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_double_hol_ot_multiplier">
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_double_hol_rest_ot_multiplier">
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_reg_ot_ns_multiplier">
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_rest_ot_ns_multiplier">
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_spec_hol_ot_ns_multiplier">
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_spec_hol_rest_ot_ns_multiplier">
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_reg_hol_ot_ns_multiplier">
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_reg_hol_rest_ot_ns_multiplier">
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_double_hol_ot_ns_multiplier">
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_double_hol_rest_ot_ns_multiplier">
                      ...
                      <div class="d-flex ml-1" style="margin-top: 25px;">
                          ...
                          <input type="text" class="form-control ml-1 text-right flex-fill" style="width: 190px;" value="0" id="total_overtime" disabled>
                      </div>
                  </div>
                  <!-- ./card-body -->
                </div>
                      ...
                      if($DISP_OTHER_TAXABLE_INCOME){
                        ?>
                          <div class="d-flex ml-1">
                              ...
                              <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="OTI_other1_multiplier">
                          ...
                          <div class="d-flex ml-1">
                              ...
                              <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="OTI_other2_multiplier">
                          ...
                          <div class="d-flex ml-1">
                              ...
                              <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="OTI_other3_multiplier">
                          ...
                          <div class="d-flex ml-1">
                              ...
                              <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="OTI_other4_multiplier">
                          ...
                          <div class="d-flex ml-1">
                              ...
                              <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="OTI_other5_multiplier">
                          ...
                          <div class="d-flex ml-1">
                              ...
                              <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="OTI_other6_multiplier">
                          ...
                          <div class="d-flex ml-1">
                              ...
                              <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="OTI_other7_multiplier">
                          ...
                          <div class="d-flex ml-1">
                              ...
                              <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="OTI_other8_multiplier">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex ml-1">
                        ...
                        <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_absent_multiplier">
                    ...
                    <div class="d-flex ml-1">
                        ...
                        <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="TI_late_undertime_multiplier">
                ...
                <div class="card">
                    <div class="card-body">
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="text" class="form-control ml-1 text-right flex-fill" style="width: 190px;" value="0" id="BP_total" disabled>
                      </div>
                      <div class="d-flex ml-1">
                          <p class="text-right mb-3 mt-1" style="font-size: 14px;width:250px;">Overtime: </p>
                          <input type="text" class="form-control ml-1 text-right flex-fill" style="width: 190px;" value="0" id="OT_total" disabled>
                      </div>
                      <div class="d-flex ml-1">
                          <p class="text-right mb-3 mt-1" style="font-size: 14px;width:250px;">Other Taxable Income: </p>
                          <input type="text" class="form-control ml-1 text-right flex-fill" style="width: 190px;" value="0" id="OTI_total" disabled>
                      </div>
                      <div class="d-flex ml-1">
                          <p class="text-right mb-3 mt-1" style="font-size: 14px;width:250px;">Absences / Tardiness / Undertime: </p>
                          <input type="text" class="form-control ml-1 text-right flex-fill" style="width: 190px;" value="0" id="ABS_total" disabled>
                      </div>
                      <br>
                      <div class="d-flex ml-1 mt-1">
                          <p class="text-right mb-3 mt-1 text-bold" style="font-size: 14px;width:250px;">Total Taxable Income: </p>
                          <input type="text" class="form-control ml-1 text-right flex-fill" style="width: 190px;" value="0" id="TI_total" disabled>
                      </div>
                    </div>
                </div>
              </div>
                ...
                <div class="card">
                  <div class="card-body">
                        ...
                        if($DISP_NON_TAXABLE_INCOME){
                          ?>
                            <div class="d-flex ml-1">
                                ...
                                <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="NTI_other1_multiplier">
                            ...
                            <div class="d-flex ml-1">
                                ...
                                <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="NTI_other2_multiplier">
                            ...
                            <div class="d-flex ml-1">
                                ...
                                <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="NTI_other3_multiplier">
                            ...
                            <div class="d-flex ml-1">
                                ...
                                <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="NTI_other4_multiplier">
                            ...
                            <div class="d-flex ml-1">
                                ...
                                <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="NTI_other5_multiplier">
                            ...
                            <div class="d-flex ml-1">
                                ...
                                <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="NTI_other6_multiplier">
                            ...
                            <div class="d-flex ml-1">
                                ...
                                <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="NTI_other7_multiplier">
                      ...
                      <div class="d-flex ml-1">
                          ...
                          <input type="text" class="form-control ml-1 text-right" style="width: 190px;" value="0" id="NTI_total" disabled>
                      </div>
                  </div>
                </div>
                <!-- ./card -->
              ...
              <div class="col-4">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex ml-1">
                        <input type="number" class="form-control ml-0 text-right flex-fill GOV_each_total  mb-2" style="width: 110px; font-size: 13px;" value="0" id="GROSS_TAX_total" disabled>
                    </div>
                    <hr>
                    ...
                    <div class="d-flex ml-1">
                        ...
                        <input type="number" class="form-control ml-1 text-right" style="width: 190px;" value="0" id="GOV_total" disabled>
                    </div>
                  </div>
                  <!-- ./card-body -->
                </div>
                ...
                <div class="card" style="height: 372px;">
                  <div class="card-body">
                    ...
                    <div class="d-flex ml-1">
                        ...
                        <input type="number" class="form-control ml-2 text-right flex-fill DED_each_total" style="width: 110px; font-size: 13px;" value="0" id="DED_salary_advances_total" disabled>
                    </div>
                      ...
                      if($DISP_DEDUCTIONS){
                        ?>
                          <div class="d-flex ml-1">
                              ...
                              <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="DED_other1_multiplier">
                          ...
                          <div class="d-flex ml-1">
                              ...
                              <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="DED_other2_multiplier">
                          ...
                          <div class="d-flex ml-1">
                              ...
                              <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="DED_other3_multiplier">
                          ...
                          <div class="d-flex ml-1">
                              ...
                              <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="DED_other4_multiplier">
                          ...
                          <div class="d-flex ml-1">
                              ...
                              <input type="number" class="form-control ml-2 text-right" style="width: 60px; font-size: 13px;" id="DED_other5_multiplier">
                    ...
                    <div class="row">
                        <div class="col-6">
                          ...
                          <div class="d-flex ml-1" style="display: none !important;;">
                              ...
                              <input type="number" class="form-control ml-2 text-right flex-fill" style="width: 110px; font-size: 13px;" value="0" id="OVR_total_OTI" disabled>
                          </div>
                          <div class="d-flex ml-1">
                              <p class="text-right mb-3 mt-1" style="font-size: 14px;width:150px;">Non-Taxable Income: </p>
                              <input type="number" class="form-control ml-2 text-right flex-fill" style="width: 110px; font-size: 13px;" value="0" id="OVR_total_NTI" disabled>
                          </div>
                        </div>
                        <div class="col-6">
                          <div class="d-flex ml-1">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-4">
                        <div class="d-flex ml-1">
                            <p class="text-right mb-3 mt-1" style="font-size: 14px;width:150px;">SSS: </p>
                            <input type="number" class="form-control ml-2 text-right flex-fill GOV_each_total" style="width: 110px; font-size: 13px;" value="0" id="GOV_CONT_EMPLYR_SSS_total" disabled>
                        </div>
                      </div>
                      <div class="col-4">
                        <div class="d-flex ml-1">
                            <p class="text-right mb-3 mt-1" style="font-size: 14px;width:150px;">PhilHealth: </p>
                            <input type="number" class="form-control ml-2 text-right flex-fill GOV_each_total" style="width: 110px; font-size: 13px;" value="0" id="GOV_CONT_EMPLYR_philhealth_total" disabled>
                        </div>
                      </div>
                      <div class="col-4">
                        <div class="d-flex ml-1">
                            <p class="text-right mb-3 mt-1" style="font-size: 14px;width:150px;">Pag-Ibig: </p>
                            <input type="number" class="form-control ml-2 text-right flex-fill GOV_each_total" style="width: 110px; font-size: 13px;" value="0" id="GOV_CONT_EMPLYR_pagibig_total" disabled>
                        </div>
                      </div>
                    </div>
                  </div>
...
<script>
  $(document).ready(function(){
    ...
    function save_to_db(){
      ...
      // $('input.reg_mul').val(reg_mul);
      // $('input.rest_mul').val(rest_mul);
      // $('input.sp_hol_mul').val(sp_hol_mul);
      // $('input.sp_hol_rest_mul').val(sp_hol_rest_mul);
      // $('input.reg_hol_mul').val(reg_hol_mul);
      // $('input.reg_hol_rest_mul').val(reg_hol_rest_mul);
      // $('input.dbl_hol_mul').val(dbl_hol_mul);
      // $('input.dbl_hol_rest_mul').val(dbl_hol_rest_mul);
      // $('input.reg_ns_mul').val(reg_ns_mul);
      // $('input.rest_ns_mul').val(rest_ns_mul);
      // $('input.sp_hol_ns_mul').val(sp_hol_ns_mul);
      // $('input.sp_hol_rest_ns_mul').val(sp_hol_rest_ns_mul);
      // $('input.reg_hol_ns_mul').val(reg_hol_ns_mul);
      // $('input.reg_hol_rest_ns_mul').val(reg_hol_rest_ns_mul);
      // $('input.dbl_hol_ns_mul').val(dbl_hol_ns_mul);
      // $('input.dbl_hol_rest_ns_mul').val(dbl_hol_rest_ns_mul);
      // $('input.total_bp').val(total_bp);
      
      // $('input.reg_ot_mul').val(reg_ot_mul);
      // $('input.rest_ot_mul').val(rest_ot_mul);
      // $('input.sp_hol_ot_mul').val(sp_hol_ot_mul);
      // $('input.sp_hol_rest_ot_mul').val(sp_hol_rest_ot_mul);
      // $('input.reg_hol_ot_mul').val(reg_hol_ot_mul);
      // $('input.reg_hol_rest_ot_mul').val(reg_hol_rest_ot_mul);
      // $('input.dbl_hol_ot_mul').val(dbl_hol_ot_mul);
      // $('input.dbl_hol_rest_ot_mul').val(dbl_hol_rest_ot_mul);
      // $('input.reg_ot_ns_mul').val(reg_ot_ns_mul);
      // $('input.rest_ot_ns_mul').val(rest_ot_ns_mul);
      // $('input.sp_hol_ot_ns_mul').val(sp_hol_ot_ns_mul);
      // $('input.sp_hol_rest_ot_ns_mul').val(sp_hol_rest_ot_ns_mul);
      // $('input.reg_hol_ot_ns_mul').val(reg_hol_ot_ns_mul);
      // $('input.reg_hol_rest_ot_ns_mul').val(reg_hol_rest_ot_ns_mul);
      // $('input.dbl_hol_ot_ns_mul').val(dbl_hol_ot_ns_mul);
      // $('input.dbl_hol_rest_ot_ns_mul').val(dbl_hol_rest_ot_ns_mul);
      // $('input.total_ot').val(total_ot);
      
      // $('input.oti_1_mul').val(oti_1_mul);
      // $('input.oti_2_mul').val(oti_2_mul);
      // $('input.oti_3_mul').val(oti_3_mul);
      // $('input.oti_4_mul').val(oti_4_mul);
      // $('input.oti_5_mul').val(oti_5_mul);
      // $('input.oti_6_mul').val(oti_6_mul);
      // $('input.oti_7_mul').val(oti_7_mul);
      // $('input.oti_8_mul').val(oti_8_mul);
      // $('input.total_oti').val(oti_total);

      // $('input.abs_mul').val(abs_mul);
      // $('input.late_mul').val(late_mul);
      // $('input.total_abs').val(abs_total);
      
      // $('input.ti_total').val(ti_total);

      // $('input.nti_1_mul').val(nti_1_mul);
      // $('input.nti_2_mul').val(nti_2_mul);
      // $('input.nti_3_mul').val(nti_3_mul);
      // $('input.nti_4_mul').val(nti_4_mul);
      // $('input.nti_5_mul').val(nti_5_mul);
      // $('input.nti_6_mul').val(nti_6_mul);
      // $('input.nti_7_mul').val(nti_7_mul);
      // $('input.nti_total').val(nti_total);

      // $('input.gross_ti').val(gross_ti);
      // $('input.gov_wtax').val(gov_wtax);
      // $('input.gov_sss').val(gov_sss);
      // $('input.gov_philhealth').val(gov_philhealth);
      // $('input.gov_pagibig').val(gov_pagibig);
      // $('input.gov_total').val(gov_total);

      // $('input.loan_sss_salary').val(loan_sss_salary);
      // $('input.loan_sss_calamity').val(loan_sss_calamity);
      // $('input.loan_hdmf_salary').val(loan_hdmf_salary);
      // $('input.loan_hdmf_calamity').val(loan_hdmf_calamity);
      // $('input.loan_company').val(loan_company);
      // $('input.loan_total').val(loan_total);

      // $('input.ded_salary_adv').val(ded_salary_adv);
      // $('input.ded_1_mul').val(ded_1_mul);
      // $('input.ded_2_mul').val(ded_2_mul);
      // $('input.ded_3_mul').val(ded_3_mul);
      // $('input.ded_4_mul').val(ded_4_mul);
      // $('input.ded_5_mul').val(ded_5_mul);
      // $('input.ded_total').val(ded_total);

      // $('input.ovr_total_ti').val(ovr_total_ti);
      // $('input.ovr_total_oti').val(ovr_total_oti);
      // $('input.ovr_total_nti').val(ovr_total_nti);
      // $('input.ovr_total_ded').val(ovr_total_ded);
      // $('input.ovr_total_gov').val(ovr_total_gov);
      // $('input.ovr_total_loan').val(ovr_total_loan);

      // $('input.net_pay').val(net_pay);
      // $('input.comp_cont_sss').val(comp_cont_sss);
      // $('input.comp_cont_philhealth').val(comp_cont_philhealth);
      // $('input.comp_cont_pagibig').val(comp_cont_pagibig);
    }
