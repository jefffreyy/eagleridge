...
class messages extends CI_Controller
{
  ...
  {
    $data["Modules"]    =  array(
      array("title" => "SMS Message","value" => "SMS Message", "icon" => "fa-duotone fa-comment-sms","url" => "messages/sms_messages","access" => "SMS", "id" => "sms_messages"),
      array("title" => "Contacts","value" => "Contacts", "icon" => "fa-duotone fa-book-user","url" => "messages/sms_messages","access" => "SMS", "id" => "sms_messages"),
    );
    $data["title_page"]                 = "Messaging";
