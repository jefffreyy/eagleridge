...
class performances extends CI_Controller
{
  ...
  function edit_row(){
    ...
    $this->logger->log_activity($this->session->userdata('SESS_USER_ID'), 'Edited performance record');
  ...
  function add_row(){
    ...
    $this->logger->log_activity($this->session->userdata('SESS_USER_ID'), 'Added performance record');
    $this->session->set_userdata('success', 'Submitted Successfully!');
    redirect($module_name . "/" . $page_name);
  }
  function delete_row(){
    ...
    $this->logger->log_activity($this->session->userdata('SESS_USER_ID'), 'Deleted performance record');
  ...
  function edit_bulk_status(){
    ...
    $this->logger->log_activity($this->session->userdata('SESS_USER_ID'), 'Updated performance bulk status');
    $this->session->set_userdata('success', 'Submitted Successfully!');
    //  var_dump($ids_int);
