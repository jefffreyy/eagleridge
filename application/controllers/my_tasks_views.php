        ...
        <div class="container-fluid p-4">
            ...
            <div class="row pt-1">
                ...
                <div class="col-md-6 button-title">
                    ...
                    <a href="<?= base_url('selfservices/request_task') ?>" class=" btn btn-primary shadow-none rounded d-flex align-items-center" ">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" <?= $hide_eye ?>>
                                                <div class="action_btn">
                                                    <form action="<?= base_url('main_table_02/show_data'); ?>" method="post">
                                                        ...
                                                        <button type="submit" class="select_edit_row" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important" row_id="<?= $id_raw ?>">
                                                            ...
                                                            <!-- <i class="far fa-eye" id="view"></i> -->
                                                        </button> <!--<i class="far fa-edit" id="edit"></i> -->
                                                    </form>
                                                    <?php
                                                    $hide = "";
                                                    $hide_action = "";
                                                    ...
                                                    ?>
                                                    <a href='<?= base_url('selfservices/edit_task/' . $id_raw) ?>' class="select_edit_row" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important">
