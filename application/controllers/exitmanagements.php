...
ob_start();
class exitmanagements extends CI_Controller
{
  ...
  function index(){
    $data["Modules"]=  array(  
      array("title"=>"Resignation",    "value"=>"Resignation",    "icon"=>"far fa-edit",         "url"=>"exitmanagements/resignations",   "access"=>"Exit Management"),
      array("title"=>"Offboarding",    "value"=>"Offboarding",    "icon"=>"fas fa-sign-out-alt", "url"=>"exitmanagements/off_boardings",  "access"=>"Exit Management"),
      array("title"=>"Clearance",      "value"=>"Clearance",      "icon"=>"fas fa-users",        "url"=>"exitmanagements/clearances",     "access"=>"Exit Management"),
      array("title"=>"Exit Interview", "value"=>"Exit Interview", "icon"=>"fas fa-user-minus",   "url"=>"exitmanagements/exit_interview", "access"=>"Exit Management"),
    );
    $data["title_page"]           = "Exist Management Module";
  ...
  function resignations(){
    ...
    $data["module_name"]      = $module       = 'exitmanagements';
    $data["page_name"]        = $page_name    = 'supports';
    $data["model_name"]       = $model        = "main_table_01_model";
    $data["table_name"]       = $table        = "tbl_hr_supports";
    $data["module"]           = ["https://testhr.technos.app/exitmanagements","Exit Managements", "Resignations"];         // Main Menu Path, Module, Page Title
    $data["id_prefix"]        = "WRN";
    $data["excel_output"]     = [true,"resignations.xlsx"];                                                       // Enable, File Name
    $data["add_button"]       = [true,"Add Resignation"];                                                                 // Enable, Button Name modal_add_enable   = true;
