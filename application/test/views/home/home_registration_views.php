...
<style>
    ...
    *{
    ...
    .cursor-line {
      ...
      display: none; /* Initially hidden until an input field is focused */
    }
...
<!-- <body style="display: flex; justify-content: center; align-items: center;margin: 0;">
    <div class="container">
        ...
        <br>
        <div style="width:100vw; height:30vh; background-color: #B8CBE9;">
            <div class="row">
...
<form action="<?= base_url().'home/createNewUser'?>" method="post" id="registration_form">
  ...
  <!-- <input class="input-field" style="width: 100px; height: 56px; left: 1388px; top: 239px; position: absolute; background: white; border-radius: 10px; border: 0.50px black solid" name="suffix" placeholder="Suffix (name)"> -->
  ...
  <!-- <input class="input-field" style="width: 250px; height: 56px; left: 633px; top: 310px; position: absolute; background: white; border-radius: 10px; border: 0.50px black solid" name="month" placeholder="Month"> -->
  ...
  <!-- <input class="input-field" style="width: 230px; height: 56px; left: 898px; top: 310px; position: absolute; background: white; border-radius: 10px; border: 0.50px black solid" name="day" placeholder="Day"> -->
  ...
  <!-- <input class="input-field" style="width: 230px; height: 56px; left: 1143px; top: 310px; position: absolute; background: white; border-radius: 10px; border: 0.50px black solid" name="year" > -->
 ...
 <!-- <div style="width: 300px; height: 60px; left: 810px; top: 525px; position: absolute; background: #92D050; border-radius: 20px"></div> -->


 <!-- <a href="<?= base_url() ?>home/selectoption">
  <div style="width: 200px; height: 37px; left: 860px; top: 623; position: absolute; text-align: center; color: white; font-size: 30px; font-family: Lato; font-weight: 700; word-wrap: break-word">Submit</div>
  </a> -->
</form>
    ...
    if (activeInputField) {
      ...
      if (key.textContent === 'BACKSPACE') {
        ...
        activeInputField.value = '';
         ...
         // Move to the next input field when Next button is clicked
      ...
      //moveCursorLine(width); // Move the cursor line to the new position
    }
  });
});
...
inputFields.forEach(inputField => {
  inputField.addEventListener('focus', () => {
    ...
    //moveCursorLine(width); // Move the cursor line to the initial position
  });
});
...
document.addEventListener('click', event => {
  // Detect click outside input field to clear the activeInputField
  ...
  if (!clickedInsideInput && !Array.from(keys).includes(event.target) ) {
    ...
    cursorLine.style.display = 'none'; // Hide the cursor line when no input field is focused
  }
});
