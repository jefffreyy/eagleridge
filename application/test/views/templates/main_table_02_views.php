        ...
        <div class="container-fluid p-4">
            ...
            <div class="row pt-1">
                ...
                <div class="col-md-6 button-title">
                    ...
                    <form action="<?= base_url('main_table_02/add_data'); ?>" class="<?=isset( $C_BUTTON_ADD) ? 'd-none' : '' ?>" method="post" >
                ...
                <?php if(isset($C_BUTTON_ADD)) { ?>
                    <a href="<?=$C_BUTTON_ADD['path']?>"  class=" btn technos-button-green shadow-none rounded"><i class="fas fa-plus"></i>&nbsp;<?=  $C_BUTTON_ADD['title']?></a>
                <?php } ?>
                                ...
                                foreach ($C_DATA_TABLE as $C_DATA_TABLE_ROW) {
                                    ...
                                    foreach ($C_DB_DESIGN as $C_DB_DESIGN_ROW) {
                                        ...
                                        if($table_display == true) {
                                            ...
                                            if($parameter != "status"){?>
                                                <td class="text-center"  style="width:<?= $table_width?>%"><?= isset($column_data) ?  is_numeric($column_data)? sprintf("%.2f", $column_data ) : $column_data : "" ?></td>
                                            <?php }
                                            else{?>
                            ...
                            ?>
                                    ...
                                    ?>
                                        ...
                                        <td class="text-center" <?=$hide_eye?>>
                                            ...
                                            <!-- <a class = "select_edit_row p-2 edit_data_id"  href="<?php echo base_url('main_table_02/edit_data?'.$url_edit_encrypted);  ?>"  style ="color: gray; cursor: pointer; !important" row_id="<?= $id_raw ?>"><i class="far fa-edit" id="edit"></i></a> -->
                                            ...
                                            <div class="action_btn">
                                                ...
                                                <form action="<?= base_url('main_table_02/show_data'); ?>" method="post" >
                                                    ...
                                                    <button type="submit" class = "select_edit_row"  style ="background-color: transparent; border: none;color: gray; cursor: pointer; !important" row_id="<?= $id_raw ?>"><i class="far fa-eye" id="view"></i></button>  <!--<i class="far fa-edit" id="edit"></i> -->
                                                </form>
                                                <?php 
                                                    $hide ="";
                                                    $hide_action ="";
                                                ...
                                                <form action="<?= base_url('main_table_02/edit_data'); ?>" method="post" <?= $hide_action ?> <?=$hide?>>
                                                    ...
                                                    <button type="submit" class = "select_edit_row"  style ="background-color: transparent; border: none;color: gray; cursor: pointer; !important" row_id="<?= $id_raw ?>"><i class="far fa-edit" id="edit"></i></button>  <!--<i class="far fa-edit" id="edit"></i> -->
                                                </form>
                                            </div>
                                        </td>
                                    </tr>
