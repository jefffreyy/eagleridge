...
$raw_input_2 = str_replace("edit_data?", "", $raw_input);
...
<body>
        ...
        <div class="container-fluid p-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Edit&nbsp;<?= $page_title ?>
                    </li>
                </ol>
            </nav>
                                    ...
                                    foreach ($output_design as $output_design_row) {
                                        ...
                                        if ($edit_display == 1) {
                                            ...
                                            if ($parameter == "id") { 
                                                $output = $id_prefix . str_pad($output, 5, '0', STR_PAD_LEFT);?>
                                                 <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="input_<?= $column ?>" id="input_<?= $column ?>" <?php echo ($edit_enable) ? "enabled" : "disabled"; ?> value= <?= $output ?>>
                                                </div>
                                            <?php
                                            ...
                                            <?php
                                                ...
                                                <div class="form-group">
                                                    <label class="" for="input_<?= $column ?>"><?= $label ?></label>
                                                    <textarea name="<?= $column ?>" class="form-control" id="input_<?= $column ?>" rows="4" cols="50" <?php echo ($edit_enable) ? "enabled" : "disabled"; ?> ><?= $output ?></textarea>
                                                </div>
                                            <?php
                                            } else if ($parameter == "number") { ?>
                                                <div class="form-group">
                                                    <label class="" for="input_<?= $column ?>"><?= $label ?></label>
                                                    <input type="number" min="0" class="form-control" name="input_<?= $column ?>" id="input_<?= $column ?>" <?php echo ($edit_enable) ? "enabled" : "disabled"; ?> value=<?= $output ?>>
                                                </div>
                                            <?php
                                            } else if ($parameter == "attachment") { ?>
                                                <div class="form-group">
                                                    <label class="" for="input_<?= $column ?>"><?= $label ?></label>
                                                    <!-- <input type="file" class="form-control" name="input_<?= $column ?>" id="input_<?= $column ?>" <?php echo ($edit_enable) ? "enabled" : "disabled"; ?> value= <?= $output ?>> -->
                                                    <!-- <input type="file" class="form-control" name="input_<?= $column ?>" id="input_<?= $column ?>"  <?php echo ($edit_enable) ? "enabled" : "disabled"; ?>style="display:none;"/> -->
                                                    <input type="text" class="form-control" name="input_<?= $column ?>" id="input_<?= $column ?>" value="<?= $output ?>" <?php echo ($edit_enable) ? "enabled" : "disabled"; ?>  hidden/>
                                            ...
                                            <?php
                                                ...
                                                <div class="form-group">
                                                    <label class="" for="input_<?= $column ?>"><?= $label ?></label>
                                                    <input type="date" class="form-control" name="input_<?= $column ?>" id="input_<?= $column ?>" <?php echo ($edit_enable) ? "enabled" : "disabled"; ?> value= <?= $output ?>>
                                                </div>
                                            <?php
                                            } else if ($parameter == "time") { ?>
                                                <div class="form-group">
                                                    <label class="" for="input_<?= $column ?>"><?= $label ?></label>
                                                    <input type="time" class="form-control" name="input_<?= $column ?>" id="input_<?= $column ?>" <?php echo ($edit_enable) ? "enabled" : "disabled"; ?> value= <?= $output ?>>
                                                </div>
                                            <?php
                                            } else if ($parameter == "datetime") { ?>
                                                <div class="form-group">
                                                    <label class="" for="input_<?= $column ?>"><?= $label ?></label>
                                                    <input type="datetime-local" class="form-control" name="input_<?= $column ?>" id="input_<?= $column ?>" <?php echo ($edit_enable) ? "enabled" : "disabled"; ?> value= <?= str_replace(" ","T",$output)?>>
                                                </div>
                                            <?php
                                                ...
                                                if ($setting == "self"){?>
                                                    <select class="form-control" name="input_<?= $column ?>" id="input_<?= $column ?>" <?php echo ($edit_enable) ? "enabled" : "disabled"; ?>>
                                            ...
                                            <?php
                                                ...
                                                <div class="form-group">
                                                    <select class="form-control" name="input_<?= $column ?>" id="input_<?= $column ?>" <?php echo ($edit_enable) ? "enabled" : "disabled"; ?>>
                                                        <?php if($add_required == 0 && $output == 0){ ?><option value=0 selected>No Option Selected</option><?php } ?>
                                                        <?php if($setting == "array1"){ foreach ($array1_str as $array1_row) { ?>
                                                            <option value=<?= $array1_row["id"] ?> <?php echo ($array1_row["id"] == $output) ? "selected" : ""; ?>><?= $array1_row["name"] ?></option>
                                                        <?php }} ?>

                                                        <?php if($setting == "array2"){ foreach ($array2_str as $array2_row) { ?>
                                                            <option value=<?= $array2_row["id"] ?> <?php echo ($array2_row["id"] == $output) ? "selected" : ""; ?>><?= $array2_row["name"] ?></option>
                                                        <?php }} ?>

                                                        <?php if($setting == "array3"){ foreach ($array3_str as $array3_row) { ?>
                                                            <option value=<?= $array3_row["id"] ?> <?php echo ($array3_row["id"] == $output) ? "selected" : ""; ?>><?= $array3_row["name"] ?></option>

                                                        <?php }} ?>

                                                        <?php if($setting == "array4"){ foreach ($array4_str as $array4_row) { ?>
                                                            <option value=<?= $array4_row["id"] ?> <?php echo ($array4_row["id"] == $output) ? "selected" : ""; ?>><?= $array4_row["name"] ?></option>
                                                        <?php }} ?>

                                                        <?php if($setting == "array5"){ foreach ($array5_str as $array5_row) { ?>
                                                            <option value=<?= $array5_row["id"] ?> <?php echo ($array5_row["id"] == $output) ? "selected" : ""; ?>><?= $array5_row["name"] ?></option>
                                                        <?php }} ?>
                                                    </select>
                                                </div>
                                            <?php
    ...
    <script>
        $(document).ready(function() {
            ...
            echo "var edit_data = " . $js_array . ";";
            ?>
            $("#btn_edit").on("click", function() {

                var col0 = [edit_data.map(d => d[0]), edit_data.map(d => d[4])];
                ...
                output.forEach(function(output_row) {
                    if (output_row[1] == 1 && isExit == 0) {
                        ...
                        if($("#input_" + output_row[0]).val() == "" && output_row[0] != 'remarks' && output_row[0] != 'attachment' && output_row[0] != 'reason' && output_row[0] != 'feedback' && output_row[0] != 'comment'){
                ...
                if(isExit == 0){
                    element_Id += '&table=' + '<?php echo ($table_name) ?>' + '&id=' + '<?php echo ($output_data["id"]) ?>';
                    document.location.href = "edit_row?" + element_Id + "&module=" + '<?php echo ($module_name) ?>' + "&page=" + '<?php echo ($page_name) ?>';
                }
            })
        })
    </script>
