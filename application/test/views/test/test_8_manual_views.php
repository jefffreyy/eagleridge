  ...
  ?>
    ...
    <?php } else { ?>
      ...
      <div style="width: 850px; height: 600px; left: 535px; top: 50px; position: absolute">
        ...
        <div style="width: 168px; height: 36px; left: 70px; top: 232px; position: absolute; color: #070707; font-size: 30px; font-family: Lato; font-weight: 400; word-wrap: break-word">Glucose</div>
