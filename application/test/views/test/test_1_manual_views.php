  ...
  ?>
    ...
    <?php } else { ?>
      ...
      <div style="width: 850px; height: 600px; left: 535px; top: 50px; position: absolute">
        ...
        <form action="<?= base_url() ?>test/insert_waist_hip/" method="post"> 
          ...
          <div style="width: 168px; height: 36px; left: 70px; top: 232px; position: absolute; color: #070707; font-size: 30px; font-family: Lato; font-weight: 400; word-wrap: break-word">Waist</div>
          <div style="width: 168px; height: 36px; left: 70px; top: 306px; position: absolute; color: #070707; font-size: 30px; font-family: Lato; font-weight: 400; word-wrap: break-word">Hip</div>
          ...
          <div style="width: 94px; height: 36px; left: 747px; top: 306px; position: absolute; color: #070707; font-size: 30px; font-family: Lato; font-weight: 400; word-wrap: break-word">cm</div>
          <input class="input-field" type="text" step="0.01" style="width: 471px; height: 56px; left: 256px; top: 225px; position: absolute; background: white; border-radius: 10px; border: 0.50px black solid" name="waist_value" placeholder="Enter Waist">
          <input class="input-field" type="text" step="0.01" style="width: 471px; height: 56px; left: 256px; top: 299px; position: absolute; background: white; border-radius: 10px; border: 0.50px black solid" name="hip_value" placeholder="Enter Hip">
