...
<div style="width: 1920px; height: 1080px; position: relative">
  ...
  <div style="width: 1000px; height: 410px; left: 880px; top: 185px; position: absolute">
    ...
    <div style="width: 960px; height: 325px; left: 20px; top: 65px; position: absolute">
      ...
      <div style="left: 451px; top: 130px; position: absolute; text-align: right; color: black; font-size: 36px; font-family: Lato; font-weight: 700; word-wrap: break-word"><?= $waist_hip_ration ?></div>
      ...
      <div style="left: 22px; top: 18px; position: absolute; color: black; font-size: 24px; font-family: Lato; font-weight: 500; word-wrap: break-word">Waist-Hip Ratio</div>
      <!-- <div style="left: 400px; top: 155px; position: absolute; font-size: 30px"><i class="fa-solid fa-up-long fa-fade fa-2xl" style="color: #ff0000;"></i></div> -->
      <div style="left: 400px; top: 155px; position: absolute; font-size: 30px"><i class="fa-solid fa-down-long fa-fade fa-2xl" style="color: #ff0000;"></i></div>
  ...
  <div style="width: 1000px; height: 410px; left: 878px; top: 630px; position: absolute">
    ...
    <div style="width: 568px; height: 132px; left: 216px; top: 162px; position: absolute">
      <div style="left: 52px; top: 0px; position: absolute; text-align: right; color: black; font-size: 36px; font-family: Lato; font-weight: 700; word-wrap: break-word">≤ 90</div>
      <div style="left: 444px; top: 0px; position: absolute; text-align: right; color: black; font-size: 36px; font-family: Lato; font-weight: 700; word-wrap: break-word">> 90</div>
      ...
      <div style="width: 176px; left: 392px; top: 103px; position: absolute; text-align: center; color: #FF0000; font-size: 24px; font-family: Lato; font-weight: 700; word-wrap: break-word">Central Obesity</div>
    </div>
