  ...
  ?>
    ...
    <?php } else { ?>
      ...
      <div style="width: 850px; height: 600px; left: 535px; top: 50px; position: absolute">
        ...
        <form action="<?= base_url() ?>test/insert_height_weight/" method="post">
          ...
          <div style="width: 168px; height: 36px; left: 70px; top: 232px; position: absolute; color: #070707; font-size: 30px; font-family: Lato; font-weight: 400; word-wrap: break-word">Height</div>
          <div style="width: 168px; height: 36px; left: 70px; top: 306px; position: absolute; color: #070707; font-size: 30px; font-family: Lato; font-weight: 400; word-wrap: break-word">Weight</div>
          ...
          <div style="width: 94px; height: 36px; left: 747px; top: 232px; position: absolute; color: #070707; font-size: 30px; font-family: Lato; font-weight: 400; word-wrap: break-word">cm</div>
          <div style="width: 94px; height: 36px; left: 747px; top: 306px; position: absolute; color: #070707; font-size: 30px; font-family: Lato; font-weight: 400; word-wrap: break-word">kg</div>
          <input class="input-field" type="text" step="0.01" style="width: 471px; height: 56px; left: 256px; top: 225px; position: absolute; background: white; border-radius: 10px; border: 0.50px black solid" name="height_value" placeholder="Enter Height">
          <input class="input-field" type="text" step="0.01" style="width: 471px; height: 56px; left: 256px; top: 299px; position: absolute; background: white; border-radius: 10px; border: 0.50px black solid" name="weight_value" placeholder="Enter Weight">
    ...
    key.addEventListener('click', () => {
      if (activeInputField) {
        ...
        if (key.textContent === 'BACKSPACE') {
          ...
          activeInputField.value = sanitizeInput(newValue);
          activeInputField.selectionStart = currentPosition + 1;
          activeInputField.selectionEnd = currentPosition + 1;
        }
