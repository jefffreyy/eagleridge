  ...
  ?>
    ...
    <?php } else { ?>
      ...
      <div style="width: 850px; height: 600px; left: 535px; top: 50px; position: absolute">
        ...
        <div style="width: 168px; height: 36px; left: 60px; top: 232px; position: absolute; color: #070707; font-size: 30px; font-family: Lato; font-weight: 400; word-wrap: break-word">Oxygen</div>
        <div style="width: 168px; height: 36px; left: 60px; top: 306px; position: absolute; color: #070707; font-size: 30px; font-family: Lato; font-weight: 400; word-wrap: break-word">Pulse</div>
        ...
        <div style="width: 94px; height: 36px; left: 690px; top: 232px; position: absolute; color: #070707; font-size: 30px; font-family: Lato; font-weight: 400; word-wrap: break-word">SpO2</div>
        <div style="width: 94px; height: 36px; left: 690px; top: 306px; position: absolute; color: #070707; font-size: 30px; font-family: Lato; font-weight: 400; word-wrap: break-word">bpm</div>
        <div style="width: 471px; height: 56px; left: 200px; top: 225px; position: absolute; background: white; border-radius: 10px; border: 0.50px black solid"></div>
        <div style="width: 471px; height: 56px; left: 200px; top: 299px; position: absolute; background: white; border-radius: 10px; border: 0.50px black solid"></div>
