        ...
        <div class="container-fluid p-4">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Zkteco Code
                    </li>
                </ol>
            </nav>
            ...
            <div class="row  pt-1"> <!-- Title starts -->
                <div class="col-md-6">
                    <h1 class="page-title">Zkteco Code</h1>
                </div>
            ...
            <div class="row mb-4"><!-- Filter Starts -->
                ...
                <div class="col-md-2">
                    ...
                    <a href=<?= base_url() . "attendances/zkteco_code" ?> id="btn_clear_filter" class="col btn btn-secondary mx-1">Clear Filter</a>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered m-0" id="TableToExport" style="width:100%">
                            <thead>
                                ...
                                <th class="text-center " style="background:#f6d6ff;">Code</th>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 1px;">
                                                ...
                                                <form class="bg-transparent" style="padding: 1px;">
                                                    <input type="hidden" id="employee_id" name="employee_id" value="<?= $DISP_EMP_LIST_ROW->id ?>">
                                                    <input type="hidden" id="employee_data" name="employee_data" value="<?= $DISP_EMP_LIST_ROW->col_empl_cmid ?>">
                                                    <input type="number" class="form-control code_val" default="<?= $DISP_EMP_LIST_ROW->empl_code?>"  id="code_val" name="code_val"  value="<?= $DISP_EMP_LIST_ROW->empl_code ?>" >
                                                </form>
                                            </td>
                                        <?php } ?>
                                        </tr>
