    ...
    <div class="container-fluid p-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add&nbsp;Overtime Requests </li>
            </ol>
        </nav>
                    ...
                    <div class="modal-body pb-5" data-select2-id="select2-data-8-pzx8">
                        <div class="row" data-select2-id="select2-data-7-j021">
                            <div class="col-md-12" data-select2-id="select2-data-6-dmol">
                                <?php echo form_open('attendances/add_new_overtime'); ?>
                            ...
                            <?php } ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" required class="form-control" name="date_ot" id="input_date_ot"
                                        enabled="" value="">
                                </div>
                                <div class="form-group">
