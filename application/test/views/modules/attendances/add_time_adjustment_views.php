        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="https://dev-env.eyebox.app/attendances">Attendance</a>
                </li>
                <li class="breadcrumb-item">
                    <a href="https://dev-env.eyebox.app/attendances/time_adjustment_lists">Time Adjustment List</a>
                </li>
                        ...
                        <?php } ?>
                            ...
                            <?php } ?>
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <input type="date" required class="form-control" name="date_adjustment"
                                        id="input_date_adjustment" enabled="" value="">
                                </div>
                                <label class="">Shift Type</label>
                                <div class="form-group">
                                    <select class="form-control" name="shift_type" id="input_shift_type"
                                        enabled="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="time" required class="form-control" name="time_out_1"
                                        id="input_time_out_1" enabled="" value="">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="time" required class="form-control" name="time_out_2"
                                        id="input_time_out_2" enabled="" value="">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="reason" class="form-control" id="input_reason" rows="4" cols="50"
                                        enabled=""></textarea>
                                </div>
