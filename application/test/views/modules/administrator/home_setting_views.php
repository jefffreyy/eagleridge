    ...
    <div class="p-3">
        <div class="flex-fill">
            ...
            <div class="row">
                <!-- Title Text -->
                <div class="col-md-6">
                    <h1 class="page-title">Home Settings<h1>
                </div>
            ...
            <div class="row">
                ...
                <div class="card col-xl col-lg-4 col-md-6 col-12 mr-2">
                    <form action="<?php echo base_url().'administrators/update_status/'.$HOME_LEAVE["id"];?>" id="" method="post" accept-charset="utf-8" autocomplete='off' class="m-2" enctype="multipart/form-data">
                        <div class="card-header mt-0">
                            <strong> Leave Information </strong>
                        </div>
                        <div class="card-body d-flex justify-content-center">
                            <label class="switch">
                                <input class="switch_on" type="checkbox" <?= $HOME_LEAVE["value"]==1 ? 'checked': ""?> name="check_status">
                                <span class="slider round" id="leave_information"></span>
                            </label>
                            <!-- <h5 class="card-title">Special title treatment</h5> -->
                            <!-- <a href="#" class="btn btn-primary">Go somewhere</a> -->
                        </div>
