    ...
    <div class="p-3">
        <div class="flex-fill">
            ...
            <div class="row">
                <!-- Title Text -->
                <div class="col-md-6">
                    <h1 class="page-title">Company Structure Settings<h1>
                </div>
                    ...
                    <form action="<?php echo base_url().'administrators/update_setting';?>"  method="post" accept-charset="utf-8" class="p-0" >
                        ...
                        <div class="card-body d-flex justify-content-center">
                            <label class="switch p-0">
                                ...
                                <input class="switch_on p-0" type="checkbox" <?= $C_COM_STRUCTURE[32]->value == '1' ? 'checked' : '';?> name="check_status" onchange="this.form.submit()" >
                    ...
                    <form action="<?php echo base_url().'administrators/update_setting';?>"  method="post" accept-charset="utf-8" class="p-0" >
                        ...
                        <div class="card-body d-flex justify-content-center">
                            <label class="switch p-0">
                                ...
                                <input class="switch_on p-0" type="checkbox" <?= $C_COM_STRUCTURE[33]->value == '1' ? 'checked' : '';?> name="check_status" onchange="this.form.submit()" >
                    ...
                    <form action="<?php echo base_url().'administrators/update_setting';?>"  method="post" accept-charset="utf-8" class="p-0" >
                        ...
                        <div class="card-body d-flex justify-content-center">
                            <label class="switch p-0">
                                ...
                                <input class="switch_on p-0" type="checkbox" <?= $C_COM_STRUCTURE[34]->value == '1' ? 'checked' : '';?> name="check_status" onchange="this.form.submit()" >
                    ...
                    <form action="<?php echo base_url().'administrators/update_setting';?>"  method="post" accept-charset="utf-8" class="p-0" >
                        ...
                        <div class="card-body d-flex justify-content-center">
                            <label class="switch p-0">
                                ...
                                <input class="switch_on p-0" type="checkbox" <?= $C_COM_STRUCTURE[35]->value == '1' ? 'checked' : '';?> name="check_status" onchange="this.form.submit()" >
                    ...
                    <form action="<?php echo base_url().'administrators/update_setting';?>"  method="post" accept-charset="utf-8" class="p-0" >
                        ...
                        <div class="card-body d-flex justify-content-center">
                            <label class="switch p-0">
                                ...
                                <input class="switch_on p-0" type="checkbox" <?= $C_COM_STRUCTURE[36]->value == '1' ? 'checked' : '';?> name="check_status" onchange="this.form.submit()" >
                    ...
                    <form action="<?php echo base_url().'administrators/update_setting';?>"  method="post" accept-charset="utf-8" class="p-0" >
                        ...
                        <div class="card-body d-flex justify-content-center">
                            <label class="switch p-0">
                                ...
                                <input class="switch_on p-0" type="checkbox" <?= $C_COM_STRUCTURE[37]->value == '1' ? 'checked' : '';?> name="check_status" onchange="this.form.submit()" >
                    ...
                    <form action="<?php echo base_url().'administrators/update_setting';?>"  method="post" accept-charset="utf-8" class="p-0" >
                        ...
                        <div class="card-body d-flex justify-content-center">
                            <label class="switch p-0">
                                ...
                                <input class="switch_on p-0" type="checkbox" <?= $C_COM_STRUCTURE[38]->value == '1' ? 'checked' : '';?> name="check_status" onchange="this.form.submit()" >
