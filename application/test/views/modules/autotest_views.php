...
<body>
                    ...
                    <table class="table table-hover m-0" id="TableToExport" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Total Number of Success</th>
                                <th class="text-center">Total Number of Failed</th>
                            </tr>
    ...
    <?php
    if ($DISP_RESULT) {
        foreach ($DISP_RESULT as $DISP_RESULT_ROW) {
            ?>
            <tr>
            <td class="text-center"><?= $DISP_RESULT_ROW->test_date ?></td>
                <td class="text-center"><?= $DISP_RESULT_ROW->test_site ?></td>
                <td class="text-center"><?= $DISP_RESULT_ROW->group_id ?></td>
                <td class="text-center"><a href="<?= base_url() ?>autotest/success_details?group_id=<?= $DISP_RESULT_ROW->group_id ?>"><?php echo 'Success Count: ' . $DISP_RESULT_ROW->success_count ?></a></td>
            <td class="text-center"><a href="<?= base_url() ?>/autotest/failed_details?group_id=<?= $DISP_RESULT_ROW->group_id ?>"><?php echo 'Failed Count:  ' . $DISP_RESULT_ROW->failed_count ?></a></td>
