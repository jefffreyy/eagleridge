...
<body>
    <div class="content-wrapper">
        <div class="container-fluid p-0">
            ...
            <div class="row pt-1">
                <div class="col-md-6">
                    <h1 class="page-title pl-4 pt-4"><?= $module[2] ?><h1>
                </div>
                <?php
                ...
                // $this->session->set_userdata($url_add_combined);
                ...
                <div class="col-md-6 button-title">
                    ...
                    <!--<form action="<?= base_url('main_table_02/add_data'); ?>" method="post" >-->
                    <!--     <input type="text" name="add_encrypted_data" value="<?= $url_add_encrypted ?>" hidden>-->
                    <!--     <button type="submit"  class=" btn technos-button-green shadow-none rounded" <?php if (!$add_button[0])  echo "hidden"; ?> <?php if (!$add_button[1]) echo "hidden" ?>><i class="fas fa-plus"></i>&nbsp;<?= $add_button[1] ?></button>-->
                    <!-- </form>-->
                    <a href="<?= base_url('selfservices/request_leave') ?>" class=" btn technos-button-green shadow-none rounded"><i class="fas fa-plus"></i>&nbsp;Add Request</a>
            ...
            <!-- <div class="card border-0 p-0 m-0"> -->
                <div class="card border-0 p-0 m-0">
                    ...
                    <div class="p-2" style = "background-color: #F6F8FC">
                        <div>
                            <?php
    ...
    <tbody id="tbl_application_container">
        ...
        ?>
                <tr style = "background-color: white">
                    ...
                    <td class='text-center'><?= $id_prefix . str_pad($C_DATA_TABLE_ROW->id, 5, '0', STR_PAD_LEFT); ?></td>
                    <td class='text-center'><?= $C_DATA_TABLE_ROW->type; ?></td>
                    <td class='text-center'><?= $C_DATA_TABLE_ROW->leave_date; ?></td>
                    <td class='text-center'><?= sprintf("%.2f",  $C_DATA_TABLE_ROW->duration); ?></td>
                    <td class='text-center'><?= $C_DATA_TABLE_ROW->status; ?></td>
                    <td class='text-center'><?= $C_DATA_TABLE_ROW->remarks; ?></td>
                ...
                <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-default">
                  Launch Default Modal
                        ...
                        <a class = "select_edit_row p-2 edit_data_id"  href="<?php echo base_url('main_table_02/edit_data?' . $url_edit_encrypted);  ?>"  style ="color: gray; cursor: pointer; !important" row_id="<?= $id_raw ?>"><i class="fa-solid fa-arrow-rotate-left"></i></a>
...
<!--                        
                        <div class="action_btn">
                            <form action="<?= base_url('main_table_02/show_data'); ?>" method="post">
                                ...
                                <button type="submit" class="select_edit_row" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important" row_id="<?= $id_raw ?>"><i class="far fa-eye" id="view"></i></button> 
                            </form>
                            ...
                            ?>
                            <form action="<?= base_url('main_table_02/edit_data'); ?>" method="post" <?= $hide_action ?> <?= $hide ?>>
                                <input type="text" name="edit_encrypted_data" value="<?= $url_edit_encrypted ?>" hidden>
                                <button type="submit" class="select_edit_row" style="background-color: transparent; border: none;color: gray; cursor: pointer; !important" row_id="<?= $id_raw ?>"><i class="far fa-edit" id="edit"></i></button> 
                            </form>
                        </div> -->
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Withdraw Leave</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <p>Would you like to withdraw your Leave Request?</p>
            </div>
