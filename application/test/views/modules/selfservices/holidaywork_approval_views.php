  ...
  <div class="container-fluid p-4">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Holiday Work Approval
        </li>
      </ol>
    </nav>
    <div class="row pt-1">
      <div class="col-md-6">
        <h1 class="page-title">Holiday Work Approval<h1>
      </div>
          ...
          <table class="table table-hover m-0" id="TableToExport" style="width:100%">
            <thead>
              <tr>
                ...
                <th class="text-center">Holiday Work ID</th>
              ...
              <?php if ($DISP_HOLIDAYWORK) {
                foreach ($DISP_HOLIDAYWORK as $DISP_HOLIDAYWORK_ROW) { ?>
                  <tr>
                    ...
                    <td class="text-center"><?= 'HWA'.str_pad($DISP_HOLIDAYWORK_ROW->id, 5, '0', STR_PAD_LEFT) ; ?></td>
                    <td class="text-center"><?= convert_cmid($DISP_EMPLOYEES, $DISP_HOLIDAYWORK_ROW->empl_id) ?> - <?= convert_data($DISP_EMPLOYEES, $DISP_HOLIDAYWORK_ROW->empl_id) ?></td>
                    <td class="text-center"> <?= $DISP_HOLIDAYWORK_ROW->type ?></td>
                    <td class="text-center"> <?= $DISP_HOLIDAYWORK_ROW->date ?> </td>
                    <td class="text-center"> <?= $DISP_HOLIDAYWORK_ROW->hours ?></td>
                    <td class="text-center"> <?= $DISP_HOLIDAYWORK_ROW->status ?></td>



                    <td style="width:15%" class="text-center">
                      <a class="select_row p-1 request_id btn btn-warning" href="<?= base_url() ?>selfservices/get_specific_holidaywork_request/<?= $DISP_HOLIDAYWORK_ROW->id ?>" id="view" data-toggle="modal" data-target="#modal_leave_request" leave_id="<?= $DISP_HOLIDAYWORK_ROW->id; ?>"><i class="far fa-eye"></i></a>
                      <button class="select_edit_row p-1 approved_data btn btn-success" href="" approved_id="<?= $DISP_HOLIDAYWORK_ROW->id; ?>" row_id=""><i class="fas fa-check-circle" id="btn_approved"></i></button>
                      <button class="select_edit_row p-1 reject_data btn btn-danger" href="" reject_key="<?= $DISP_HOLIDAYWORK_ROW->id; ?>" row_id=""><i class="fas fa-times-circle" id="btn_reject"></i></button>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header" style="border-bottom: none;">
        <h4 class="modal-title ml-1" id="exampleModalLabel">View Overtime Request
        </h4>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="form-group">
                <label class="required " for="holiday_work_id">ID
                </label>
                <input type="text" class="form-control" name="holiday_work_id" id="holiday_work_id" readonly>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="required " for="overtime_type">Type
                </label>
                <input type="text" class="form-control" name="overtime_type" id="overtime_type" readonly>
              </div>
              <div class="form-group">
                <label class="required " for="date">Date
                </label>
                <input type="text" class="form-control" name="date" id="date" readonly>
              </div>
              <div class="form-group">
                <label class="required " for="hours">Hours
                </label>
                <input type="text" class="form-control" name="hours" id="hours" readonly>
              </div>
              <div class="form-group">
...
<script>
  $(document).ready(function() {
    ...
    function filter_data(page_row) {
      ...
      window.location = base_url + "selfservices/holidaywork_approval"+page_row;
    }
    ...
    $('.reject_data').click(function(e) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          window.location.href = "<?= base_url(); ?>selfservices/reject_holidaywork_assign?reject_id=" + reject_key;
        }
      })
    })
    ...
    $('.approved_data').click(function(e) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          window.location.href = "<?= base_url(); ?>selfservices/update_holidaywork_assign?approved_id=" + approved_id;
        }
      })
    })
    ...
    $('.request_id').on('click', function() {
      ...
      fetch(url)
        ...
        // $('#overtime_id').val('HWA00' + data[0]['id']);
