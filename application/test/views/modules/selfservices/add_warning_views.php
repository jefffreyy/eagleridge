    ...
    <div class="container-fluid p-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="https://dev-env.eyebox.app/selfservices/my_warnings">Warnings</a>
                </li>
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="modal-body pb-5">
                        <div class="row">
                            <div class="col-md-12">
                            <?php echo form_open_multipart('selfservices/add_new_warning');?>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" required class="form-control" id="input_description" rows="4"
