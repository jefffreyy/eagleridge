        ...
        <div class="container-fluid p-4">
            ...
            <div class="row pt-1">
                ...
                <div class="col-md-6 button-title">
                    ...
                    <a href="<?=base_url('selfservices/add_complaint')?>" class=" btn technos-button-green shadow-none rounded"><i class="fas fa-plus"></i>&nbsp;Add Complaints</a>
                                    ...
                                    foreach ($C_DB_DESIGN as $C_DB_DESIGN_ROW) {
                                        ...
                                        if($table_display == true) {
                                            ...
                                            if($parameter != "status"){?>
                                                ...
                                                <td class="text-center"  style="width:<?= $table_width?>%"><?= isset($column_data) ? $column_data : "" ?></td>
