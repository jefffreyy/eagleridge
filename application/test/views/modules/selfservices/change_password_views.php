	...
	<body>
		...
		<div class="container pt-5 align-items-center">
			...
			<div class = " p-3 login-page" style="text-align:center;">
				...
				<!-- <p style = "font-size:30px; font-family: 'Lato',san-serif; color:#008037" class="text-bold"><b>New Password</b></p> -->
                ...
                <div class="container p-3">
                    ...
                    <form action="<?= base_url() ?>selfservices/submit_new_password" method="post">
                        <div class = "forgot-inputs">
                            ...
                            <button type = "submit" style="background-color:#008037;color:white" class = "btn btn-block shadow-none" id="submit_button">Submit</button>
