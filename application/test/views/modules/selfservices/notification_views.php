    ...
    <div class="container-fluid p-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Notifications
            </ol>
        </nav>
...
<?php foreach($C_NOTIFICATION as $NOTIFICATION_ROW) { ?>
                            <tr>
                                <td><?=date_format(date_create($NOTIFICATION_ROW["create_date"]),"M d Y  h:i a")?></td>
                                <td><?=getID($C_EMPLOYEES_ID,$NOTIFICATION_ROW["empl_id"])?></td>
