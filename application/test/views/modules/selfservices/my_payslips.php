                                            ...
                                            <tr class="payslip_row">
                                                ...
                                                <!-- <td><a href="#">
                                                        <img class="rounded-circle avatar " width="35" height="35" src="<?php if ($employee[0]->col_imag_path) {
                                                                                                                        ...
                                                                                                                        } ?>">&nbsp;&nbsp;<?= $employee[0]->col_last_name . ', ' . $employee[0]->col_frst_name . ' ' . $midl_ini ?></a>
                                                </td> -->
                                                ...
                                                <!-- <td><?php echo number_format((float)$DISP_PAYROLL_DATA_ROW->total_earnings, 2, '.', ''); ?></td> -->
                                                <!-- <td><?php echo number_format((float)$DISP_PAYROLL_DATA_ROW->total_deductions, 2, '.', ''); ?></td> -->
