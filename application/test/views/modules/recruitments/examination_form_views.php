...
$title =  "Entrance Exam";
$header_button =  "Apply Entrance Exam";
$modal_title =  "Apply Entrance Exam";
$request_name =  "Apply Entrance Exam";

$id_code =  "EXM";

$col_name_1 =  "Entrance Exam". '&nbsp;' ."ID";
...
<body>
  ...
  <div class="content-wrapper">
    ...
    <nav aria-label="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Entrance Exam
      </li>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body pb-5">
          ...
          <div class="row">
            <div class="col-12">
              <!-- Form starts -->
              <form action="<?php echo base_url('recruitments/insert_data'); ?>" id="apply_form" method="post" accept-charset="utf-8" autocomplete='off' class="m-2" enctype="multipart/form-data">
