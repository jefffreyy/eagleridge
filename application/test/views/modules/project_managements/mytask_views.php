    ...
    <nav aria-label="breadcrumb">
      ...
      <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">
            ...
            <a href="https://testhr.technos.app/self_services">Self-Service</a>

          </li>

          <li class="breadcrumb-item active" aria-current="page">My Tasks
          </li>
      ...
      <div class="row">
        ...
        <div class="col-md-6 button-title">
          ...
          <a href="<?php echo base_url('task/exportCSV'); ?>" cutoff_id="" class="btn btn-primary" id="download_csv"><i class="fas fa-download"></i>&nbsp;&nbsp;Export XLSX</a>
                ...
                <tbody id="tbl_application_container">
                  ...
                  if ($DISP_TABLE) {
                    ...
                    foreach ($DISP_TABLE as $DISP_TABLE_ROW) {
                      ...
                      $employee_id = $this->p020_emplist_mod->MOD_DISP_EMPLOYEE($DISP_TABLE_ROW->employee_id);
                  ...
                  ?>
                      ...
                      <tr class="form_row" style="" data-toggle="" employee_id="<?= $DISP_TABLE_ROW->employee_id ?>" request_id="<?= $DISP_TABLE_ROW->id ?>">
                        ...
                        <td><a href="" class="btn btn-warning" employee_id="<?= $DISP_TABLE_ROW->employee_id ?>" request_id="<?= $DISP_TABLE_ROW->id ?>" data-toggle="modal" data-target="#modal_edit_task"><i class="fas fa-fw fa-edit"></i></a></td>
        ...
        <div class="modal-body pb-5">
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <form action="<?php echo base_url('task/insert_data'); ?>" id="apply_form" method="post" accept-charset="utf-8" autocomplete='off' class="m-2" enctype="multipart/form-data">
                ...
                <div id="request_data">
                  ...
                  <div class="form-check">
                    ...
                    <input class="form-check-input all_day" type="checkbox" name="all_day" value="true" style="width:15px;height:15px">
        ...
        <div class="modal-body pb-5">
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <form action="<?php echo base_url('task/edit_data'); ?>" id="update_form" method="post" accept-charset="utf-8" autocomplete='off' class="m-2" enctype="multipart/form-data">
                  ...
                  <div class="ml-3">
                    ...
                    <div class="d-flex border border-1 border-darken container_select">
                      ...
                      <div class="container_select">
                        ...
                        <select class="form-control border-0 time" name="start_time" id="UPDATE_START_TIME" style="appearance:none">
                      ...
                      <div class="container_select"> 
                        ...
                        <select class="form-control border-0" name="start_Indicator" id="UPDATE_START_INDICATOR"  style="appearance:none">
                  ...
                  <div class="ml-3">
                    ...
                    <div class="d-flex border border-1 border-darken container_select">
                      ...
                      <div class="">
                        ...
                        <select class="form-control border-0 time" name="end_time" id="UPDATE_END_TIME" style="appearance:none">
                      ...
                      <div class=""> 
                        ...
                        <select class="form-control border-0" name="end_Indicator" id="UPDATE_END_INDICATOR"  style="appearance:none">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="UPDATE_REMARKS" id="UPDATE_REMARKS" cols="30" rows="2"></textarea>
