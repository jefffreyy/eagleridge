        ...
        <form action="<?php echo base_url(); ?>superadministrators/update_company_name" id="apply_form" method="post" accept-charset="utf-8" autocomplete='off' class="m-2" enctype="multipart/form-data" >
            <div class="form-group" style="margin-bottom: 40px">
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        <button class="btn w-100 btn-primary btn-block float-right" id="INSRT_BTN" type="submit">Update</button>
                    </div>
                </div>
            </div>
        </form> 
                    ...
                    <div class="col-10">
                        <div class="input-group">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input fileficker" id="INSRT_LOGIN_LOGO" name="INSRT_LOGIN_LOGO" multiple="" accept=".jpg, .jpeg, .png">
            ...
            <div class="form-group" id="application_file"  style="margin-top: 40px">
                ...
                <div class="row">
                    <div class="col-10">
                        <div class="input-group">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input fileficker" id="NAVBAR_LOGO" name="INSRT_NAVBAR_LOGO" multiple="" accept=".jpg, .jpeg, .png">
        ...
        <form action="<?php echo base_url(); ?>superadministrators/update_header" id="apply_form" method="post" accept-charset="utf-8" autocomplete='off' class="m-2" enctype="multipart/form-data">
            <div class="form-group" id="application_file"  style="margin-top: 40px">
                ...
                <div class="row">
                    <div class="col-10">
                        <div class="input-group">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input fileficker" id="INSRT_HEADER_LOGO" name="INSRT_HEADER_LOGO" multiple="" accept=".jpg, .jpeg, .png">
                    ...
                    <div class="col-2 ">
                        ...
                        <button class="btn w-100 btn-primary float-right" id="INSRT_BTN" type="submit">Update</button>
                    </div>
                </div>
            </div>
            <div>
            ...
            <div class="form-group" id="application_file"  style="margin-top: 40px">
                ...
                <div class="row">
                    <div class="col-10">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input fileficker" id="INSRT_MOBILE_BANNER" name="INSRT_MOBILE_BANNER" multiple="" accept=".jpg, .jpeg, .png">
                            <label class="custom-file-label" for="INSRT_MOBILE_BANNER">Choose file
                            </label>
                        </div>
                    </div>
                    <div class="col-2">
                        <button class="btn btn-primary float-right w-100" id="INSRT_BTN" type="submit">Update</button>
                    </div>
                </div>
            </div>
            <div>
            ...
            <div class="form-group" id="application_file"  style="margin-top: 40px">
                ...
                <div class="row">
                    <div class="col-10">
                        <div class="input-group">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input fileficker" id="INSRT_DESKTOP_BANNER" name="INSRT_DESKTOP_BANNER" multiple="" accept=".jpg, .jpeg, .png">
