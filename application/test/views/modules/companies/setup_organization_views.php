        ...
        <div class="container-fluid p-4">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Setup Organizational Chart
                    </li>
                </ol>
            </nav>
            ...
            <div class="row  pt-1"> <!-- Title starts -->
                <div class="col-md-6">
                    <h1 class="page-title">Setup Organizational Chart</h1>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var base_url = '<?= base_url(); ?>';
             $('.employees').select2();// to add search feature when selecting
