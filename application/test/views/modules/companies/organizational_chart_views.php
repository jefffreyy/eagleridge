    ...
    <div class="container-fluid p-4">
      ...
      <div class='row'>
          ...
          <div class='col text-right'>
            <a class='btn technos-button-blue' href="<?=base_url('companies/setup_organization')?>">Setup Organization</a>
          </div>
        </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    fetch("/companies/get_organizational_chart").then(res=>res.json()).then(res_data=>{
