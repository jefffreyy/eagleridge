        ...
        <div class="container-fluid p-4">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Non-Taxable Deduction
                    </li>
                </ol>
            </nav>
            ...
            <div class="row  pt-1"> <!-- Title starts -->
                <div class="col-md-6">
                    <h1 class="page-title">Non-Taxable Deduction</h1>
                </div>
            ...
            <div class="row mb-4"><!-- Filter Starts -->
                ...
                <div class="col-md-2">
                    ...
                    <a href=<?= base_url() . "employees/non_taxable_deduction_assign" ?> id="btn_clear_filter" class="col btn btn-secondary mx-1">Clear Filter</a>
                </div>
                                        ...
                                        ?>
                                            <td>
                                                <form class="bg-transparent">
                                                    ...
                                                    <input type="text" class="deduction_nontax_val" id="deduction_nontax_val" name="deduction_nontax_val" pattern="[0-9]*" style="width:100%;" default=<?=$val?> value=<?= $val ?> >
                                                </form>
                                            </td>
                                        <?php } ?>
                                    </tr>
    ...
    <div class="modal fade  class_modal_update_list" id="modela_update" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url() . 'employees/update_deduction_non_tax'; ?>" method="post" accept-charset="utf-8" autocomplete='off' class="m-2">
    ...
    <script>
        $(document).ready(function() {
            ...
            function filter_data(page_row) {
                ...
                window.location = base_url + "employees/non_taxable_deduction_assign"+page_row+"&branch=" + branch +
            ...
            // $('.deduction_nontax_val').on('change', function() {

            $('.deduction_nontax_val').on('focusout', function(event) {
                // if (event.key === "Enter") {
                    ...
                    if(defaultVal!=deduction_val){
                        window.location = base_url + "employees/process_deduction_assigning_nontax/" + employee + "/" + deduction_val + "/" + year + "/" + type;
