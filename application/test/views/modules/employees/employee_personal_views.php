...
if ($C_EMP_INFO) {
    foreach ($C_EMP_INFO as $C_EMP_INFO_ROW) {
        ...
        (!$C_EMP_INFO_ROW->salary_type) ? array_push($empty, 'Salary Type') : '';
        ...
        (!$C_EMP_INFO_ROW->salary_rate) ? array_push($empty, 'Salary Rate') : '';
    ...
    <div class="container-fluid p-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Personal Info
                </li>
            </ol>
        </nav>
        <div class="row  d-flex justify-content-center">
            <div class="col-sm-12 col-md-8 card">
                <div class="p-0">
                    <div class="d-flex justify-content-between align-items-start">
                        ...
                        if ($C_EMP_INFO[0]->disabled > 0) {
                        ?>
                            <a href="<?= base_url() ?>employees/user_activation/<?= $C_EMP_INFO[0]->id ?>/0" class="btn btn-sm btn-success px-3 btnActivate" data-toggle="tooltip" data-placement="top" title="Activate this user">Activate</a>
                        <?php
                        } else {
                        ?>
                            <a href="<?= base_url() ?>employees/user_activation/<?= $C_EMP_INFO[0]->id ?>/1" class="btn btn-sm btn-danger px-3 btnActivate" data-toggle="tooltip" data-placement="top" title="Deactivate this user">Deactivate</a>
                        <?php
                        }
                        ?>
            ...
            <div class="col-md-8 card p-1" id="content_container">
                ...
                <div class="card-title pl-4 pt-0 pb-0 text-bold header-title">
                    ...
                    <a href="<?php echo base_url('employees/edit_personal_detail/' . $user_id) ?>" type="submit" class="btn btn-success btn-sm px-4 float-right mr-5" name="p_details">Edit</a>
                </div>
                <hr>
                ...
                <div class="card-title pl-4 pt-0 pb-0 text-bold header-title">
                    ...
                    <a href="<?php echo base_url('employees/edit_employment_detail/' . $user_id) ?>" type="submit" class="btn btn-success btn-sm px-4 float-right mr-5" name="p_details"">Edit</a>
                </div>
                <hr>
                <div class=" row pl-4 pt-0 pb-0 mt-3">
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col col-md-6 text-bold">
                                    Hired Date <span style="color:red;">*</span>
                                </div>
                                <div class="col col-md-6">
                                    <span style="font-weight:normal"><?= $hired_on ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col col-md-6">
                                    <span style="font-weight:normal"><?= $regularization_date ?></span>
                                </div>
                            </div>
                        </div>
                </div>
                <div class="row pl-4 pt-0 pb-0 mt-3">
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col col-md-6">
                                <span style="font-weight:normal"><?= $resignation_date ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="card-title pl-4 pt-0 pb-0 text-bold header-title">
                    ...
                    <a href="<?php echo base_url('employees/edit_id_detail/' . $user_id) ?>" type="submit" class="btn btn-success btn-sm px-4 float-right mr-5" name="p_details"">Edit</a>
                </div>
                <hr>
                <div class=" row pl-4 pt-0 pb-0 mt-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col col-md-6 text-bold">
                                    Pagibig <span style="color:red;">*</span>
                                </div>
                                <div class="col col-md-6">
                ...
                <div class="row pl-4 pt-0 pb-0 mt-3">
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col col-md-6 text-bold">
                                Philhealth <span style="color:red;">*</span>
                            </div>
                            <div class="col col-md-6">
                ...
                <div class="card-title pl-4 pt-0 pb-0 text-bold header-title">
                    ...
                    <a href="<?php echo base_url('employees/edit_compensation_detail/' . $user_id) ?>" type="submit" class="btn btn-success btn-sm px-4 float-right mr-5" name="p_details"">Edit</a>
                </div>
                <hr>
                <div class="row pl-4 pt-0 pb-0 mt-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col col-md-6 text-bold">
                                Salary Rate <span style="color:red;">*</span>
                            </div>
                            <div class="col col-md-6">
                ...
                <div class="card-title pl-4 pt-0 pb-0 text-bold header-title">
                    ...
                    <a href="<?php echo base_url() ?>employees/add_education/<?= $user_id ?>" type="submit" class="btn btn-success btn-sm px-4 float-right mr-5" name="p_details">Add</a>
                </div>
                <hr class="mb-0">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url() ?>employees/edit_educ_detail/<?= $C_EDUCATION_ROW->id ?>/<?= $user_id ?>" class="mr-2" style="color: gray; cursor: pointer; !important"><i class="far fa-edit"></i></a>
                                                <a href="<?= base_url() ?>employees/delete_empl_education/<?= $C_EDUCATION_ROW->id ?>" class="delete_action" style="color: gray; cursor: pointer; !important"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
                ...
                <div class="card-title pl-4 pt-0 pb-0 text-bold header-title">
                    ...
                    <a href="<?php echo base_url('employees/add_skills/' . $user_id) ?>" type="submit" class="btn btn-success btn-sm px-4 float-right mr-5" name="p_details">Add</a>
                </div>
                <hr class="mb-0">
                <div class="row pl-3 pr-3">
                    <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url() ?>employees/edit_skill_detail/<?= $C_SKILLS_MATRIX_ROW->id ?>/<?= $user_id ?>" class=" mr-2" style="color: gray; cursor: pointer; !important"><i class="far fa-edit"></i></a>
                                                <a href="<?= base_url() ?>employees/delete_empl_skill/<?= $C_SKILLS_MATRIX_ROW->id ?>" class="delete_action" style="color: gray; cursor: pointer; !important"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
                ...
                <hr>
                <div class="card-title pl-4 pt-0 pb-0 text-bold header-title">
                    <i class="fas fa-book-open  mr-2 pb-1"></i>Documents <span style="color:red;">*</span>
                    <a href="<?php echo base_url('employees/add_documents/' . $user_id) ?>" type="submit" class="btn btn-success btn-sm px-4 float-right mr-5" name="p_details">Add</a>
                </div>
                <hr class="mb-0">
                <div class="row pl-3 pr-3">
                    <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a file_name="<?= $C_DOCUMENTS_ROW->col_doc_file; ?>" href="<?= base_url() ?>assets_user/documents/<?= $C_DOCUMENTS_ROW->col_doc_file ?>" download class="mr-2 download_file" style="color: gray; cursor: pointer; !important"> <i class="fa fa-download"></i> </a>
                                                <a href="<?= base_url() ?>employees/delete_documents/<?= $C_DOCUMENTS_ROW->id ?>" class="delete_action"><i class="fa fa-trash" style="color: gray; cursor: pointer; !important"></i></a>
                                            </td>
                ...
                <hr>
                <div class="card-title pl-4 pt-0 pb-0 text-bold header-title">
                    <i class="fas fa-book-open  mr-2 pb-1"></i>Dependents <span style="color:red;">*</span>
                    <a href="<?php echo base_url('employees/add_dependents/' . $user_id) ?>" type="submit" class="btn btn-success btn-sm px-4 float-right mr-5" name="p_details">Add</a>
                </div>
                <hr class="mb-0">
                <div class="row pl-3 pr-3">
                    <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url() ?>employees/edit_dependent/<?= $C_DEPENDENTS_ROW->id ?>/<?= $user_id ?>" class="mr-2" style="color: gray; cursor: pointer; !important"><i class="far fa-edit"></i></a>
                                                <a href="<?= base_url() ?>employees/delete_dependent/<?= $C_DEPENDENTS_ROW->id ?>" class="delete_action" style="color: gray; cursor: pointer; !important"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
                ...
                <hr>
                <div class="card-title pl-4 pt-0 pb-0 text-bold header-title">
                    <i class="fas fa-book-open  mr-2 pb-1"></i>Emergency Contacts <span style="color:red;">*</span>
                    <a href="<?php echo base_url('employees/add_emergency_contact/' . $user_id) ?>" type="submit" class="btn btn-success btn-sm px-4 float-right mr-5" name="p_details">Add</a>
                </div>
                <hr class="mb-0">
                <div class="row pl-3 pr-3">
                    <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url() ?>employees/edit_emergency_contact/<?= $C_EMERGENCY_ROW->id ?>/<?= $user_id ?>" class=" mr-2" style="color: gray; cursor: pointer; !important"><i class="far fa-edit"></i></a>
                                                <a href="<?= base_url() ?>employees/delete_emergency_contact/<?= $C_EMERGENCY_ROW->id ?>/<?= $user_id ?>" class="delete_action" style="color: gray; cursor: pointer; !important"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
...
<?php
if ($this->session->flashdata('SESS_SUCC_UPDT')) {
?>
<script>
    $(document).Toasts('create', {
        ...
        title: 'Success',
        subtitle: 'close',
        body: '<?php echo $this->session->flashdata('SESS_SUCC_UPDT'); ?>'
      })
</script>
<?php
}
...
<?php
if ($this->session->flashdata('SESS_ERR_UPDT')) {
?>
<script>
    $(document).Toasts('create', {
        ...
        subtitle: 'close',
        body: '<?php echo $this->session->flashdata('SESS_ERR_UPDT'); ?>'
      })
</script>
<?php
}
...
<?php
if ($this->session->flashdata('SESS_SUCC_ADD')) {
?>
<script>
    $(document).Toasts('create', {
        class: 'bg-success toast_width',
        title: 'Success',
        subtitle: 'close',
        body: '<?php echo $this->session->flashdata('SESS_SUCC_ADD'); ?>'
      })
</script>
<?php
}
...
<?php
if ($this->session->flashdata('SESS_ERR_ADD')) {
?>
<script>
    $(document).Toasts('create', {
        class: 'bg-danger toast_width',
        title: 'Unable to Update',
        subtitle: 'close',
        body: '<?php echo $this->session->flashdata('SESS_ERR_ADD'); ?>'
      })
</script>
<?php
}
...
?>
    <script>
        Swal.fire(
            '<?php echo $this->session->flashdata('SESS_ERR_ADD'); ?>',
            '',
            'error'
        )
    </script>
...
?>
    <script>
        Swal.fire(
            '<?php echo $this->session->userdata('SESS_SUCC_MSG'); ?>',
            '',
            'success'
        )
    </script>
