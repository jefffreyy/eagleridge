    ...
    <div class="container-fluid p-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Personal Detail
                </li>
            </ol>
        </nav>
        <div class="row d-flex justify-content-center">
            <div class="col-sm-6">
                <div class="card">
                    <!-- form start -->
                    <form action="<?php echo base_url('employees/update_personal_detail'); ?>" id="" method="post" accept-charset="utf-8" autocomplete='off' class="m-2" enctype="multipart/form-data">
                        <div class="modal-body pb-5">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="UPDATE_MIDDLENAME" class="required">Middle Name</label>
                                        <input class="form-control " type="text" name="UPDATE_MIDDLENAME" id="UPDATE_MIDDLENAME" value="<?=$middlename?>" required />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="UPDATE_MART_STAT" class="required">Marital Status</label>
                                        <select class="form-control" name="UPDATE_MART_STAT" id="UPDATE_MART_STAT">
<?php                               if($C_MARITAL) {
                                        foreach($C_MARITAL as $C_MARITAL_ROW){  ?>  
                                            <option value="<?=$C_MARITAL_ROW->id?>" <?php  if($marital_status == $C_MARITAL_ROW->id){echo"Selected";} ?>> <?=$C_MARITAL_ROW->name?></option>
<?php                                   } 
                                    }   ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="UPDATE_MOB_NUM" class="required">Moblie Number</label>
                                        <input class="form-control" type="text" name="UPDATE_MOB_NUM" id="UPDATE_MOB_NUM" value="<?=$mobile_number?>" required />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="UPDATE_GENDER" class="required">Gender</label>
                                        <select class="form-control" name="UPDATE_GENDER" id="UPDATE_GENDER">
<?php                               if($C_GENDERS) {
                                        foreach($C_GENDERS as $C_GENDERS_ROW){  ?>  
                                            <option value="<?=$C_GENDERS_ROW->id?>" <?php  if($gender == $C_GENDERS_ROW->id) {echo"Selected";} ?>> <?=$C_GENDERS_ROW->name?></option>
<?php                                   } 
                                    }   ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="UPDATE_NATIONALITY" class="required">Nationality</label>
...
<?php                               if($C_NATIONALITY) {
                                        foreach($C_NATIONALITY as $C_NATIONALITY_ROW){  ?>  
                                            <option value="<?=$C_NATIONALITY_ROW->id?>" <?php if($nationality == $C_NATIONALITY_ROW->id){echo "Selected";} ?>> <?=$C_NATIONALITY_ROW->name?></option>
<?php                                   } 
                                    }   ?>
                                        </select>                                    
                                    </div>
                                    <div class="form-group">
                                        <label for="UPDATE_SHIRT_SIZE" class="required">Shirt size</label>
                                        <select class="form-control" name="UPDATE_SHIRT_SIZE" id="UPDATE_SHIRT_SIZE">
<?php                               if($C_SHIRT_SIZE) {
                                        foreach($C_SHIRT_SIZE as $C_SHIRT_SIZE_ROW){  ?>  
                                            <option value="<?=$C_SHIRT_SIZE_ROW->id?>" <?php  if($shirt_size == $C_SHIRT_SIZE_ROW->id){echo"Selected";}  ?> > <?=$C_SHIRT_SIZE_ROW->name?></option>
<?php                                   } 
                                    }   ?>
                                        </select>   
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="UPDATE_EMAIL" id="UPDATE_EMAIL" value="<?=$email?>" required />
                                    </div>
                                    <div class="form-group">
                                        <label for="UPDATE_HOME_ADD" class="required">Home Address</label>
                                        <input class="form-control" type="text" name="UPDATE_HOME_ADD" id="UPDATE_HOME_ADD" value="<?=$home_address?>" required />
                                    </div>
                                    <div class="form-group">
                                        <label for="UPDATE_CURRENT_ADD" class="required">Current Address</label>
                                        <input class="form-control" type="text" name="UPDATE_CURRENT_ADD" id="UPDATE_CURRENT_ADD" value="<?=$current_address?>" required />
                                    </div>
