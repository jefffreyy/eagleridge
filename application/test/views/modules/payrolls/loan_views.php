  ...
  <div class="container-fluid p-4">
    <div class="row pt-1">
      ...
      <!-- <a href="<?= base_url() . 'payrolls'; ?>"><i class="fa-solid fa-square-left"></i> -->
        <h1 class="page-title"><a href="<?= base_url() . 'payrolls'; ?>"><i class="fa-sharp fa-solid fa-arrow-left fa-2xs"></i></a>&nbsp;Loans<h1>
      </div>
          ...
          <table class="table table-hover m-0" id="TableToExport">
            <thead style="position: sticky; top: 0;">
              <tr>
                ...
                <th class="text-center" style="min-width: 150px !important">Date</th>
                <th class="text-center" style="min-width: 300px !important">Employee</th>
                <th class="text-center" style="min-width: 150px !important">Type</th>
                <th class="text-center" style="min-width: 100px !important">Amount</th>
              ...
              <?php if ($DISP_PAYROLL_LOAN) {
                foreach ($DISP_PAYROLL_LOAN as $DISP_PAYROLL_LOAN_ROW) { ?>
                  <tr>
                    ...
                    <td class="text-left"><?= $DISP_PAYROLL_LOAN_ROW['date'] ?></td>
                    <td class="text-left"><?= $DISP_PAYROLL_LOAN_ROW['name'] ?></td>
                    <td class="text-left"><?= $DISP_PAYROLL_LOAN_ROW['loan_type'] ?></td>
                    <td class="text-right"><?= $DISP_PAYROLL_LOAN_ROW['loan_amount'] ?></td>
                    <td class="text-right"><?= $DISP_PAYROLL_LOAN_ROW['term_amount'] ?></td>
                    ...
                    <td style="width:15%" class="text-center">
                      <a class="select_row p-2" href="<?= base_url('payrolls/edit_loan/' . $DISP_PAYROLL_LOAN_ROW['id']) ?>" style="color: gray; " row_id=""><i class="far fa-edit"></i></a>
...
<script>
  $(document).ready(function() {
    $('#row_dropdown').on('change', function() {
      let row = $(this).val();
      // alert(row);
      window.location = "<?= base_url() ?>payrolls/loans?" + "page=" + 1 + "&row=" + row + '&tab=<?= $TAB ?>';
    });
