        ...
        <div class="container-fluid p-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add&nbsp;Deduction
                    </li>
                </ol>
            </nav>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="modal-body pb-5">
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="<?=base_url('payrolls/insert_new_deduction')?>" id='form_deduction' method="POST">
                                        <div class="form-group ">
                                            <label class="required">Deduction Title</label>
                                            <input type="text" class="form-control" name="insrt_name" id="insrt_deduct_name" placeholder="Enter Deduction Title" required>
                                        </div>
                                        <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <input type="number" min="0" step="1" class="form-control" name="insrt_amount" id="insrt_amount" placeholder="Enter Deduct Amount" required>
                                        </div>
