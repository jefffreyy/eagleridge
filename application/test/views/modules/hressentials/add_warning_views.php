        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="https://dev-env.eyebox.app/hressentials">HR Essentials</a>
                </li>
                <li class="breadcrumb-item">
                    <a href="https://dev-env.eyebox.app/hressentials/warnings">Warnings</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Add&nbsp;Warnings </li>
            </ol>
        </nav>
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="modal-body pb-5">
                        <div class="row">
                            <div class="col-md-12">
                                <?php echo form_open_multipart('hressentials/add_new_warning');?>
                                <label class="">Employee</label>
                                <select class="form-control custom_selection" name="employee_id"
                                    id="input_employee_id">
                            <?php foreach($C_EMPLOYEES as $employee) { ?>
                                    <option value="1"><?=$employee->col_empl_cmid.'-'.$employee->col_last_name.' '.$employee->col_frst_name?></option>
                            <?php } ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea required name="description" class="form-control" id="description" rows="4"
                                        cols="50" enabled=""></textarea>
                                </div>
                                <div class="form-group">
                                    <label class="" for="input_feedback">Feedback</label>
                                    <textarea  name="feedback" class="form-control" id="feedback" rows="4"
                                        cols="50" enabled=""></textarea>
                                </div>
                                <div class="form-group">
